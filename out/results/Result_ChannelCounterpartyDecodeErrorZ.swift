			...
			extension Bindings {
				...
				public class Result_ChannelCounterpartyDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelCounterpartyDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ChannelCounterpartyDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelCounterpartyDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelCounterparty) -> Result_ChannelCounterpartyDecodeErrorZ {
						...
						let returnValue = Result_ChannelCounterpartyDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelCounterpartyDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelCounterpartyDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelCounterpartyDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelCounterparty? {
						if self.cType?.result_ok == true {
							return ChannelCounterparty(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelCounterpartyDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelCounterpartyDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelCounterpartyDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
