				...
				open class BindingsType: NativeTraitWrapper {
					...
					public init() {
						...
						func debugStrLambda(this_arg: UnsafeRawPointer?) -> LDKStr {
							...
							// return value (do some wrapping)
							let returnValue = Str(value: swiftCallbackResult, instantiationContext: "BindingsType.swift::init()::\(#function):\(#line)").dangleRecursively().cType!
						...
						func writeLambda(this_arg: UnsafeRawPointer?) -> LDKCVec_u8Z {
							...
							// return value (do some wrapping)
							let returnValue = Vec_u8Z(array: swiftCallbackResult, instantiationContext: "BindingsType.swift::init()::\(#function):\(#line)").dangleRecursively().cType!
