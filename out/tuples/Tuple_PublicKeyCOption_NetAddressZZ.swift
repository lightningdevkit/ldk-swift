...
extension Bindings {
	...
	internal class Tuple_PublicKeyCOption_NetAddressZZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKC2Tuple_PublicKeyCOption_NetAddressZZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		internal func clone() -> Tuple_PublicKeyCOption_NetAddressZZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKC2Tuple_PublicKeyCOption_NetAddressZZ>) in
			...
			let returnValue = Tuple_PublicKeyCOption_NetAddressZZ(
				cType: nativeCallResult,
				instantiationContext: "Tuple_PublicKeyCOption_NetAddressZZ.swift::\(#function):\(#line)")
		...
		public init(a: [UInt8], b: NetAddress?, instantiationContext: String) {
			...
			let aPrimitiveWrapper = PublicKey(
				value: a, instantiationContext: "Tuple_PublicKeyCOption_NetAddressZZ.swift::\(#function):\(#line)")

			let bOption = Option_NetAddressZ(
				some: b, instantiationContext: "Tuple_PublicKeyCOption_NetAddressZZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		public func getA() -> [UInt8] {
			...
			let returnValue = PublicKey(
				cType: self.cType!.a,
				instantiationContext: "Tuple_PublicKeyCOption_NetAddressZZ.swift::\(#function):\(#line)", anchor: self
			)
			.dangle().getValue()
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Tuple_PublicKeyCOption_NetAddressZZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Tuple_PublicKeyCOption_NetAddressZZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
