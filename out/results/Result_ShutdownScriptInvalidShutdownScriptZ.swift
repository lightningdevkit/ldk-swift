			...
			extension Bindings {
				...
				public class Result_ShutdownScriptInvalidShutdownScriptZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ShutdownScriptInvalidShutdownScriptZ) {
					...
					internal init(cType: LDKCResult_ShutdownScriptInvalidShutdownScriptZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ShutdownScriptInvalidShutdownScriptZ_clone(origPointer)
					...
					public func getError() -> InvalidShutdownScript? {
						if self.cType?.result_ok == false {
							return InvalidShutdownScript(cType: self.cType!.contents.err.pointee, anchor: self)
						}
						return nil
					}
