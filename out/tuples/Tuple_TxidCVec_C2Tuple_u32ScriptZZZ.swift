			...
			extension Bindings {
				...
				internal class Tuple_TxidCVec_C2Tuple_u32ScriptZZZ: NativeTypeWrapper {
					...
					internal init(cType: LDKC2Tuple_TxidCVec_C2Tuple_u32ScriptZZZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKC2Tuple_TxidCVec_C2Tuple_u32ScriptZZZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Tuple_TxidCVec_C2Tuple_u32ScriptZZZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Tuple_TxidCVec_C2Tuple_u32ScriptZZZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
