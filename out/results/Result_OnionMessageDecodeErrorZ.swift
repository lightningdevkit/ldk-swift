			...
			extension Bindings {
				...
				public class Result_OnionMessageDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_OnionMessageDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_OnionMessageDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_OnionMessageDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> OnionMessage? {
						if self.cType?.result_ok == true {
							return OnionMessage(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
