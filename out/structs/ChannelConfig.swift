...
extension Bindings {
	...
	public class ChannelConfig: NativeTypeWrapper {
		...
		public init(
			...
			cltvExpiryDeltaArg: UInt16, maxDustHtlcExposureMsatArg: UInt64, forceCloseAvoidanceMaxFeeSatoshisArg: UInt64
		) {
			// native call variable prep
			...
			let nativeCallResult = ChannelConfig_new(
				...
				maxDustHtlcExposureMsatArg, forceCloseAvoidanceMaxFeeSatoshisArg)
		...
		internal func dangleRecursively() -> ChannelConfig {
			self.dangling = true
