			...
			extension Bindings {
				...
				public class Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ([UInt8], ChannelMonitor)? {
						if self.cType?.result_ok == true {
							return Tuple_BlockHashChannelMonitorZ(cType: self.cType!.contents.result.pointee, anchor: self).getValue()
						}
						return nil
					}
