			...
			extension Bindings {
				...
				public class Result_RouteHintDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RouteHintDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_RouteHintDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_RouteHintDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: RouteHint) -> Result_RouteHintDecodeErrorZ {
						...
						let returnValue = Result_RouteHintDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_RouteHintDecodeErrorZ.swift::\(#function):\(#line)")
					...
					public class func initWithErr(e: DecodeError) -> Result_RouteHintDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_RouteHintDecodeErrorZ_err(e.danglingClone().cType!)
				...
				CResult_RouteHintDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_RouteHintDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> RouteHint? {
						if self.cType?.result_ok == true {
							return RouteHint(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_RouteHintDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_RouteHintDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_RouteHintDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_RouteHintDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
