...
extension Bindings {
	...
	public class Result_QueryShortChannelIdsDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_QueryShortChannelIdsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: QueryShortChannelIds) -> Result_QueryShortChannelIdsDecodeErrorZ {
			...
			let returnValue = Result_QueryShortChannelIdsDecodeErrorZ(
				...
				instantiationContext: "Result_QueryShortChannelIdsDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_QueryShortChannelIdsDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_QueryShortChannelIdsDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_QueryShortChannelIdsDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_QueryShortChannelIdsDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_QueryShortChannelIdsDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
