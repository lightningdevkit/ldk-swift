...
extension Bindings {
	...
	public class Result_ChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
		...
		internal var cOpaqueStruct: LDKCResult_ChannelAnnouncementDecodeErrorZ?
		...
		/* RESULT_METHODS_START */
			...
			public func getValue() -> ChannelAnnouncement? {
				if self.cOpaqueStruct?.result_ok == true {
					return ChannelAnnouncement(pointer: self.cOpaqueStruct!.contents.result.pointee, anchor: self).dangle()
				}
				return nil
			}
