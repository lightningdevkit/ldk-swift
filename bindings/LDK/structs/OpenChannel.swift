...
OpenChannel_write(objPointer)
    ...
    public class func read(ser: [UInt8]) throws -> OpenChannel {
        ...
        return try Result_OpenChannelDecodeErrorZ(pointer: OpenChannel_read(serWrapper.cOpaqueStruct!)).getValue();
    }
