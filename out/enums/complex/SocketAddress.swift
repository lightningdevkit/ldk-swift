...
extension Bindings {
	...
	public class SocketAddress: NativeTypeWrapper {
		...
		internal init(
			cType: LDKSocketAddress, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithTcpIpV4(addr: [UInt8], port: UInt16) -> SocketAddress {
			...
			let addrPrimitiveWrapper = FourBytes(
				value: addr, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
		...
		public class func initWithTcpIpV6(addr: [UInt8], port: UInt16) -> SocketAddress {
			...
			let addrPrimitiveWrapper = SixteenBytes(
				value: addr, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
		...
		public class func initWithOnionV2(a: [UInt8]) -> SocketAddress {
			...
			let aPrimitiveWrapper = TwelveBytes(
				value: a, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
		...
		public class func initWithOnionV3(ed25519Pubkey: [UInt8], checksum: UInt16, version: UInt8, port: UInt16)
			-> SocketAddress
		{
			// native call variable prep

			let ed25519PubkeyPrimitiveWrapper = ThirtyTwoBytes(
				value: ed25519Pubkey, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
		...
		public class func read(ser: [UInt8]) -> Result_SocketAddressDecodeErrorZ {
			...
			let serPrimitiveWrapper = u8slice(
				value: ser, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
			...
			// return value (do some wrapping)
			let returnValue = Result_SocketAddressDecodeErrorZ(
				cType: nativeCallResult, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
		...
		public class func fromStr(s: String) -> Result_SocketAddressSocketAddressParseErrorZ {
			...
			let sPrimitiveWrapper = Str(value: s, instantiationContext: "SocketAddress.swift::\(#function):\(#line)")
				.dangle()
		...
		public func getValueAsTcpIpV4() -> TcpIpV4? {
			...
			return SocketAddress_LDKTcpIpV4_Body(
				cType: self.cType!.tcp_ip_v4, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsTcpIpV6() -> TcpIpV6? {
			...
			return SocketAddress_LDKTcpIpV6_Body(
				cType: self.cType!.tcp_ip_v6, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsOnionV2() -> [UInt8]? {
			...
			return TwelveBytes(
				cType: self.cType!.onion_v2, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
				anchor: self
			)
			.getValue()
		}
		...
		public func getValueAsOnionV3() -> OnionV3? {
			...
			return SocketAddress_LDKOnionV3_Body(
				cType: self.cType!.onion_v3, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsHostname() -> Hostname? {
			...
			return SocketAddress_LDKHostname_Body(
				cType: self.cType!.hostname, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing SocketAddress \(self.instanceNumber). (Origin: \(self.instantiationContext))")
				}

				self.free()
			} else if Self.enableDeinitLogging {
				Bindings.print(
					"Not freeing SocketAddress \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
		...
		public class TcpIpV4: NativeTypeWrapper {
			...
			internal init(
				cType: LDKSocketAddress_LDKTcpIpV4_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
			...
			public func getAddr() -> [UInt8] {
				// return value (do some wrapping)
				let returnValue = FourBytes(
					cType: self.cType!.addr, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
					anchor: self
				)
				.getValue()
		...
		public class TcpIpV6: NativeTypeWrapper {
			...
			internal init(
				cType: LDKSocketAddress_LDKTcpIpV6_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
		...
		public class OnionV3: NativeTypeWrapper {
			...
			internal init(
				cType: LDKSocketAddress_LDKOnionV3_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
			...
			public func getEd25519Pubkey() -> [UInt8] {
				...
				let returnValue = ThirtyTwoBytes(
					cType: self.cType!.ed25519_pubkey,
					instantiationContext: "SocketAddress.swift::\(#function):\(#line)", anchor: self
				)
				.getValue()
		...
		public class Hostname: NativeTypeWrapper {
			...
			internal init(
				cType: LDKSocketAddress_LDKHostname_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
			...
			public func getHostname() -> Bindings.Hostname {
				// return value (do some wrapping)
				let returnValue = Bindings.Hostname(
					cType: self.cType!.hostname, instantiationContext: "SocketAddress.swift::\(#function):\(#line)",
					anchor: self)
