			...
			extension Bindings {
				...
				public class Result_COption_APIErrorZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_APIErrorZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: APIError?) -> Result_COption_APIErrorZDecodeErrorZ {
						...
						let returnValue = Result_COption_APIErrorZDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_COption_APIErrorZDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_COption_APIErrorZDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_COption_APIErrorZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> APIError? {
						if self.cType?.result_ok == true {
							return Option_APIErrorZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_COption_APIErrorZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_COption_APIErrorZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_COption_APIErrorZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
