			...
			extension Bindings {
				...
				public class Result_ChannelUpdateDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: ChannelUpdate) -> Result_ChannelUpdateDecodeErrorZ {
						...
						let returnValue = Result_ChannelUpdateDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_ChannelUpdateDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelUpdate? {
						if self.cType?.result_ok == true {
							return ChannelUpdate(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
