			...
			extension Bindings {
				...
				public class Result_ClaimedHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ClaimedHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ClaimedHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ClaimedHTLC) -> Result_ClaimedHTLCDecodeErrorZ {
						...
						let returnValue = Result_ClaimedHTLCDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ClaimedHTLCDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ClaimedHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ClaimedHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ClaimedHTLC? {
						if self.cType?.result_ok == true {
							return ClaimedHTLC(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ClaimedHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ClaimedHTLCDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ClaimedHTLCDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
