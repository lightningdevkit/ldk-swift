			...
			extension Bindings {
				...
				public class Result_CounterpartyForwardingInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
