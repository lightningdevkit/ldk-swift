			...
			extension Bindings {
				...
				public class Result_OpenChannelDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: OpenChannel) -> Result_OpenChannelDecodeErrorZ {
						...
						let returnValue = Result_OpenChannelDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_OpenChannelDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> OpenChannel? {
						if self.cType?.result_ok == true {
							return OpenChannel(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
