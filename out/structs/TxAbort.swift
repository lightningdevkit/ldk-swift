			...
			extension Bindings {
				...
				TxAbort_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "TxAbort.swift::\(#function):\(#line)")
				...
				TxAbort_get_data(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TxAbort.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				TxAbort_set_data(thisPtrPointer, valVector.cType!)
					...
					public init(channelIdArg: [UInt8], dataArg: [UInt8]) {
						...
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "TxAbort.swift::\(#function):\(#line)")
				
						let dataArgVector = Vec_u8Z(array: dataArg, instantiationContext: "TxAbort.swift::\(#function):\(#line)").dangle()
				...
				TxAbort_write(objPointer)
					...
					public class func read(ser: [UInt8]) -> Result_TxAbortDecodeErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_TxAbortDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TxAbort.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing TxAbort \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
