			...
			extension Bindings {
				...
				ChannelConfig_get_max_dust_htlc_exposure(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = MaxDustHTLCExposure(cType: nativeCallResult, instantiationContext: "ChannelConfig.swift::\(#function):\(#line)", anchor: self)
				...
				ChannelConfig_set_accept_underpaying_htlcs(thisPtrPointer, val)
					...
					public init(forwardingFeeProportionalMillionthsArg: UInt32, forwardingFeeBaseMsatArg: UInt32, cltvExpiryDeltaArg: UInt16, maxDustHtlcExposureArg: MaxDustHTLCExposure, forceCloseAvoidanceMaxFeeSatoshisArg: UInt64, acceptUnderpayingHtlcsArg: Bool) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = ChannelConfig_new(forwardingFeeProportionalMillionthsArg, forwardingFeeBaseMsatArg, cltvExpiryDeltaArg, maxDustHtlcExposureArg.danglingClone().cType!, forceCloseAvoidanceMaxFeeSatoshisArg, acceptUnderpayingHtlcsArg)
