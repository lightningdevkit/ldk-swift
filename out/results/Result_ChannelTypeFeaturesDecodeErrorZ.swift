...
extension Bindings {
	...
	public class Result_ChannelTypeFeaturesDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ChannelTypeFeaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: ChannelTypeFeatures) -> Result_ChannelTypeFeaturesDecodeErrorZ {
			...
			let returnValue = Result_ChannelTypeFeaturesDecodeErrorZ(
				...
				instantiationContext: "Result_ChannelTypeFeaturesDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ChannelTypeFeaturesDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ChannelTypeFeaturesDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_ChannelTypeFeaturesDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ChannelTypeFeaturesDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ChannelTypeFeaturesDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
