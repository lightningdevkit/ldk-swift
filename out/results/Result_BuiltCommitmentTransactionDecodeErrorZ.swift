...
extension Bindings {
	...
	public class Result_BuiltCommitmentTransactionDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_BuiltCommitmentTransactionDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: BuiltCommitmentTransaction) -> Result_BuiltCommitmentTransactionDecodeErrorZ {
			...
			let returnValue = Result_BuiltCommitmentTransactionDecodeErrorZ(
				...
				instantiationContext: "Result_BuiltCommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_BuiltCommitmentTransactionDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_BuiltCommitmentTransactionDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_BuiltCommitmentTransactionDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_BuiltCommitmentTransactionDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_BuiltCommitmentTransactionDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
