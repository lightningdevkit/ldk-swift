class CounterpartyChannelTransactionParameters {
    ...
    init(pubkeys_arg: ChannelPublicKeys, selected_contest_delay_arg: UInt16) {
    	
        self.cOpaqueStruct = CounterpartyChannelTransactionParameters_new(pubkeys_arg.cOpaqueStruct!, selected_contest_delay_arg)
    }
    /* DEFAULT_CONSTRUCTOR_END */

    init(pointer: LDKCounterpartyChannelTransactionParameters){
    ...
    func get_selected_contest_delay() -> UInt16 {
    ...
    func set_selected_contest_delay(val: UInt16) -> Void {
    ...
    func write(obj: CounterpartyChannelTransactionParameters) -> [UInt8] {
    ...
    func read(ser: [UInt8]) -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
