			...
			extension Bindings {
				...
				Balance_clone(origPointer)
					...
					public class func initWithClaimableAwaitingConfirmations(claimableAmountSatoshis: UInt64, confirmationHeight: UInt32) -> Balance {
						// native call variable prep
					...
					public class func initWithContentiousClaimable(claimableAmountSatoshis: UInt64, timeoutHeight: UInt32) -> Balance {
						// native call variable prep
					...
					public class func initWithMaybeTimeoutClaimableHtlc(claimableAmountSatoshis: UInt64, claimableHeight: UInt32) -> Balance {
						// native call variable prep
					...
					public class func initWithMaybePreimageClaimableHtlc(claimableAmountSatoshis: UInt64, expiryHeight: UInt32) -> Balance {
						// native call variable prep
