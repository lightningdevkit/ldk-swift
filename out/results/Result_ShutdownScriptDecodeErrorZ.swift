			...
			extension Bindings {
				...
				public class Result_ShutdownScriptDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ShutdownScriptDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ShutdownScriptDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ShutdownScriptDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ShutdownScript) -> Result_ShutdownScriptDecodeErrorZ {
						...
						let returnValue = Result_ShutdownScriptDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ShutdownScriptDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ShutdownScriptDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ShutdownScriptDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ShutdownScript? {
						if self.cType?.result_ok == true {
							return ShutdownScript(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ShutdownScriptDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ShutdownScriptDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ShutdownScriptDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
