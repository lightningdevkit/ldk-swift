			...
			extension Bindings {
				...
				internal class Vec_C2Tuple_PublicKeyTypeZZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCVec_C2Tuple_PublicKeyTypeZZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(array: [([UInt8], BindingsType)], instantiationContext: String) {
						...
						let currentValueDepth1Tuple = Tuple_PublicKeyTypeZ(tuple: currentValueDepth1, instantiationContext: "Vec_C2Tuple_PublicKeyTypeZZ.swift::\(#function):\(#line)").danglingClone()
...
Tuple_PublicKeyTypeZ(cType: currentCType, instantiationContext: "Vec_C2Tuple_PublicKeyTypeZZ.swift::\(#function):\(#line)").dangle().getValue()
						}
						return swiftArray
					}
