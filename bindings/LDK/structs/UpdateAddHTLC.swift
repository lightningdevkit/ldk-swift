...
UpdateAddHTLC_write(objPointer)
    ...
    public class func read(ser: [UInt8]) throws -> UpdateAddHTLC {
        ...
        return try Result_UpdateAddHTLCDecodeErrorZ(pointer: UpdateAddHTLC_read(serWrapper.cOpaqueStruct!)).getValue();
    }
