			...
			extension Bindings {
				...
				public class Result_RecipientOnionFieldsDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RecipientOnionFieldsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_RecipientOnionFieldsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: RecipientOnionFields) -> Result_RecipientOnionFieldsDecodeErrorZ {
						...
						let returnValue = Result_RecipientOnionFieldsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_RecipientOnionFieldsDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_RecipientOnionFieldsDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_RecipientOnionFieldsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> RecipientOnionFields? {
						if self.cType?.result_ok == true {
							return RecipientOnionFields(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_RecipientOnionFieldsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_RecipientOnionFieldsDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_RecipientOnionFieldsDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
