			...
			extension Bindings {
				...
				public class Result_HTLCOutputInCommitmentDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_HTLCOutputInCommitmentDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_HTLCOutputInCommitmentDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: HTLCOutputInCommitment) -> Result_HTLCOutputInCommitmentDecodeErrorZ {
						...
						let returnValue = Result_HTLCOutputInCommitmentDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_HTLCOutputInCommitmentDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_HTLCOutputInCommitmentDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_HTLCOutputInCommitmentDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> HTLCOutputInCommitment? {
						if self.cType?.result_ok == true {
							return HTLCOutputInCommitment(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_HTLCOutputInCommitmentDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_HTLCOutputInCommitmentDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_HTLCOutputInCommitmentDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
