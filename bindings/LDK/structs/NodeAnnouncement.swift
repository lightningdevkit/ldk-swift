...
NodeAnnouncement_write(objPointer)
    ...
    public class func read(ser: [UInt8]) throws -> NodeAnnouncement {
        ...
        return try Result_NodeAnnouncementDecodeErrorZ(pointer: NodeAnnouncement_read(serWrapper.cOpaqueStruct!)).getValue();
    }
