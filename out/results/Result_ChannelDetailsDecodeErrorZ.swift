			...
			extension Bindings {
				...
				public class Result_ChannelDetailsDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelDetailsDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ChannelDetailsDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ChannelDetailsDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelDetails? {
						if self.cType?.result_ok == true {
							return ChannelDetails(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
