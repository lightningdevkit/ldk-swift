			...
			extension Bindings {
				...
				TrustedClosingTransaction_sign(thisArgPointer, tupledFundingKeyPointer, fundingRedeemscriptPrimitiveWrapper.cType!, channelValueSatoshis)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "TrustedClosingTransaction.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
