			...
			extension Bindings {
				...
				public class Result_ShutdownDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ShutdownDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Shutdown) -> Result_ShutdownDecodeErrorZ {
						...
						let returnValue = Result_ShutdownDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ShutdownDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ShutdownDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ShutdownDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Shutdown? {
						if self.cType?.result_ok == true {
							return Shutdown(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ShutdownDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ShutdownDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ShutdownDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
