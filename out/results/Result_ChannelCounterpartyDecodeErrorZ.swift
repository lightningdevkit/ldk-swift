...
extension Bindings {
	...
	public class Result_ChannelCounterpartyDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ChannelCounterpartyDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: ChannelCounterparty) -> Result_ChannelCounterpartyDecodeErrorZ {
			...
			let returnValue = Result_ChannelCounterpartyDecodeErrorZ(
				...
				instantiationContext: "Result_ChannelCounterpartyDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ChannelCounterpartyDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ChannelCounterpartyDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_ChannelCounterpartyDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ChannelCounterpartyDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ChannelCounterpartyDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
