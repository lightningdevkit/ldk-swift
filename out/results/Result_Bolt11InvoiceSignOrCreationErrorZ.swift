			...
			extension Bindings {
				...
				public class Result_Bolt11InvoiceSignOrCreationErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_Bolt11InvoiceSignOrCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_Bolt11InvoiceSignOrCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Bolt11Invoice) -> Result_Bolt11InvoiceSignOrCreationErrorZ {
						...
						let returnValue = Result_Bolt11InvoiceSignOrCreationErrorZ(cType: nativeCallResult, instantiationContext: "Result_Bolt11InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_Bolt11InvoiceSignOrCreationErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_Bolt11InvoiceSignOrCreationErrorZ>) in
				CResult_Bolt11InvoiceSignOrCreationErrorZ_clone(origPointer)
					...
					public func getError() -> SignOrCreationError? {
						if self.cType?.result_ok == false {
							return SignOrCreationError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_Bolt11InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Bolt11Invoice? {
						if self.cType?.result_ok == true {
							return Bolt11Invoice(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_Bolt11InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_Bolt11InvoiceSignOrCreationErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_Bolt11InvoiceSignOrCreationErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
