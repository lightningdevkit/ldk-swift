			...
			extension Bindings {
				...
				Payee_clone(origPointer)
					...
					public class func initWithBlinded(routeHints: [(BlindedPayInfo, BlindedPath)], features: Bindings.Bolt12InvoiceFeatures) -> Payee {
						// native call variable prep
						
						let routeHintsVector = Vec_C2Tuple_BlindedPayInfoBlindedPathZZ(array: routeHints, instantiationContext: "Payee.swift::\(#function):\(#line)").dangle()
					...
					public class func initWithClear(nodeId: [UInt8], routeHints: [RouteHint], features: Bindings.Bolt11InvoiceFeatures, finalCltvExpiryDelta: UInt32) -> Payee {
						// native call variable prep
						
						let nodeIdPrimitiveWrapper = PublicKey(value: nodeId, instantiationContext: "Payee.swift::\(#function):\(#line)")
				
						let routeHintsVector = Vec_RouteHintZ(array: routeHints, instantiationContext: "Payee.swift::\(#function):\(#line)").dangle()
				

						// native method call
						let nativeCallResult = Payee_clear(nodeIdPrimitiveWrapper.cType!, routeHintsVector.cType!, features.dynamicallyDangledClone().cType!, finalCltvExpiryDelta)
				...
				Payee_eq(aPointer, bPointer)
					...
					public func getValueAsBlinded() -> Blinded? {
						...
						return Payee_LDKBlinded_Body(cType: self.cType!.blinded, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public func getValueAsClear() -> Clear? {
						...
						return Payee_LDKClear_Body(cType: self.cType!.clear, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self)
					}
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Payee \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
					...
					public class Blinded: NativeTypeWrapper {
						...
						internal init(cType: LDKPayee_LDKBlinded_Body, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
						...
						public func getRouteHints() -> [(BlindedPayInfo, BlindedPath)] {
							// return value (do some wrapping)
							let returnValue = Vec_C2Tuple_BlindedPayInfoBlindedPathZZ(cType: self.cType!.route_hints, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self).getValue()
						...
						public func getFeatures() -> Bindings.Bolt12InvoiceFeatures {
							// return value (do some wrapping)
							let returnValue = Bindings.Bolt12InvoiceFeatures(cType: self.cType!.features, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self)
					...
					public class Clear: NativeTypeWrapper {
						...
						internal init(cType: LDKPayee_LDKClear_Body, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
						...
						public func getNodeId() -> [UInt8] {
							// return value (do some wrapping)
							let returnValue = PublicKey(cType: self.cType!.node_id, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self).getValue()
						...
						public func getRouteHints() -> [RouteHint] {
							// return value (do some wrapping)
							let returnValue = Vec_RouteHintZ(cType: self.cType!.route_hints, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self).getValue()
						...
						public func getFeatures() -> Bindings.Bolt11InvoiceFeatures {
							// return value (do some wrapping)
							let returnValue = Bindings.Bolt11InvoiceFeatures(cType: self.cType!.features, instantiationContext: "Payee.swift::\(#function):\(#line)", anchor: self)
