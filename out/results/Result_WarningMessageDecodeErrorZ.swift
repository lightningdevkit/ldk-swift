			...
			extension Bindings {
				...
				public class Result_WarningMessageDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_WarningMessageDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_WarningMessageDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_WarningMessageDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: WarningMessage) -> Result_WarningMessageDecodeErrorZ {
						...
						let returnValue = Result_WarningMessageDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_WarningMessageDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_WarningMessageDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_WarningMessageDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> WarningMessage? {
						if self.cType?.result_ok == true {
							return WarningMessage(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_WarningMessageDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_WarningMessageDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_WarningMessageDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
