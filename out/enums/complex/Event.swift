			...
			extension Bindings {
				...
				Event_clone(origPointer)
					...
					public class func initWithPaymentClaimable(receiverNodeId: [UInt8], paymentHash: [UInt8], onionFields: Bindings.RecipientOnionFields, amountMsat: UInt64, counterpartySkimmedFeeMsat: UInt64, purpose: PaymentPurpose, viaChannelId: [UInt8]?, viaUserChannelId: [UInt8]?, claimDeadline: UInt32?) -> Event {
						// native call variable prep
						...
						let viaChannelIdOption = Option_ThirtyTwoBytesZ(some: viaChannelId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
					...
					public class func initWithPaymentClaimed(receiverNodeId: [UInt8], paymentHash: [UInt8], amountMsat: UInt64, purpose: PaymentPurpose, htlcs: [ClaimedHTLC], senderIntendedTotalMsat: UInt64?) -> Event {
						// native call variable prep
						...
						let htlcsVector = Vec_ClaimedHTLCZ(array: htlcs, instantiationContext: "Event.swift::\(#function):\(#line)").dangle()
				
						let senderIntendedTotalMsatOption = Option_u64Z(some: senderIntendedTotalMsat, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = Event_payment_claimed(receiverNodeIdPrimitiveWrapper.cType!, paymentHashPrimitiveWrapper.cType!, amountMsat, purpose.danglingClone().cType!, htlcsVector.cType!, senderIntendedTotalMsatOption.cType!)
					...
					public class func initWithPaymentSent(paymentId: [UInt8]?, paymentPreimage: [UInt8], paymentHash: [UInt8], feePaidMsat: UInt64?) -> Event {
						...
						let paymentIdOption = Option_ThirtyTwoBytesZ(some: paymentId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
						...
						// native method call
						let nativeCallResult = Event_payment_sent(paymentIdOption.cType!, paymentPreimagePrimitiveWrapper.cType!, paymentHashPrimitiveWrapper.cType!, feePaidMsatOption.cType!)
					...
					public class func initWithPaymentPathSuccessful(paymentId: [UInt8], paymentHash: [UInt8]?, path: Bindings.Path) -> Event {
						...
						let paymentHashOption = Option_ThirtyTwoBytesZ(some: paymentHash, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = Event_payment_path_successful(paymentIdPrimitiveWrapper.cType!, paymentHashOption.cType!, path.dynamicallyDangledClone().cType!)
					...
					public class func initWithPaymentPathFailed(paymentId: [UInt8]?, paymentHash: [UInt8], paymentFailedPermanently: Bool, failure: PathFailure, path: Bindings.Path, shortChannelId: UInt64?) -> Event {
						...
						// native method call
						let nativeCallResult = Event_payment_path_failed(paymentIdOption.cType!, paymentHashPrimitiveWrapper.cType!, paymentFailedPermanently, failure.danglingClone().cType!, path.dynamicallyDangledClone().cType!, shortChannelIdOption.cType!)
					...
					public class func initWithSpendableOutputs(outputs: [SpendableOutputDescriptor], channelId: [UInt8]?) -> Event {
						...
						let channelIdOption = Option_ThirtyTwoBytesZ(some: channelId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
					...
					public class func initWithPaymentForwarded(prevChannelId: [UInt8]?, nextChannelId: [UInt8]?, feeEarnedMsat: UInt64?, claimFromOnchainTx: Bool, outboundAmountForwardedMsat: UInt64?) -> Event {
						...
						let prevChannelIdOption = Option_ThirtyTwoBytesZ(some: prevChannelId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
				
						let nextChannelIdOption = Option_ThirtyTwoBytesZ(some: nextChannelId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
						...
						// native method call
						let nativeCallResult = Event_payment_forwarded(prevChannelIdOption.cType!, nextChannelIdOption.cType!, feeEarnedMsatOption.cType!, claimFromOnchainTx, outboundAmountForwardedMsatOption.cType!)
					...
					public class func initWithChannelPending(channelId: [UInt8], userChannelId: [UInt8], formerTemporaryChannelId: [UInt8]?, counterpartyNodeId: [UInt8], fundingTxo: Bindings.OutPoint) -> Event {
						...
						let formerTemporaryChannelIdOption = Option_ThirtyTwoBytesZ(some: formerTemporaryChannelId, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
				
						let counterpartyNodeIdPrimitiveWrapper = PublicKey(value: counterpartyNodeId, instantiationContext: "Event.swift::\(#function):\(#line)")
				

						// native method call
						let nativeCallResult = Event_channel_pending(channelIdPrimitiveWrapper.cType!, userChannelIdPrimitiveWrapper.cType!, formerTemporaryChannelIdOption.cType!, counterpartyNodeIdPrimitiveWrapper.cType!, fundingTxo.dynamicallyDangledClone().cType!)
					...
					public class func initWithChannelClosed(channelId: [UInt8], userChannelId: [UInt8], reason: ClosureReason, counterpartyNodeId: [UInt8], channelCapacitySats: UInt64?) -> Event {
						// native call variable prep
						...
						let channelCapacitySatsOption = Option_u64Z(some: channelCapacitySats, instantiationContext: "Event.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = Event_channel_closed(channelIdPrimitiveWrapper.cType!, userChannelIdPrimitiveWrapper.cType!, reason.danglingClone().cType!, counterpartyNodeIdPrimitiveWrapper.cType!, channelCapacitySatsOption.cType!)
				...
				Event_write(objPointer)
					...
					public func getValueAsBumpTransaction() -> BumpTransactionEvent? {
						...
						return BumpTransactionEvent(cType: self.cType!.bump_transaction, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public class PaymentClaimable: NativeTypeWrapper {
						...
						public func getViaChannelId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.via_channel_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class PaymentClaimed: NativeTypeWrapper {
						...
						public func getHtlcs() -> [ClaimedHTLC] {
							// return value (do some wrapping)
							let returnValue = Vec_ClaimedHTLCZ(cType: self.cType!.htlcs, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
						...
						public func getSenderIntendedTotalMsat() -> UInt64? {
							// return value (do some wrapping)
							let returnValue = Option_u64Z(cType: self.cType!.sender_intended_total_msat, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class PaymentSent: NativeTypeWrapper {
						...
						public func getPaymentId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.payment_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class PaymentPathSuccessful: NativeTypeWrapper {
						...
						public func getPaymentHash() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.payment_hash, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class SpendableOutputs: NativeTypeWrapper {
						...
						public func getChannelId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.channel_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class PaymentForwarded: NativeTypeWrapper {
						...
						public func getPrevChannelId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.prev_channel_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
						...
						public func getNextChannelId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.next_channel_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class ChannelPending: NativeTypeWrapper {
						...
						public func getFormerTemporaryChannelId() -> [UInt8]? {
							// return value (do some wrapping)
							let returnValue = Option_ThirtyTwoBytesZ(cType: self.cType!.former_temporary_channel_id, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public class ChannelClosed: NativeTypeWrapper {
						...
						public func getChannelCapacitySats() -> UInt64? {
							// return value (do some wrapping)
							let returnValue = Option_u64Z(cType: self.cType!.channel_capacity_sats, instantiationContext: "Event.swift::\(#function):\(#line)", anchor: self).getValue()
