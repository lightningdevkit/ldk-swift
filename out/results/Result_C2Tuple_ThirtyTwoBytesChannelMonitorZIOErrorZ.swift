...
public typealias Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ, instantiationContext: String,
			...
			-> Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ
		{
			...
			let oTuple = Tuple_ThirtyTwoBytesChannelMonitorZ(
				...
				instantiationContext:
					"Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		internal func clone() -> Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ>) in
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
