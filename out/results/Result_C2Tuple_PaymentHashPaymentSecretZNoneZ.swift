			...
			extension Bindings {
				...
				public class Result_C2Tuple_PaymentHashPaymentSecretZNoneZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_PaymentHashPaymentSecretZNoneZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ([UInt8], [UInt8])) -> Result_C2Tuple_PaymentHashPaymentSecretZNoneZ {
						...
						let oTuple = Tuple_PaymentHashPaymentSecretZ(tuple: o, instantiationContext: "Result_C2Tuple_PaymentHashPaymentSecretZNoneZ.swift::\(#function):\(#line)").danglingClone()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_C2Tuple_PaymentHashPaymentSecretZNoneZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_C2Tuple_PaymentHashPaymentSecretZNoneZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
