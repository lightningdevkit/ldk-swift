...
public typealias Result_UnsignedChannelAnnouncementDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_UnsignedChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_UnsignedChannelAnnouncementDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: UnsignedChannelAnnouncement) -> Result_UnsignedChannelAnnouncementDecodeErrorZ {
			...
			// native method call
			let nativeCallResult = CResult_UnsignedChannelAnnouncementDecodeErrorZ_ok(
			...
			let returnValue = Result_UnsignedChannelAnnouncementDecodeErrorZ(
				cType: nativeCallResult,
				instantiationContext: "Result_UnsignedChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_UnsignedChannelAnnouncementDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_UnsignedChannelAnnouncementDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_UnsignedChannelAnnouncementDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_UnsignedChannelAnnouncementDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_UnsignedChannelAnnouncementDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
