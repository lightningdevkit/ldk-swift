			...
			extension Bindings {
				...
				Refund_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = Refund(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)")
				...
				Refund_description(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PrintableString(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Refund_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_DurationZ(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				Refund_paths(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_BlindedPathZ(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Refund_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = u8slice(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle().getValue()
				...
				Refund_chain(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Refund_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = InvoiceRequestFeatures(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Refund_quantity(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				Refund_payer_id(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Refund_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "Refund.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					internal func dangle(_ shouldDangle: Bool = true) -> Refund {
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Refund \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
