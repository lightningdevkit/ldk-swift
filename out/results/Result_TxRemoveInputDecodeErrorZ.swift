			...
			extension Bindings {
				...
				public class Result_TxRemoveInputDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_TxRemoveInputDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_TxRemoveInputDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: TxRemoveInput) -> Result_TxRemoveInputDecodeErrorZ {
						...
						let returnValue = Result_TxRemoveInputDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_TxRemoveInputDecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_TxRemoveInputDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_TxRemoveInputDecodeErrorZ>) in
				CResult_TxRemoveInputDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_TxRemoveInputDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> TxRemoveInput? {
						if self.cType?.result_ok == true {
							return TxRemoveInput(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_TxRemoveInputDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_TxRemoveInputDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_TxRemoveInputDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
