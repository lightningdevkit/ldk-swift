			...
			extension Bindings {
				...
				public class Result_ChannelUpdateInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelUpdateInfoDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ChannelUpdateInfoDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ChannelUpdateInfoDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelUpdateInfo? {
						if self.cType?.result_ok == true {
							return ChannelUpdateInfo(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
