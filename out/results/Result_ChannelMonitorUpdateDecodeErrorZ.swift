			...
			extension Bindings {
				...
				public class Result_ChannelMonitorUpdateDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelMonitorUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelMonitorUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelMonitorUpdate) -> Result_ChannelMonitorUpdateDecodeErrorZ {
						...
						let returnValue = Result_ChannelMonitorUpdateDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelMonitorUpdateDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelMonitorUpdateDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelMonitorUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelMonitorUpdate? {
						if self.cType?.result_ok == true {
							return ChannelMonitorUpdate(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelMonitorUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelMonitorUpdateDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelMonitorUpdateDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
