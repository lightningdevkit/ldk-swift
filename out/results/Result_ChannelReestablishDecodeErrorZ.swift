			...
			extension Bindings {
				...
				public class Result_ChannelReestablishDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelReestablishDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelReestablishDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelReestablish) -> Result_ChannelReestablishDecodeErrorZ {
						...
						let returnValue = Result_ChannelReestablishDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelReestablishDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelReestablishDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelReestablishDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelReestablish? {
						if self.cType?.result_ok == true {
							return ChannelReestablish(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelReestablishDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelReestablishDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelReestablishDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
