...
public typealias Result_HolderCommitmentTransactionDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_HolderCommitmentTransactionDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_HolderCommitmentTransactionDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: HolderCommitmentTransaction) -> Result_HolderCommitmentTransactionDecodeErrorZ {
			...
			// native method call
			let nativeCallResult = CResult_HolderCommitmentTransactionDecodeErrorZ_ok(
			...
			let returnValue = Result_HolderCommitmentTransactionDecodeErrorZ(
				...
				instantiationContext: "Result_HolderCommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_HolderCommitmentTransactionDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_HolderCommitmentTransactionDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_HolderCommitmentTransactionDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_HolderCommitmentTransactionDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_HolderCommitmentTransactionDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
