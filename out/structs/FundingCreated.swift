			...
			extension Bindings {
				...
				FundingCreated_get_signature(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "FundingCreated.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setSignature(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ECDSASignature(value: val, instantiationContext: "FundingCreated.swift::\(#function):\(#line)")
				...
				FundingCreated_set_signature(thisPtrPointer, valPrimitiveWrapper.cType!)
					...
					public init(temporaryChannelIdArg: [UInt8], fundingTxidArg: [UInt8], fundingOutputIndexArg: UInt16, signatureArg: [UInt8]) {
						...
						let signatureArgPrimitiveWrapper = ECDSASignature(value: signatureArg, instantiationContext: "FundingCreated.swift::\(#function):\(#line)")
