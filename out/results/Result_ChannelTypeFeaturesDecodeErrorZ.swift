			...
			extension Bindings {
				...
				public class Result_ChannelTypeFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelTypeFeaturesDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ChannelTypeFeaturesDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ChannelTypeFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelTypeFeatures? {
						if self.cType?.result_ok == true {
							return ChannelTypeFeatures(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
