			...
			extension Bindings {
				...
				public class Result_InvoiceParseOrSemanticErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_InvoiceParseOrSemanticErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Invoice) -> Result_InvoiceParseOrSemanticErrorZ {
						...
						let returnValue = Result_InvoiceParseOrSemanticErrorZ(cType: nativeCallResult, instantiationContext: "Result_InvoiceParseOrSemanticErrorZ.swift::\(#function):\(#line)")
				...
				CResult_InvoiceParseOrSemanticErrorZ_clone(origPointer)
					...
					public func getError() -> ParseOrSemanticError? {
						if self.cType?.result_ok == false {
							return ParseOrSemanticError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_InvoiceParseOrSemanticErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Invoice? {
						if self.cType?.result_ok == true {
							return Invoice(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_InvoiceParseOrSemanticErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_InvoiceParseOrSemanticErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_InvoiceParseOrSemanticErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
