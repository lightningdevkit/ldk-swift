			...
			extension Bindings {
				...
				public class Result_TxSignaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_TxSignaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_TxSignaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: TxSignatures) -> Result_TxSignaturesDecodeErrorZ {
						...
						let returnValue = Result_TxSignaturesDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_TxSignaturesDecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_TxSignaturesDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_TxSignaturesDecodeErrorZ>) in
				CResult_TxSignaturesDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_TxSignaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> TxSignatures? {
						if self.cType?.result_ok == true {
							return TxSignatures(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_TxSignaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_TxSignaturesDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_TxSignaturesDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
