...
public class Bindings{
	...
	public class func swift_sign(msg: [UInt8], sk: [UInt8]) -> Result_StringErrorZ {
				...
				return 
				Result_StringErrorZ(pointer: sign(Bindings.new_LDKu8slice(array: msg), Bindings.new_LDKSecretKey(array: sk)))
...
withUnsafePointer(to: keys.cOpaqueStruct!) { (keysPointer: UnsafePointer<LDKTxCreationKeys>) in
	...
	public class func swift_build_htlc_transaction(prev_hash: [UInt8], feerate_per_kw: UInt32, contest_delay: UInt16, htlc: HTLCOutputInCommitment, broadcaster_delayed_payment_key: [UInt8], revocation_key: [UInt8]) -> [UInt8] {
		
				return withUnsafePointer(to: Bindings.array_to_tuple32(array: prev_hash)) { (prev_hashPointer: UnsafePointer<(UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8,UInt8)>) in
withUnsafePointer(to: htlc.cOpaqueStruct!) { (htlcPointer: UnsafePointer<LDKHTLCOutputInCommitment>) in

				Bindings.LDKTransaction_to_array(nativeType: build_htlc_transaction(prev_hashPointer, feerate_per_kw, contest_delay, htlcPointer, Bindings.new_LDKPublicKey(array: broadcaster_delayed_payment_key), Bindings.new_LDKPublicKey(array: revocation_key)))
