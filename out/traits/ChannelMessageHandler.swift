			...
			extension Bindings {
				...
				open class ChannelMessageHandler: NativeTraitWrapper {
					...
					public init(messageSendEventsProvider: MessageSendEventsProvider) {
						...
						func handleOpenChannelV2Lambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKOpenChannelV2>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleOpenChannelV2Lambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleOpenChannelV2(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: OpenChannelV2(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleAcceptChannelV2Lambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKAcceptChannelV2>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleAcceptChannelV2Lambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleAcceptChannelV2(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: AcceptChannelV2(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxAddInputLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxAddInput>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxAddInputLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxAddInput(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxAddInput(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxAddOutputLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxAddOutput>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxAddOutputLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxAddOutput(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxAddOutput(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxRemoveInputLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxRemoveInput>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxRemoveInputLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxRemoveInput(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxRemoveInput(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxRemoveOutputLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxRemoveOutput>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxRemoveOutputLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxRemoveOutput(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxRemoveOutput(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxCompleteLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxComplete>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxCompleteLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxComplete(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxComplete(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxSignaturesLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxSignatures>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxSignaturesLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxSignatures(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxSignatures(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxInitRbfLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxInitRbf>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxInitRbfLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxInitRbf(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxInitRbf(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxAckRbfLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxAckRbf>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxAckRbfLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxAckRbf(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxAckRbf(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func handleTxAbortLambda(this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: UnsafePointer<LDKTxAbort>) -> Void {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::handleTxAbortLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.handleTxAbort(theirNodeId: PublicKey(cType: their_node_id, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").getValue(), msg: TxAbort(cType: msg.pointee, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func getGenesisHashesLambda(this_arg: UnsafeRawPointer?) -> LDKCOption_CVec_ThirtyTwoBytesZZ {
							let instance: ChannelMessageHandler = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "ChannelMessageHandler::getGenesisHashesLambda")
							...
							// return value (do some wrapping)
							let returnValue = Option_CVec_ThirtyTwoBytesZZ(some: swiftCallbackResult, instantiationContext: "ChannelMessageHandler.swift::init()::\(#function):\(#line)").danglingClone().cType!
			...
			open func handleOpenChannelV2(theirNodeId: [UInt8], msg: OpenChannelV2) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleOpenChannelV2 MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func handleAcceptChannelV2(theirNodeId: [UInt8], msg: AcceptChannelV2) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleAcceptChannelV2 MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func handleTxAddInput(theirNodeId: [UInt8], msg: TxAddInput) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxAddInput MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_add_output` message from the given peer.
			open func handleTxAddOutput(theirNodeId: [UInt8], msg: TxAddOutput) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxAddOutput MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_remove_input` message from the given peer.
			open func handleTxRemoveInput(theirNodeId: [UInt8], msg: TxRemoveInput) -> Void {
			...
			open func handleTxRemoveOutput(theirNodeId: [UInt8], msg: TxRemoveOutput) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxRemoveOutput MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_complete message` from the given peer.
			open func handleTxComplete(theirNodeId: [UInt8], msg: TxComplete) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxComplete MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_signatures` message from the given peer.
			open func handleTxSignatures(theirNodeId: [UInt8], msg: TxSignatures) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxSignatures MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_init_rbf` message from the given peer.
			open func handleTxInitRbf(theirNodeId: [UInt8], msg: TxInitRbf) -> Void {
			...
			open func handleTxAckRbf(theirNodeId: [UInt8], msg: TxAckRbf) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxAckRbf MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
		
			/// Handle an incoming `tx_abort message` from the given peer.
			open func handleTxAbort(theirNodeId: [UInt8], msg: TxAbort) -> Void {
				
				Bindings.print("Error: ChannelMessageHandler::handleTxAbort MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			public override func handleOpenChannelV2(theirNodeId: [UInt8], msg: OpenChannelV2) {
				...
				self.cType!.handle_open_channel_v2(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleAcceptChannelV2(theirNodeId: [UInt8], msg: AcceptChannelV2) {
				...
				self.cType!.handle_accept_channel_v2(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleTxAddInput(theirNodeId: [UInt8], msg: TxAddInput) {
				...
				self.cType!.handle_tx_add_input(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleTxAddOutput(theirNodeId: [UInt8], msg: TxAddOutput) {
				...
				self.cType!.handle_tx_add_output(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleTxRemoveInput(theirNodeId: [UInt8], msg: TxRemoveInput) {
				...
				self.cType!.handle_tx_remove_input(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleTxRemoveOutput(theirNodeId: [UInt8], msg: TxRemoveOutput) {
				...
				self.cType!.handle_tx_remove_output(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func handleTxSignatures(theirNodeId: [UInt8], msg: TxSignatures) {
				...
				self.cType!.handle_tx_signatures(self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msgPointer)
						}
			...
			public override func getGenesisHashes() -> [[UInt8]]? {
				...
				// return value (do some wrapping)
				let returnValue = Option_CVec_ThirtyTwoBytesZZ(cType: nativeCallResult, instantiationContext: "ChannelMessageHandler.swift::\(#function):\(#line)").getValue()
