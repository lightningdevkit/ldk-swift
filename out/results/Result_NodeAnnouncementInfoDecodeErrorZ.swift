			...
			extension Bindings {
				...
				public class Result_NodeAnnouncementInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
