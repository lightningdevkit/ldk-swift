			...
			extension Bindings {
				...
				public class Result_ChannelPublicKeysDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelPublicKeysDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ChannelPublicKeysDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ChannelPublicKeysDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelPublicKeys? {
						if self.cType?.result_ok == true {
							return ChannelPublicKeys(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
