				...
				open class NodeSigner: NativeTraitWrapper {
					...
					public init() {
						...
						func getInboundPaymentKeyMaterialLambda(this_arg: UnsafeRawPointer?) -> LDKThirtyTwoBytes {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::getInboundPaymentKeyMaterialLambda")
							...
							let returnValue = ThirtyTwoBytes(value: swiftCallbackResult, instantiationContext: "NodeSigner.swift::init()::\(#function):\(#line)").dangleRecursively().cType!

							return returnValue
						}
		
						func getNodeIdLambda(this_arg: UnsafeRawPointer?, recipient: LDKRecipient) -> LDKCResult_PublicKeyNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::getNodeIdLambda")
						...
						func ecdhLambda(this_arg: UnsafeRawPointer?, recipient: LDKRecipient, other_key: LDKPublicKey, tweak: LDKCOption_BigEndianScalarZ) -> LDKCResult_ThirtyTwoBytesNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::ecdhLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.ecdh(recipient: Recipient(value: recipient), otherKey: PublicKey(cType: other_key, instantiationContext: "NodeSigner.swift::init()::\(#function):\(#line)").getValue(), tweak: Option_BigEndianScalarZ(cType: tweak, instantiationContext: "NodeSigner.swift::init()::\(#function):\(#line)").getValue())
						...
						func signInvoiceLambda(this_arg: UnsafeRawPointer?, hrp_bytes: LDKu8slice, invoice_data: LDKCVec_U5Z, recipient: LDKRecipient) -> LDKCResult_RecoverableSignatureNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::signInvoiceLambda")
						...
						func signBolt12InvoiceRequestLambda(this_arg: UnsafeRawPointer?, invoice_request: UnsafePointer<LDKUnsignedInvoiceRequest>) -> LDKCResult_SchnorrSignatureNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::signBolt12InvoiceRequestLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.signBolt12InvoiceRequest(invoiceRequest: UnsignedInvoiceRequest(cType: invoice_request.pointee, instantiationContext: "NodeSigner.swift::init()::\(#function):\(#line)").dangle())
						...
						func signBolt12InvoiceLambda(this_arg: UnsafeRawPointer?, invoice: UnsafePointer<LDKUnsignedBolt12Invoice>) -> LDKCResult_SchnorrSignatureNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::signBolt12InvoiceLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.signBolt12Invoice(invoice: UnsignedBolt12Invoice(cType: invoice.pointee, instantiationContext: "NodeSigner.swift::init()::\(#function):\(#line)").dangle())
						...
						func signGossipMessageLambda(this_arg: UnsafeRawPointer?, msg: LDKUnsignedGossipMessage) -> LDKCResult_ECDSASignatureNoneZ {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::signGossipMessageLambda")
						...
						func freeLambda(this_arg: UnsafeMutableRawPointer?) -> Void {
							let instance: NodeSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "NodeSigner::freeLambda")
			...
			open func getInboundPaymentKeyMaterial() -> [UInt8] {
				...
				Bindings.print("Error: NodeSigner::getInboundPaymentKeyMaterial MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func getNodeId(recipient: Recipient) -> Result_PublicKeyNoneZ {
				...
				Bindings.print("Error: NodeSigner::getNodeId MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func ecdh(recipient: Recipient, otherKey: [UInt8], tweak: [UInt8]?) -> Result_ThirtyTwoBytesNoneZ {
				...
				Bindings.print("Error: NodeSigner::ecdh MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			/// Sign an invoice.
					...
					/// 
					/// Errors if the [`Recipient`] variant is not supported by the implementation.
			open func signInvoice(hrpBytes: [UInt8], invoiceData: [UInt8], recipient: Recipient) -> Result_RecoverableSignatureNoneZ {
				
				Bindings.print("Error: NodeSigner::signInvoice MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func signBolt12InvoiceRequest(invoiceRequest: UnsignedInvoiceRequest) -> Result_SchnorrSignatureNoneZ {
				...
				Bindings.print("Error: NodeSigner::signBolt12InvoiceRequest MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			open func signBolt12Invoice(invoice: UnsignedBolt12Invoice) -> Result_SchnorrSignatureNoneZ {
				...
				Bindings.print("Error: NodeSigner::signBolt12Invoice MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			/// Gets the ECDH shared secret of our node secret and `other_key`, multiplying by `tweak` if
					...
					/// 
					/// Errors if the [`Recipient`] variant is not supported by the implementation.
			public override func ecdh(recipient: Recipient, otherKey: [UInt8], tweak: [UInt8]?) -> Result_ThirtyTwoBytesNoneZ {
				// native call variable prep
				
						let otherKeyPrimitiveWrapper = PublicKey(value: otherKey, instantiationContext: "NodeSigner.swift::\(#function):\(#line)")
				
						let tweakOption = Option_BigEndianScalarZ(some: tweak, instantiationContext: "NodeSigner.swift::\(#function):\(#line)").danglingClone()
				...
				// return value (do some wrapping)
				let returnValue = Result_ThirtyTwoBytesNoneZ(cType: nativeCallResult, instantiationContext: "NodeSigner.swift::\(#function):\(#line)")
			...
			public override func signInvoice(hrpBytes: [UInt8], invoiceData: [UInt8], recipient: Recipient) -> Result_RecoverableSignatureNoneZ {
				...
				// native method call
				let nativeCallResult = self.cType!.sign_invoice(self.cType!.this_arg, hrpBytesPrimitiveWrapper.cType!, invoiceDataVector.cType!, recipient.getCValue())
			...
			/// Signs the [`TaggedHash`] of a BOLT 12 invoice request.
					...
					/// 
					/// [`TaggedHash`]: crate::offers::merkle::TaggedHash
			public override func signBolt12InvoiceRequest(invoiceRequest: UnsignedInvoiceRequest) -> Result_SchnorrSignatureNoneZ {
				// native call variable prep
				...
				let nativeCallResult = 
						withUnsafePointer(to: invoiceRequest.cType!) { (invoiceRequestPointer: UnsafePointer<LDKUnsignedInvoiceRequest>) in
				...
				// return value (do some wrapping)
				let returnValue = Result_SchnorrSignatureNoneZ(cType: nativeCallResult, instantiationContext: "NodeSigner.swift::\(#function):\(#line)")
			...
			public override func signGossipMessage(msg: UnsignedGossipMessage) -> Result_ECDSASignatureNoneZ {
				...
				// return value (do some wrapping)
				let returnValue = Result_ECDSASignatureNoneZ(cType: nativeCallResult, instantiationContext: "NodeSigner.swift::\(#function):\(#line)")
