...
public typealias Option_WriteableScoreZ = Bindings.Option_WriteableScoreZ
	...
	public class Option_WriteableScoreZ: NativeTypeWrapper {
		...
		public func getValue() -> WriteableScore? {
				...
				if self.cOpaqueStruct!.tag == LDKCOption_WriteableScoreZ_Some {
					return WriteableScore(pointer: self.cOpaqueStruct!.some, anchor: self).dangle()
				}
		...
		public class func some(o: Bindings.WriteableScore) -> Option_WriteableScoreZ {
