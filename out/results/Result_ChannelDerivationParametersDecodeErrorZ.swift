...
extension Bindings {
	...
	public class Result_ChannelDerivationParametersDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ChannelDerivationParametersDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: ChannelDerivationParameters) -> Result_ChannelDerivationParametersDecodeErrorZ {
			...
			// native method call
			let nativeCallResult = CResult_ChannelDerivationParametersDecodeErrorZ_ok(
			...
			let returnValue = Result_ChannelDerivationParametersDecodeErrorZ(
				...
				instantiationContext: "Result_ChannelDerivationParametersDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ChannelDerivationParametersDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ChannelDerivationParametersDecodeErrorZ>) in
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ChannelDerivationParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ChannelDerivationParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
