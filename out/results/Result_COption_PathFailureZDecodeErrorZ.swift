...
extension Bindings {
	...
	public class Result_COption_PathFailureZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_PathFailureZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: PathFailure?) -> Result_COption_PathFailureZDecodeErrorZ {
			...
			let oOption = Option_PathFailureZ(
				some: o, instantiationContext: "Result_COption_PathFailureZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
			...
			let returnValue = Result_COption_PathFailureZDecodeErrorZ(
				...
				instantiationContext: "Result_COption_PathFailureZDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_COption_PathFailureZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_PathFailureZDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_COption_PathFailureZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_PathFailureZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_PathFailureZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
