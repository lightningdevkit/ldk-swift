			...
			extension Bindings {
				...
				public class Result_ChannelMonitorUpdateStatusNoneZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelMonitorUpdateStatusNoneZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelMonitorUpdateStatusNoneZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelMonitorUpdateStatus) -> Result_ChannelMonitorUpdateStatusNoneZ {
						...
						let returnValue = Result_ChannelMonitorUpdateStatusNoneZ(cType: nativeCallResult, instantiationContext: "Result_ChannelMonitorUpdateStatusNoneZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_ChannelMonitorUpdateStatusNoneZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_ChannelMonitorUpdateStatusNoneZ>) in
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelMonitorUpdateStatusNoneZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelMonitorUpdateStatusNoneZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
