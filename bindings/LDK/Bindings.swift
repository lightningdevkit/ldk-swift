...
class Bindings{
	...
	/* SWIFT_TO_RUST_START */
	static func new_LDKCVec_SignatureZ(array: [LDKSignature]) -> LDKCVec_SignatureZ {

        let dataContainer = array.withUnsafeBufferPointer { (pointer: UnsafeBufferPointer<LDKSignature>) -> UnsafeMutablePointer<LDKSignature> in
	...
	/* RUST_TO_SWIFT_START */
    static func LDKCVec_SignatureZ_to_array(nativeType: LDKCVec_SignatureZ) -> [LDKSignature] {
	...
	/* SWIFT_TO_RUST_START */
	static func new_LDKCVec_TransactionZ(array: [LDKTransaction]) -> LDKCVec_TransactionZ {

        let dataContainer = array.withUnsafeBufferPointer { (pointer: UnsafeBufferPointer<LDKTransaction>) -> UnsafeMutablePointer<LDKTransaction> in
	...
	/* RUST_TO_SWIFT_START */
    static func LDKCVec_TransactionZ_to_array(nativeType: LDKCVec_TransactionZ) -> [LDKTransaction] {
	...
	/* SWIFT_TO_RUST_START */
	static func new_LDKCVec_PublicKeyZ(array: [LDKPublicKey]) -> LDKCVec_PublicKeyZ {

        let dataContainer = array.withUnsafeBufferPointer { (pointer: UnsafeBufferPointer<LDKPublicKey>) -> UnsafeMutablePointer<LDKPublicKey> in
	...
	/* RUST_TO_SWIFT_START */
    static func LDKCVec_PublicKeyZ_to_array(nativeType: LDKCVec_PublicKeyZ) -> [LDKPublicKey] {
