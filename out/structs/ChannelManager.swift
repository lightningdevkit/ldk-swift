			...
			extension Bindings {
				...
				public class ChannelManager: NativeTypeWrapper {
					...
					public init(feeEst: FeeEstimator, chainMonitor: Watch, txBroadcaster: BroadcasterInterface, router: Router, logger: Logger, entropySource: EntropySource, nodeSigner: NodeSigner, signerProvider: SignerProvider, config: UserConfig, params: ChainParameters, currentTimestamp: UInt32) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = ChannelManager_new(feeEst.activate().cType!, chainMonitor.activate().cType!, txBroadcaster.activate().cType!, router.activate().cType!, logger.activate().cType!, entropySource.activate().cType!, nodeSigner.activate().cType!, signerProvider.activate().cType!, config.dynamicallyDangledClone().cType!, params.dynamicallyDangledClone().cType!, currentTimestamp)
				...
				ChannelManager_get_current_default_configuration(thisArgPointer)
					...
					public func createChannel(theirNetworkKey: [UInt8], channelValueSatoshis: UInt64, pushMsat: UInt64, userChannelId: [UInt8], overrideConfig: UserConfig) -> Result_ThirtyTwoBytesAPIErrorZ {
						// native call variable prep
				...
				ChannelManager_create_channel(thisArgPointer, theirNetworkKeyPrimitiveWrapper.cType!, channelValueSatoshis, pushMsat, userChannelIdPrimitiveWrapper.cType!, overrideConfig.dynamicallyDangledClone().cType!)
						...
						// return value (do some wrapping)
						let returnValue = Result_ThirtyTwoBytesAPIErrorZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				ChannelManager_list_usable_channels(thisArgPointer)
					...
					public func listChannelsWithCounterparty(counterpartyNodeId: [UInt8]) -> [ChannelDetails] {
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_list_channels_with_counterparty(thisArgPointer, counterpartyNodeIdPrimitiveWrapper.cType!)
						}
				...
				ChannelManager_close_channel(thisArgPointer, tupledChannelIdPointer, counterpartyNodeIdPrimitiveWrapper.cType!)
					...
					public func closeChannelWithFeerateAndScript(channelId: [UInt8], counterpartyNodeId: [UInt8], targetFeerateSatsPer1000Weight: UInt32?, shutdownScript: ShutdownScript) -> Result_NoneAPIErrorZ {
						// native call variable prep
						...
						let targetFeerateSatsPer1000WeightOption = Option_u32Z(some: targetFeerateSatsPer1000Weight, instantiationContext: "ChannelManager.swift::\(#function):\(#line)").danglingClone()
						...
						withUnsafePointer(to: tupledChannelId) { (tupledChannelIdPointer: UnsafePointer<UInt8Tuple32>) in
				ChannelManager_close_channel_with_feerate_and_script(thisArgPointer, tupledChannelIdPointer, counterpartyNodeIdPrimitiveWrapper.cType!, targetFeerateSatsPer1000WeightOption.cType!, shutdownScript.dynamicallyDangledClone().cType!)
						}
				...
				ChannelManager_force_close_all_channels_without_broadcasting_txn(thisArgPointer)
					...
					public func sendPaymentWithRoute(route: Route, paymentHash: [UInt8], recipientOnion: RecipientOnionFields, paymentId: [UInt8]) -> Result_NonePaymentSendFailureZ {
						// native call variable prep
				...
				ChannelManager_send_payment_with_route(thisArgPointer, routePointer, paymentHashPrimitiveWrapper.cType!, recipientOnion.dynamicallyDangledClone().cType!, paymentIdPrimitiveWrapper.cType!)
						}
					...
					public func sendPayment(paymentHash: [UInt8], recipientOnion: RecipientOnionFields, paymentId: [UInt8], routeParams: RouteParameters, retryStrategy: Retry) -> Result_NoneRetryableSendFailureZ {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_send_payment(thisArgPointer, paymentHashPrimitiveWrapper.cType!, recipientOnion.dynamicallyDangledClone().cType!, paymentIdPrimitiveWrapper.cType!, routeParams.dynamicallyDangledClone().cType!, retryStrategy.danglingClone().cType!)
						}
				...
				ChannelManager_abandon_payment(thisArgPointer, paymentIdPrimitiveWrapper.cType!)
					...
					public func sendSpontaneousPayment(route: Route, paymentPreimage: [UInt8]?, recipientOnion: RecipientOnionFields, paymentId: [UInt8]) -> Result_ThirtyTwoBytesPaymentSendFailureZ {
						// native call variable prep
						
						let paymentPreimageOption = Option_ThirtyTwoBytesZ(some: paymentPreimage, instantiationContext: "ChannelManager.swift::\(#function):\(#line)").danglingClone()
						...
						withUnsafePointer(to: route.cType!) { (routePointer: UnsafePointer<LDKRoute>) in
				ChannelManager_send_spontaneous_payment(thisArgPointer, routePointer, paymentPreimageOption.cType!, recipientOnion.dynamicallyDangledClone().cType!, paymentIdPrimitiveWrapper.cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Result_ThirtyTwoBytesPaymentSendFailureZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public func sendSpontaneousPaymentWithRetry(paymentPreimage: [UInt8]?, recipientOnion: RecipientOnionFields, paymentId: [UInt8], routeParams: RouteParameters, retryStrategy: Retry) -> Result_ThirtyTwoBytesRetryableSendFailureZ {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_send_spontaneous_payment_with_retry(thisArgPointer, paymentPreimageOption.cType!, recipientOnion.dynamicallyDangledClone().cType!, paymentIdPrimitiveWrapper.cType!, routeParams.dynamicallyDangledClone().cType!, retryStrategy.danglingClone().cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Result_ThirtyTwoBytesRetryableSendFailureZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				ChannelManager_send_probe(thisArgPointer, path.dynamicallyDangledClone().cType!)
						...
						// return value (do some wrapping)
						let returnValue = Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZPaymentSendFailureZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public func sendSpontaneousPreflightProbes(nodeId: [UInt8], amountMsat: UInt64, finalCltvExpiryDelta: UInt32, liquidityLimitMultiplier: UInt64?) -> Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbeSendFailureZ {
						// native call variable prep
						
						let nodeIdPrimitiveWrapper = PublicKey(value: nodeId, instantiationContext: "ChannelManager.swift::\(#function):\(#line)")
				
						let liquidityLimitMultiplierOption = Option_u64Z(some: liquidityLimitMultiplier, instantiationContext: "ChannelManager.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_send_spontaneous_preflight_probes(thisArgPointer, nodeIdPrimitiveWrapper.cType!, amountMsat, finalCltvExpiryDelta, liquidityLimitMultiplierOption.cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbeSendFailureZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public func sendPreflightProbes(routeParams: RouteParameters, liquidityLimitMultiplier: UInt64?) -> Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbeSendFailureZ {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_send_preflight_probes(thisArgPointer, routeParams.dynamicallyDangledClone().cType!, liquidityLimitMultiplierOption.cType!)
						}
				...
				ChannelManager_funding_transaction_generated(thisArgPointer, tupledTemporaryChannelIdPointer, counterpartyNodeIdPrimitiveWrapper.cType!, fundingTransactionPrimitiveWrapper.cType!)
					...
					public func batchFundingTransactionGenerated(temporaryChannels: [([UInt8], [UInt8])], fundingTransaction: [UInt8]) -> Result_NoneAPIErrorZ {
						// native call variable prep
						
						let temporaryChannelsVector = Vec_C2Tuple_ThirtyTwoBytesPublicKeyZZ(array: temporaryChannels, instantiationContext: "ChannelManager.swift::\(#function):\(#line)").dangle()
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_batch_funding_transaction_generated(thisArgPointer, temporaryChannelsVector.cType!, fundingTransactionPrimitiveWrapper.cType!)
						}
					...
					public func updatePartialChannelConfig(counterpartyNodeId: [UInt8], channelIds: [[UInt8]], configUpdate: ChannelConfigUpdate) -> Result_NoneAPIErrorZ {
						// native call variable prep
						...
						withUnsafePointer(to: configUpdate.cType!) { (configUpdatePointer: UnsafePointer<LDKChannelConfigUpdate>) in
				ChannelManager_update_partial_channel_config(thisArgPointer, counterpartyNodeIdPrimitiveWrapper.cType!, channelIdsVector.cType!, configUpdatePointer)
						}
				...
				ChannelManager_fail_htlc_backwards(thisArgPointer, tupledPaymentHashPointer)
					...
					public func failHtlcBackwardsWithReason(paymentHash: [UInt8], failureCode: FailureCode) {
						...
						withUnsafePointer(to: tupledPaymentHash) { (tupledPaymentHashPointer: UnsafePointer<UInt8Tuple32>) in
				ChannelManager_fail_htlc_backwards_with_reason(thisArgPointer, tupledPaymentHashPointer, failureCode.danglingClone().cType!)
						}
				...
				ChannelManager_claim_funds(thisArgPointer, paymentPreimagePrimitiveWrapper.cType!)
					...
					public func claimFundsWithKnownCustomTlvs(paymentPreimage: [UInt8]) {
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_claim_funds_with_known_custom_tlvs(thisArgPointer, paymentPreimagePrimitiveWrapper.cType!)
						}
				...
				ChannelManager_accept_inbound_channel_from_trusted_peer_0conf(thisArgPointer, tupledTemporaryChannelIdPointer, counterpartyNodeIdPrimitiveWrapper.cType!, userChannelIdPrimitiveWrapper.cType!)
					...
					/// [`create_inbound_payment_for_hash`]: Self::create_inbound_payment_for_hash
					public func createInboundPayment(minValueMsat: UInt64?, invoiceExpiryDeltaSecs: UInt32, minFinalCltvExpiryDelta: UInt16?) -> Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_create_inbound_payment(thisArgPointer, minValueMsatOption.cType!, invoiceExpiryDeltaSecs, minFinalCltvExpiryDeltaOption.cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					/// [`create_inbound_payment`]: Self::create_inbound_payment
					/// [`PaymentClaimable`]: events::Event::PaymentClaimable
					public func createInboundPaymentForHash(paymentHash: [UInt8], minValueMsat: UInt64?, invoiceExpiryDeltaSecs: UInt32, minFinalCltvExpiry: UInt16?) -> Result_ThirtyTwoBytesNoneZ {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKChannelManager>) in
				ChannelManager_create_inbound_payment_for_hash(thisArgPointer, paymentHashPrimitiveWrapper.cType!, minValueMsatOption.cType!, invoiceExpiryDeltaSecs, minFinalCltvExpiryOption.cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Result_ThirtyTwoBytesNoneZ(cType: nativeCallResult, instantiationContext: "ChannelManager.swift::\(#function):\(#line)", anchor: self).dangle(false)
