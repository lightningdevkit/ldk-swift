...
public typealias Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ, instantiationContext: String,
			...
			-> Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ
		{
			...
			let oVector = Vec_C2Tuple_BlockHashChannelMonitorZZ(
				array: o,
				instantiationContext: "Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ.swift::\(#function):\(#line)"
			)
			.dangle()
			...
			let returnValue = Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ(
		...
		internal func clone() -> Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ>) in
		...
		public func getValue() -> [([UInt8], ChannelMonitor)]? {
			if self.cType?.result_ok == true {
				return Vec_C2Tuple_BlockHashChannelMonitorZZ(
					cType: self.cType!.contents.result.pointee,
					instantiationContext:
						"Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ.swift::\(#function):\(#line)", anchor: self
				)
				.getValue()
			}
			return nil
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
