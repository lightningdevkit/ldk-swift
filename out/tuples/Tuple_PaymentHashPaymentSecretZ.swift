			...
			extension Bindings {
				...
				internal class Tuple_PaymentHashPaymentSecretZ: NativeTypeWrapper {
					...
					internal init(cType: LDKC2Tuple_PaymentHashPaymentSecretZ) {
					...
					internal init(cType: LDKC2Tuple_PaymentHashPaymentSecretZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				C2Tuple_PaymentHashPaymentSecretZ_clone(origPointer)
						...
						let returnValue = Tuple_PaymentHashPaymentSecretZ(cType: nativeCallResult)
