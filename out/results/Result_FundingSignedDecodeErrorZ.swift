			...
			extension Bindings {
				...
				public class Result_FundingSignedDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_FundingSignedDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: FundingSigned) -> Result_FundingSignedDecodeErrorZ {
						...
						let returnValue = Result_FundingSignedDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_FundingSignedDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_FundingSignedDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_FundingSignedDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> FundingSigned? {
						if self.cType?.result_ok == true {
							return FundingSigned(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_FundingSignedDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_FundingSignedDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_FundingSignedDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
