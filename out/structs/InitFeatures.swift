...
extension Bindings {
	...
	public class InitFeatures: NativeTypeWrapper {
		...
		internal init(
			cType: LDKInitFeatures, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		internal func clone() -> InitFeatures {
			...
			let returnValue = InitFeatures(
				cType: nativeCallResult, instantiationContext: "InitFeatures.swift::\(#function):\(#line)")
		...
		public func hash() -> UInt64 {
			...
			// native method call
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (oPointer: UnsafePointer<LDKInitFeatures>) in
		...
		public func requiresUnknownBitsFrom() -> Bool {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKInitFeatures>) in
					...
					withUnsafePointer(to: self.cType!) { (otherPointer: UnsafePointer<LDKInitFeatures>) in
						InitFeatures_requires_unknown_bits_from(thisArgPointer, otherPointer)
					}
		...
		public func setRequiredCustomBit(bit: UInt) -> Result_NoneNoneZ {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_required_custom_bit(thisArgPointer, bit)
				}
		...
		public func setOptionalCustomBit(bit: UInt) -> Result_NoneNoneZ {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_optional_custom_bit(thisArgPointer, bit)
				}
		...
		public class func read(ser: [UInt8]) -> Result_InitFeaturesDecodeErrorZ {
			...
			let serPrimitiveWrapper = u8slice(
				value: ser, instantiationContext: "InitFeatures.swift::\(#function):\(#line)")
			...
			// return value (do some wrapping)
			let returnValue = Result_InitFeaturesDecodeErrorZ(
				cType: nativeCallResult, instantiationContext: "InitFeatures.swift::\(#function):\(#line)")
		...
		public func setAnchorsNonzeroFeeHtlcTxOptional() {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_anchors_nonzero_fee_htlc_tx_optional(thisArgPointer)
				}
		...
		public func setAnchorsNonzeroFeeHtlcTxRequired() {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_anchors_nonzero_fee_htlc_tx_required(thisArgPointer)
				}
		...
		public func supportsAnchorsNonzeroFeeHtlcTx() -> Bool {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKInitFeatures>) in
					InitFeatures_supports_anchors_nonzero_fee_htlc_tx(thisArgPointer)
				}
		...
		public func requiresAnchorsNonzeroFeeHtlcTx() -> Bool {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKInitFeatures>) in
					InitFeatures_requires_anchors_nonzero_fee_htlc_tx(thisArgPointer)
				}
		...
		public func setRouteBlindingOptional() {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_route_blinding_optional(thisArgPointer)
				}
		...
		public func setRouteBlindingRequired() {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKInitFeatures>) in
					InitFeatures_set_route_blinding_required(thisArgPointer)
				}
		...
		public func supportsRouteBlinding() -> Bool {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKInitFeatures>) in
					InitFeatures_supports_route_blinding(thisArgPointer)
				}
		...
		public func requiresRouteBlinding() -> Bool {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKInitFeatures>) in
					InitFeatures_requires_route_blinding(thisArgPointer)
				}
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing InitFeatures \(self.instanceNumber). (Origin: \(self.instantiationContext))")
				}

				self.free()
			} else if Self.enableDeinitLogging {
				Bindings.print(
					"Not freeing InitFeatures \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
