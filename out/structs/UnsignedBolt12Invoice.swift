			...
			extension Bindings {
				...
				public class UnsignedBolt12Invoice: NativeTypeWrapper {
					...
					internal init(cType: LDKUnsignedBolt12Invoice, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				UnsignedBolt12Invoice_tagged_hash(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = TaggedHash(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_offer_chains(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_ThirtyTwoBytesZZ(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				UnsignedBolt12Invoice_chain(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedBolt12Invoice_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKAmount
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Amount(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				// Type: LDKOfferFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = OfferFeatures(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_description(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PrintableString(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				UnsignedBolt12Invoice_message_paths(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_BlindedPathZ(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				// Type: LDKQuantity
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Quantity(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_payer_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = u8slice(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle().getValue()
				...
				UnsignedBolt12Invoice_invoice_request_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = InvoiceRequestFeatures(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_payer_id(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedBolt12Invoice_invoice_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Bolt12InvoiceFeatures(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedBolt12Invoice_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "UnsignedBolt12Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing UnsignedBolt12Invoice \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing UnsignedBolt12Invoice \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
