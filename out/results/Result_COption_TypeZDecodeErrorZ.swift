...
extension Bindings {
	...
	public class Result_COption_TypeZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_TypeZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: BindingsType?) -> Result_COption_TypeZDecodeErrorZ {
			...
			let oOption = Option_TypeZ(
				some: o, instantiationContext: "Result_COption_TypeZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
			...
			let returnValue = Result_COption_TypeZDecodeErrorZ(
				...
				instantiationContext: "Result_COption_TypeZDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_COption_TypeZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_TypeZDecodeErrorZ>) in
		...
		public func getError() -> DecodeError? {
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext: "Result_COption_TypeZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
			}
			return nil
		}
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_TypeZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_TypeZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
