			...
			extension Bindings {
				...
				public class AcceptChannelV2: NativeTypeWrapper {
					...
					internal init(cType: LDKAcceptChannelV2, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				AcceptChannelV2_get_temporary_channel_id(thisPtrPointer)
					...
					public func setTemporaryChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				

						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKAcceptChannelV2>) in
				...
				AcceptChannelV2_get_funding_pubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setFundingPubkey(val: [UInt8]) {
						...
						let valPrimitiveWrapper = PublicKey(value: val, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				...
				AcceptChannelV2_get_shutdown_scriptpubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setShutdownScriptpubkey(val: [UInt8]?) {
						...
						let valOption = Option_CVec_u8ZZ(some: val, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)").danglingClone()
				...
				// Type: LDKChannelTypeFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = ChannelTypeFeatures(cType: nativeCallResult, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				AcceptChannelV2_set_require_confirmed_inputs(thisPtrPointer, val.getCValue())
					...
					public init(temporaryChannelIdArg: [UInt8], fundingSatoshisArg: UInt64, dustLimitSatoshisArg: UInt64, maxHtlcValueInFlightMsatArg: UInt64, htlcMinimumMsatArg: UInt64, minimumDepthArg: UInt32, toSelfDelayArg: UInt16, maxAcceptedHtlcsArg: UInt16, fundingPubkeyArg: [UInt8], revocationBasepointArg: [UInt8], paymentBasepointArg: [UInt8], delayedPaymentBasepointArg: [UInt8], htlcBasepointArg: [UInt8], firstPerCommitmentPointArg: [UInt8], secondPerCommitmentPointArg: [UInt8], shutdownScriptpubkeyArg: [UInt8]?, channelTypeArg: ChannelTypeFeatures, requireConfirmedInputsArg: Option_NoneZ) {
						// native call variable prep
						
						let temporaryChannelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: temporaryChannelIdArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let fundingPubkeyArgPrimitiveWrapper = PublicKey(value: fundingPubkeyArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let revocationBasepointArgPrimitiveWrapper = PublicKey(value: revocationBasepointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let paymentBasepointArgPrimitiveWrapper = PublicKey(value: paymentBasepointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let delayedPaymentBasepointArgPrimitiveWrapper = PublicKey(value: delayedPaymentBasepointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let htlcBasepointArgPrimitiveWrapper = PublicKey(value: htlcBasepointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let firstPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: firstPerCommitmentPointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let secondPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: secondPerCommitmentPointArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				
						let shutdownScriptpubkeyArgOption = Option_CVec_u8ZZ(some: shutdownScriptpubkeyArg, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = AcceptChannelV2_new(temporaryChannelIdArgPrimitiveWrapper.cType!, fundingSatoshisArg, dustLimitSatoshisArg, maxHtlcValueInFlightMsatArg, htlcMinimumMsatArg, minimumDepthArg, toSelfDelayArg, maxAcceptedHtlcsArg, fundingPubkeyArgPrimitiveWrapper.cType!, revocationBasepointArgPrimitiveWrapper.cType!, paymentBasepointArgPrimitiveWrapper.cType!, delayedPaymentBasepointArgPrimitiveWrapper.cType!, htlcBasepointArgPrimitiveWrapper.cType!, firstPerCommitmentPointArgPrimitiveWrapper.cType!, secondPerCommitmentPointArgPrimitiveWrapper.cType!, shutdownScriptpubkeyArgOption.cType!, channelTypeArg.dynamicallyDangledClone().cType!, requireConfirmedInputsArg.getCValue())
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
				...
				AcceptChannelV2_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_AcceptChannelV2DecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_AcceptChannelV2DecodeErrorZ(cType: nativeCallResult, instantiationContext: "AcceptChannelV2.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing AcceptChannelV2 \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing AcceptChannelV2 \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
