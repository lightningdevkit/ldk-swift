			...
			extension Bindings {
				...
				InMemorySigner_counterparty_selected_contest_delay(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u16Z(cType: nativeCallResult, instantiationContext: "InMemorySigner.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				InMemorySigner_is_outbound(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_boolZ(cType: nativeCallResult, instantiationContext: "InMemorySigner.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKChannelTypeFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = ChannelTypeFeatures(cType: nativeCallResult, instantiationContext: "InMemorySigner.swift::\(#function):\(#line)", anchor: self).dangle(false)
