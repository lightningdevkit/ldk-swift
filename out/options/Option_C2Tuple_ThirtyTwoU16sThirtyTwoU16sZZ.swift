			...
			extension Bindings {
				...
				internal class Option_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCOption_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCOption_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(some: ([UInt16], [UInt16])?, instantiationContext: String) {
						...
						if let some = some {
							...
							let someTuple = Tuple__u1632_u1632Z(tuple: some, instantiationContext: "Option_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ.swift::\(#function):\(#line)").dangle()
					...
					public func getValue() -> ([UInt16], [UInt16])? {
						...
						if self.cType!.tag == LDKCOption_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ_Some {
							return Tuple__u1632_u1632Z(cType: self.cType!.some, instantiationContext: "Option_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ.swift::\(#function):\(#line)", anchor: self).dangle().getValue()
						}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Option_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Option_C2Tuple_ThirtyTwoU16sThirtyTwoU16sZZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
