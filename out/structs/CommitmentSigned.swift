			...
			extension Bindings {
				...
				CommitmentSigned_get_signature(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setSignature(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ECDSASignature(value: val, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)")
				...
				CommitmentSigned_get_htlc_signatures(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ECDSASignatureZ(cType: nativeCallResult, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setHtlcSignatures(val: [[UInt8]]) {
						...
						let valVector = Vec_ECDSASignatureZ(array: val, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)").dangle()
				...
				CommitmentSigned_set_htlc_signatures(thisPtrPointer, valVector.cType!)
					...
					public init(channelIdArg: [UInt8], signatureArg: [UInt8], htlcSignaturesArg: [[UInt8]]) {
						...
						let signatureArgPrimitiveWrapper = ECDSASignature(value: signatureArg, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)")
				
						let htlcSignaturesArgVector = Vec_ECDSASignatureZ(array: htlcSignaturesArg, instantiationContext: "CommitmentSigned.swift::\(#function):\(#line)").dangle()
