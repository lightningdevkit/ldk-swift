			...
			extension Bindings {
				...
				public class Result_SpendableOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_SpendableOutputDescriptorDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_SpendableOutputDescriptorDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_SpendableOutputDescriptorDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> SpendableOutputDescriptor? {
						if self.cType?.result_ok == true {
							return SpendableOutputDescriptor(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
