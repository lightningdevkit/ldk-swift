...
extension Bindings {
	...
	public class Result_RoutingFeesDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_RoutingFeesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: RoutingFees) -> Result_RoutingFeesDecodeErrorZ {
			...
			let returnValue = Result_RoutingFeesDecodeErrorZ(
				cType: nativeCallResult,
				instantiationContext: "Result_RoutingFeesDecodeErrorZ.swift::\(#function):\(#line)")
		...
		public func getError() -> DecodeError? {
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext: "Result_RoutingFeesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
			}
			return nil
		}
		...
		internal func dangleRecursively() -> Result_RoutingFeesDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_RoutingFeesDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_RoutingFeesDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
