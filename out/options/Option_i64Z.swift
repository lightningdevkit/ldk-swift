			...
			extension Bindings {
				...
				internal class Option_i64Z: NativeTypeWrapper {
					...
					internal init(cType: LDKCOption_i64Z, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				COption_i64Z_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_i64Z(cType: nativeCallResult, instantiationContext: "Option_i64Z.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Option_i64Z \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
