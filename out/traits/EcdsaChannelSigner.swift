			...
			extension Bindings {
				...
				open class EcdsaChannelSigner: NativeTraitWrapper {
					...
					public init(channelSigner: ChannelSigner) {
						...
						func signCounterpartyCommitmentLambda(this_arg: UnsafeRawPointer?, commitment_tx: UnsafePointer<LDKCommitmentTransaction>, preimages: LDKCVec_ThirtyTwoBytesZ) -> LDKCResult_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
							...
							// Swift callback call
							let swiftCallbackResult = instance.signCounterpartyCommitment(commitmentTx: CommitmentTransaction(cType: commitment_tx.pointee, instantiationContext: "EcdsaChannelSigner.swift::init()::\(#function):\(#line)").dangle().clone(), preimages: Vec_ThirtyTwoBytesZ(cType: preimages, instantiationContext: "EcdsaChannelSigner.swift::init()::\(#function):\(#line)").getValue())
						...
						func signHolderCommitmentAndHtlcsLambda(this_arg: UnsafeRawPointer?, commitment_tx: UnsafePointer<LDKHolderCommitmentTransaction>) -> LDKCResult_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
						...
						func signJusticeRevokedOutputLambda(this_arg: UnsafeRawPointer?, justice_tx: LDKTransaction, input: UInt, amount: UInt64, per_commitment_key: UnsafePointer<UInt8Tuple32>?) -> LDKCResult_ECDSASignatureNoneZ {
						...
						func signJusticeRevokedHtlcLambda(this_arg: UnsafeRawPointer?, justice_tx: LDKTransaction, input: UInt, amount: UInt64, per_commitment_key: UnsafePointer<UInt8Tuple32>?, htlc: UnsafePointer<LDKHTLCOutputInCommitment>) -> LDKCResult_ECDSASignatureNoneZ {
						...
						func signHolderHtlcTransactionLambda(this_arg: UnsafeRawPointer?, htlc_tx: LDKTransaction, input: UInt, htlc_descriptor: UnsafePointer<LDKHTLCDescriptor>) -> LDKCResult_ECDSASignatureNoneZ {
							let instance: EcdsaChannelSigner = Bindings.pointerToInstance(pointer: this_arg!, sourceMarker: "EcdsaChannelSigner::signHolderHtlcTransactionLambda")

							// Swift callback variable prep
											

							// Swift callback call
							let swiftCallbackResult = instance.signHolderHtlcTransaction(htlcTx: Transaction(cType: htlc_tx, instantiationContext: "EcdsaChannelSigner.swift::init()::\(#function):\(#line)").getValue(), input: input, htlcDescriptor: HTLCDescriptor(cType: htlc_descriptor.pointee, instantiationContext: "EcdsaChannelSigner.swift::init()::\(#function):\(#line)").dangle().clone())
						...
						func signCounterpartyHtlcTransactionLambda(this_arg: UnsafeRawPointer?, htlc_tx: LDKTransaction, input: UInt, amount: UInt64, per_commitment_point: LDKPublicKey, htlc: UnsafePointer<LDKHTLCOutputInCommitment>) -> LDKCResult_ECDSASignatureNoneZ {
						...
						func signClosingTransactionLambda(this_arg: UnsafeRawPointer?, closing_tx: UnsafePointer<LDKClosingTransaction>) -> LDKCResult_ECDSASignatureNoneZ {
						...
						func signHolderAnchorInputLambda(this_arg: UnsafeRawPointer?, anchor_tx: LDKTransaction, input: UInt) -> LDKCResult_ECDSASignatureNoneZ {
						...
						func signChannelAnnouncementWithFundingKeyLambda(this_arg: UnsafeRawPointer?, msg: UnsafePointer<LDKUnsignedChannelAnnouncement>) -> LDKCResult_ECDSASignatureNoneZ {
			...
			open func signCounterpartyCommitment(commitmentTx: CommitmentTransaction, preimages: [[UInt8]]) -> Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
			...
			open func signHolderCommitmentAndHtlcs(commitmentTx: HolderCommitmentTransaction) -> Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
			...
			/// Create a signature for the given input in a transaction spending an HTLC transaction output
					...
					/// so).
			open func signJusticeRevokedOutput(justiceTx: [UInt8], input: UInt, amount: UInt64, perCommitmentKey: [UInt8]?) -> Result_ECDSASignatureNoneZ {
			...
			open func signJusticeRevokedHtlc(justiceTx: [UInt8], input: UInt, amount: UInt64, perCommitmentKey: [UInt8]?, htlc: HTLCOutputInCommitment) -> Result_ECDSASignatureNoneZ {
			...
			open func signHolderHtlcTransaction(htlcTx: [UInt8], input: UInt, htlcDescriptor: HTLCDescriptor) -> Result_ECDSASignatureNoneZ {
				
				Bindings.print("Error: EcdsaChannelSigner::signHolderHtlcTransaction MUST be overridden! Offending class: \(String(describing: self)). Aborting.", severity: .ERROR)
				abort()
			}
			...
			/// Create a signature for a claiming transaction for a HTLC output on a counterparty's commitment
					...
					/// BIP 143 signature.
			open func signCounterpartyHtlcTransaction(htlcTx: [UInt8], input: UInt, amount: UInt64, perCommitmentPoint: [UInt8], htlc: HTLCOutputInCommitment) -> Result_ECDSASignatureNoneZ {
			...
			/// Create a signature for a counterparty's commitment transaction and associated HTLC transactions.
					...
					/// Note that all the relevant preimages will be provided, but there may also be additional
					/// irrelevant or duplicate preimages.
			public override func signCounterpartyCommitment(commitmentTx: CommitmentTransaction, preimages: [[UInt8]]) -> Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
				// native call variable prep
				
						let preimagesVector = Vec_ThirtyTwoBytesZ(array: preimages, instantiationContext: "EcdsaChannelSigner.swift::\(#function):\(#line)").dangle()
				...
				// return value (do some wrapping)
				let returnValue = Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ(cType: nativeCallResult, instantiationContext: "EcdsaChannelSigner.swift::\(#function):\(#line)")
			...
			/// Creates a signature for a holder's commitment transaction and its claiming HTLC transactions.
					...
					/// 
					/// [`ChannelMonitor`]: crate::chain::channelmonitor::ChannelMonitor
			public override func signHolderCommitmentAndHtlcs(commitmentTx: HolderCommitmentTransaction) -> Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {
				// native call variable prep
			...
			/// Create a signature for the given input in a transaction spending an HTLC transaction output
					...
					/// not allow the spending of any funds by itself (you need our holder `revocation_secret` to do
					/// so).
			public override func signJusticeRevokedOutput(justiceTx: [UInt8], input: UInt, amount: UInt64, perCommitmentKey: [UInt8]?) -> Result_ECDSASignatureNoneZ {
				// native call variable prep
				...
				// return value (do some wrapping)
				let returnValue = Result_ECDSASignatureNoneZ(cType: nativeCallResult, instantiationContext: "EcdsaChannelSigner.swift::\(#function):\(#line)")
			...
			/// Create a signature for the given input in a transaction spending a commitment transaction
					...
					/// `htlc` holds HTLC elements (hash, timelock), thus changing the format of the witness script
					/// (which is committed to in the BIP 143 signatures).
			public override func signJusticeRevokedHtlc(justiceTx: [UInt8], input: UInt, amount: UInt64, perCommitmentKey: [UInt8]?, htlc: HTLCOutputInCommitment) -> Result_ECDSASignatureNoneZ {
				// native call variable prep
			...
			/// Computes the signature for a commitment transaction's HTLC output used as an input within
					...
					/// 
					/// [`EcdsaSighashType::All`]: bitcoin::blockdata::transaction::EcdsaSighashType::All
			public override func signHolderHtlcTransaction(htlcTx: [UInt8], input: UInt, htlcDescriptor: HTLCDescriptor) -> Result_ECDSASignatureNoneZ {
				// native call variable prep
				...
				// native method call
				let nativeCallResult = 
						withUnsafePointer(to: htlcDescriptor.cType!) { (htlcDescriptorPointer: UnsafePointer<LDKHTLCDescriptor>) in
				self.cType!.sign_holder_htlc_transaction(self.cType!.this_arg, htlcTxPrimitiveWrapper.cType!, input, htlcDescriptorPointer)
						}
			...
			/// Create a signature for a claiming transaction for a HTLC output on a counterparty's commitment
					...
					/// channel state keys, which are then included in the witness script and committed to in the
					/// BIP 143 signature.
			public override func signCounterpartyHtlcTransaction(htlcTx: [UInt8], input: UInt, amount: UInt64, perCommitmentPoint: [UInt8], htlc: HTLCOutputInCommitment) -> Result_ECDSASignatureNoneZ {
				// native call variable prep
			...
			/// Signs a channel announcement message with our funding key proving it comes from one of the
					...
					/// our counterparty may (though likely will not) close the channel on us for violating the
					/// protocol.
			public override func signChannelAnnouncementWithFundingKey(msg: UnsignedChannelAnnouncement) -> Result_ECDSASignatureNoneZ {
				// native call variable prep
