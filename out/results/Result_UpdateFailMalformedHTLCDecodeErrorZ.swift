...
extension Bindings {
	...
	public class Result_UpdateFailMalformedHTLCDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_UpdateFailMalformedHTLCDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: UpdateFailMalformedHTLC) -> Result_UpdateFailMalformedHTLCDecodeErrorZ {
			...
			let returnValue = Result_UpdateFailMalformedHTLCDecodeErrorZ(
				...
				instantiationContext: "Result_UpdateFailMalformedHTLCDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_UpdateFailMalformedHTLCDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_UpdateFailMalformedHTLCDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_UpdateFailMalformedHTLCDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_UpdateFailMalformedHTLCDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_UpdateFailMalformedHTLCDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
