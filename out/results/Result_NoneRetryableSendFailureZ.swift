			...
			extension Bindings {
				...
				public class Result_NoneRetryableSendFailureZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NoneRetryableSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_NoneRetryableSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk() -> Result_NoneRetryableSendFailureZ {
						...
						let returnValue = Result_NoneRetryableSendFailureZ(cType: nativeCallResult, instantiationContext: "Result_NoneRetryableSendFailureZ.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NoneRetryableSendFailureZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NoneRetryableSendFailureZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
