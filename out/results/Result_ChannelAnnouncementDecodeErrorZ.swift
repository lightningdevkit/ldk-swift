			...
			extension Bindings {
				...
				public class Result_ChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelAnnouncementDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ChannelAnnouncementDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelAnnouncementDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelAnnouncement) -> Result_ChannelAnnouncementDecodeErrorZ {
						...
						let returnValue = Result_ChannelAnnouncementDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelAnnouncement? {
						if self.cType?.result_ok == true {
							return ChannelAnnouncement(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelAnnouncementDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelAnnouncementDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
