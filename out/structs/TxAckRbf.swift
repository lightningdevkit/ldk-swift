			...
			extension Bindings {
				...
				TxAckRbf_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)")
				...
				TxAckRbf_get_funding_output_contribution(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_i64Z(cType: nativeCallResult, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setFundingOutputContribution(val: Int64?) {
						...
						let valOption = Option_i64Z(some: val, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)").danglingClone()
				...
				TxAckRbf_set_funding_output_contribution(thisPtrPointer, valOption.cType!)
					...
					public init(channelIdArg: [UInt8], fundingOutputContributionArg: Int64?) {
						...
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)")
				
						let fundingOutputContributionArgOption = Option_i64Z(some: fundingOutputContributionArg, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = TxAckRbf_new(channelIdArgPrimitiveWrapper.cType!, fundingOutputContributionArgOption.cType!)
				...
				TxAckRbf_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_TxAckRbfDecodeErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_TxAckRbfDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TxAckRbf.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing TxAckRbf \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
