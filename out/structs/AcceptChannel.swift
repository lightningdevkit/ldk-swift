			...
			extension Bindings {
				...
				AcceptChannel_get_shutdown_scriptpubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setShutdownScriptpubkey(val: [UInt8]?) {
						...
						let valOption = Option_CVec_u8ZZ(some: val, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)").danglingClone()
				...
				AcceptChannel_set_channel_type(thisPtrPointer, val.dynamicallyDangledClone().cType!)
					...
					public init(temporaryChannelIdArg: [UInt8], dustLimitSatoshisArg: UInt64, maxHtlcValueInFlightMsatArg: UInt64, channelReserveSatoshisArg: UInt64, htlcMinimumMsatArg: UInt64, minimumDepthArg: UInt32, toSelfDelayArg: UInt16, maxAcceptedHtlcsArg: UInt16, fundingPubkeyArg: [UInt8], revocationBasepointArg: [UInt8], paymentPointArg: [UInt8], delayedPaymentBasepointArg: [UInt8], htlcBasepointArg: [UInt8], firstPerCommitmentPointArg: [UInt8], shutdownScriptpubkeyArg: [UInt8]?, channelTypeArg: ChannelTypeFeatures) {
						...
						let temporaryChannelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: temporaryChannelIdArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let fundingPubkeyArgPrimitiveWrapper = PublicKey(value: fundingPubkeyArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let revocationBasepointArgPrimitiveWrapper = PublicKey(value: revocationBasepointArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let paymentPointArgPrimitiveWrapper = PublicKey(value: paymentPointArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let delayedPaymentBasepointArgPrimitiveWrapper = PublicKey(value: delayedPaymentBasepointArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let htlcBasepointArgPrimitiveWrapper = PublicKey(value: htlcBasepointArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let firstPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: firstPerCommitmentPointArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
				
						let shutdownScriptpubkeyArgOption = Option_CVec_u8ZZ(some: shutdownScriptpubkeyArg, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = AcceptChannel_new(temporaryChannelIdArgPrimitiveWrapper.cType!, dustLimitSatoshisArg, maxHtlcValueInFlightMsatArg, channelReserveSatoshisArg, htlcMinimumMsatArg, minimumDepthArg, toSelfDelayArg, maxAcceptedHtlcsArg, fundingPubkeyArgPrimitiveWrapper.cType!, revocationBasepointArgPrimitiveWrapper.cType!, paymentPointArgPrimitiveWrapper.cType!, delayedPaymentBasepointArgPrimitiveWrapper.cType!, htlcBasepointArgPrimitiveWrapper.cType!, firstPerCommitmentPointArgPrimitiveWrapper.cType!, shutdownScriptpubkeyArgOption.cType!, channelTypeArg.dynamicallyDangledClone().cType!)
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "AcceptChannel.swift::\(#function):\(#line)")
