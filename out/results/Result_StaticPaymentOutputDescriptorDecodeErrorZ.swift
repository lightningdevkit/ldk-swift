			...
			extension Bindings {
				...
				public class Result_StaticPaymentOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_StaticPaymentOutputDescriptorDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_StaticPaymentOutputDescriptorDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_StaticPaymentOutputDescriptorDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: StaticPaymentOutputDescriptor) -> Result_StaticPaymentOutputDescriptorDecodeErrorZ {
						...
						let returnValue = Result_StaticPaymentOutputDescriptorDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_StaticPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_StaticPaymentOutputDescriptorDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_StaticPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> StaticPaymentOutputDescriptor? {
						if self.cType?.result_ok == true {
							return StaticPaymentOutputDescriptor(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_StaticPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_StaticPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_StaticPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
