			...
			extension Bindings {
				...
				public class Result_RouteHintDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RouteHintDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_RouteHintDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_RouteHintDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RouteHint? {
						if self.cType?.result_ok == true {
							return RouteHint(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
