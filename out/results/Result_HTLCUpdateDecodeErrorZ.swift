			...
			extension Bindings {
				...
				public class Result_HTLCUpdateDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_HTLCUpdateDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_HTLCUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_HTLCUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: HTLCUpdate) -> Result_HTLCUpdateDecodeErrorZ {
						...
						let returnValue = Result_HTLCUpdateDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_HTLCUpdateDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_HTLCUpdateDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_HTLCUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> HTLCUpdate? {
						if self.cType?.result_ok == true {
							return HTLCUpdate(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_HTLCUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_HTLCUpdateDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_HTLCUpdateDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
