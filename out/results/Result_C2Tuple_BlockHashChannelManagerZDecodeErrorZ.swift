			...
			extension Bindings {
				...
				public class Result_C2Tuple_BlockHashChannelManagerZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_BlockHashChannelManagerZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_C2Tuple_BlockHashChannelManagerZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ([UInt8], ChannelManager)) -> Result_C2Tuple_BlockHashChannelManagerZDecodeErrorZ {
						...
						let oTuple = Tuple_BlockHashChannelManagerZ(tuple: o, instantiationContext: "Result_C2Tuple_BlockHashChannelManagerZDecodeErrorZ.swift::\(#function):\(#line)").dangle()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_C2Tuple_BlockHashChannelManagerZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_C2Tuple_BlockHashChannelManagerZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
