			...
			extension Bindings {
				...
				public class RawBolt11Invoice: NativeTypeWrapper {
					...
					internal init(cType: LDKRawBolt11Invoice, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				RawBolt11Invoice_get_data(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = RawDataPart(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public func setData(val: RawDataPart) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKRawBolt11Invoice>) in
				...
				RawBolt11Invoice_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = RawBolt11Invoice(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)")
				...
				RawBolt11Invoice_signable_hash(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				// Type: LDKSha256
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Sha256(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				// Type: LDKDescription
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Description(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				// Type: LDKPayeePubKey
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = PayeePubKey(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				// Type: LDKExpiryTime
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = ExpiryTime(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				// Type: LDKMinFinalCltvExpiryDelta
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = MinFinalCltvExpiryDelta(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				RawBolt11Invoice_payment_secret(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				RawBolt11Invoice_payment_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKBolt11InvoiceFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Bolt11InvoiceFeatures(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				RawBolt11Invoice_private_routes(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_PrivateRouteZ(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				RawBolt11Invoice_amount_pico_btc(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "RawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing RawBolt11Invoice \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing RawBolt11Invoice \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
