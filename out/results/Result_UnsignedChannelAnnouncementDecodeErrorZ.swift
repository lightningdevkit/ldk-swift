			...
			extension Bindings {
				...
				public class Result_UnsignedChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UnsignedChannelAnnouncementDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_UnsignedChannelAnnouncementDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_UnsignedChannelAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UnsignedChannelAnnouncement? {
						if self.cType?.result_ok == true {
							return UnsignedChannelAnnouncement(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
