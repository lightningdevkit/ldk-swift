...
extension Bindings {
	...
	public class Result_SpendableOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_SpendableOutputDescriptorDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: SpendableOutputDescriptor) -> Result_SpendableOutputDescriptorDecodeErrorZ {
			...
			let returnValue = Result_SpendableOutputDescriptorDecodeErrorZ(
				...
				instantiationContext: "Result_SpendableOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_SpendableOutputDescriptorDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_SpendableOutputDescriptorDecodeErrorZ>) in
		...
		public func getValue() -> SpendableOutputDescriptor? {
			if self.cType?.result_ok == true {
				return SpendableOutputDescriptor(
		...
		internal func dangleRecursively() -> Result_SpendableOutputDescriptorDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_SpendableOutputDescriptorDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_SpendableOutputDescriptorDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
