			...
			extension Bindings {
				...
				CResult_WriteableEcdsaChannelSignerDecodeErrorZ_clone(origPointer)
					...
					deinit {
						...
						if !self.dangling {
							Bindings.print("Freeing Result_WriteableEcdsaChannelSignerDecodeErrorZ \(self.instanceNumber).")
							
							self.free()
						} else {
							Bindings.print("Not freeing Result_WriteableEcdsaChannelSignerDecodeErrorZ \(self.instanceNumber) due to dangle.")
						}
					}
