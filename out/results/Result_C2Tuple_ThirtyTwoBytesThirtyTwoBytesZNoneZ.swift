			...
			public typealias Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ = Bindings.Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ
			...
			extension Bindings {
				...
				public class Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ([UInt8], [UInt8])) -> Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ {
						...
						let oTuple = Tuple_ThirtyTwoBytesThirtyTwoBytesZ(tuple: o, instantiationContext: "Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ.swift::\(#function):\(#line)").danglingClone()
						...
						let returnValue = Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ(cType: nativeCallResult, instantiationContext: "Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ>) in
					...
					*/
					...
					public func getValue() -> ([UInt8], [UInt8])? {
						if self.cType?.result_ok == true {
							return Tuple_ThirtyTwoBytesThirtyTwoBytesZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
