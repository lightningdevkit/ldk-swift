			...
			extension Bindings {
				...
				public class Result_CounterpartyChannelTransactionParametersDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CounterpartyChannelTransactionParametersDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_CounterpartyChannelTransactionParametersDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> CounterpartyChannelTransactionParameters? {
						if self.cType?.result_ok == true {
							return CounterpartyChannelTransactionParameters(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
