			...
			extension Bindings {
				...
				public class Result_UnsignedChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UnsignedChannelAnnouncementDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UnsignedChannelAnnouncement) -> Result_UnsignedChannelAnnouncementDecodeErrorZ {
						...
						let returnValue = Result_UnsignedChannelAnnouncementDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UnsignedChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UnsignedChannelAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UnsignedChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UnsignedChannelAnnouncement? {
						if self.cType?.result_ok == true {
							return UnsignedChannelAnnouncement(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UnsignedChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UnsignedChannelAnnouncementDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UnsignedChannelAnnouncementDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
