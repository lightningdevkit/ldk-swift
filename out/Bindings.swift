			...
			public class Bindings {
				...
				*/
				...
				public class func ldkGetCompiledVersion() -> String {
					...
					let returnValue = Str(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				sign(msgPrimitiveWrapper.cType!, tupledSkPointer)
					...
					// return value (do some wrapping)
					let returnValue = Result_StrSecp256k1ErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func recoverPk(msg: [UInt8], sig: String) -> Result_PublicKeySecp256k1ErrorZ {
					...
					// return value (do some wrapping)
					let returnValue = Result_PublicKeySecp256k1ErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func constructInvoicePreimage(hrpBytes: [UInt8], dataWithoutSignature: [UInt8]) -> [UInt8] {
					...
					// return value (do some wrapping)
					let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				public class func readChannelMonitors(kvStore: KVStore, entropySource: EntropySource, signerProvider: SignerProvider) -> Result_CVec_C2Tuple_ThirtyTwoBytesChannelMonitorZZIOErrorZ {
					// native call variable prep
					

					// native method call
					let nativeCallResult = read_channel_monitors(kvStore.activate().cType!, entropySource.activate().cType!, signerProvider.activate().cType!)
					...
					// return value (do some wrapping)
					let returnValue = Result_CVec_C2Tuple_ThirtyTwoBytesChannelMonitorZZIOErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				provided_init_features(configPointer)
					...
					// return value (do some wrapping)
					let returnValue = InitFeatures(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func swiftCreate(keys: ExpandedKey, minValueMsat: UInt64?, invoiceExpiryDeltaSecs: UInt32, entropySource: EntropySource, currentTime: UInt64, minFinalCltvExpiryDelta: UInt16?) -> Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ {
					// native call variable prep
				...
				create(keysPointer, minValueMsatOption.cType!, invoiceExpiryDeltaSecs, entropySourcePointer, currentTime, minFinalCltvExpiryDeltaOption.cType!)
					...
					// return value (do some wrapping)
					let returnValue = Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZNoneZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				/// 
				/// [phantom node payments]: crate::sign::PhantomKeysManager
				public class func createFromHash(keys: ExpandedKey, minValueMsat: UInt64?, paymentHash: [UInt8], invoiceExpiryDeltaSecs: UInt32, currentTime: UInt64, minFinalCltvExpiryDelta: UInt16?) -> Result_ThirtyTwoBytesNoneZ {
					// native call variable prep
				...
				create_from_hash(keysPointer, minValueMsatOption.cType!, paymentHashPrimitiveWrapper.cType!, invoiceExpiryDeltaSecs, currentTime, minFinalCltvExpiryDeltaOption.cType!)
					...
					// return value (do some wrapping)
					let returnValue = Result_ThirtyTwoBytesNoneZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func parseOnionAddress(host: String, port: UInt16) -> Result_SocketAddressSocketAddressParseErrorZ {
					...
					let hostPrimitiveWrapper = Str(value: host, instantiationContext: "Bindings.swift::\(#function):\(#line)").dangle()
					...
					// return value (do some wrapping)
					let returnValue = Result_SocketAddressSocketAddressParseErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func htlcSuccessTxWeight(channelTypeFeatures: ChannelTypeFeatures) -> UInt64 {
					...
					// native method call
					let nativeCallResult = 
					withUnsafePointer(to: channelTypeFeatures.cType!) { (channelTypeFeaturesPointer: UnsafePointer<LDKChannelTypeFeatures>) in
				...
				build_commitment_secret(tupledCommitmentSeedPointer, idx)
					...
					// return value (do some wrapping)
					let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				public class func buildClosingTransaction(toHolderValueSat: UInt64, toCounterpartyValueSat: UInt64, toHolderScript: [UInt8], toCounterpartyScript: [UInt8], fundingOutpoint: OutPoint) -> [UInt8] {
					...
					// return value (do some wrapping)
					let returnValue = Transaction(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				derive_private_key(perCommitmentPointPrimitiveWrapper.cType!, tupledBaseSecretPointer)
					...
					// return value (do some wrapping)
					let returnValue = SecretKey(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				public class func derivePublicKey(perCommitmentPoint: [UInt8], basePoint: [UInt8]) -> [UInt8] {
					...
					// return value (do some wrapping)
					let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				/// the channel type.
				public class func getCounterpartyPaymentScript(channelTypeFeatures: ChannelTypeFeatures, paymentKey: [UInt8]) -> [UInt8] {
					// native call variable prep
					
					let paymentKeyPrimitiveWrapper = PublicKey(value: paymentKey, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func getHtlcRedeemscript(htlc: HTLCOutputInCommitment, channelTypeFeatures: ChannelTypeFeatures, keys: TxCreationKeys) -> [UInt8] {
					// native call variable prep
				...
				public class func buildHtlcTransaction(commitmentTxid: [UInt8], feeratePerKw: UInt32, contestDelay: UInt16, htlc: HTLCOutputInCommitment, channelTypeFeatures: ChannelTypeFeatures, broadcasterDelayedPaymentKey: [UInt8], revocationKey: [UInt8]) -> [UInt8] {
					// native call variable prep
					...
					withUnsafePointer(to: channelTypeFeatures.cType!) { (channelTypeFeaturesPointer: UnsafePointer<LDKChannelTypeFeatures>) in
				build_htlc_transaction(tupledCommitmentTxidPointer, feeratePerKw, contestDelay, htlcPointer, channelTypeFeaturesPointer, broadcasterDelayedPaymentKeyPrimitiveWrapper.cType!, revocationKeyPrimitiveWrapper.cType!)
					}
				...
				public class func buildHtlcInputWitness(localSig: [UInt8], remoteSig: [UInt8], preimage: [UInt8]?, redeemScript: [UInt8], channelTypeFeatures: ChannelTypeFeatures) -> [UInt8] {
					// native call variable prep
					
					let localSigPrimitiveWrapper = ECDSASignature(value: localSig, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				
					let remoteSigPrimitiveWrapper = ECDSASignature(value: remoteSig, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				
					let preimageOption = Option_ThirtyTwoBytesZ(some: preimage, instantiationContext: "Bindings.swift::\(#function):\(#line)").danglingClone()
					...
					let nativeCallResult = 
					withUnsafePointer(to: channelTypeFeatures.cType!) { (channelTypeFeaturesPointer: UnsafePointer<LDKChannelTypeFeatures>) in
				build_htlc_input_witness(localSigPrimitiveWrapper.cType!, remoteSigPrimitiveWrapper.cType!, preimageOption.cType!, redeemScriptPrimitiveWrapper.cType!, channelTypeFeaturesPointer)
					}
					...
					// return value (do some wrapping)
					let returnValue = Witness(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)").getValue()
				...
				public class func buildAnchorInputWitness(fundingKey: [UInt8], fundingSig: [UInt8]) -> [UInt8] {
					...
					let fundingSigPrimitiveWrapper = ECDSASignature(value: fundingSig, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				verify_node_announcement(msgPointer)
					...
					// return value (do some wrapping)
					let returnValue = Result_NoneLightningErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func findRoute(ourNodePubkey: [UInt8], routeParams: RouteParameters, networkGraph: NetworkGraph, firstHops: [ChannelDetails]?, logger: Logger, scorer: ScoreLookUp, scoreParams: ProbabilisticScoringFeeParameters, randomSeedBytes: [UInt8]) -> Result_RouteLightningErrorZ {
					// native call variable prep
				...
				if let firstHops = firstHops {
					...
					let firstHopsVector = Vec_ChannelDetailsZ(array: firstHops, instantiationContext: "Bindings.swift::\(#function):\(#line)").dangle()
				...
				find_route(ourNodePubkeyPrimitiveWrapper.cType!, routeParamsPointer, networkGraphPointer, firstHopsVectorPointer, logger.activate().cType!, scorerPointer, scoreParamsPointer, tupledRandomSeedBytesPointer)
					}
					...
					// return value (do some wrapping)
					let returnValue = Result_RouteLightningErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func createOnionMessage(entropySource: EntropySource, nodeSigner: NodeSigner, path: OnionMessagePath, message: OnionMessageContents, replyPath: BlindedPath) -> Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
					// native call variable prep
					...
					withUnsafePointer(to: nodeSigner.activate().cType!) { (nodeSignerPointer: UnsafePointer<LDKNodeSigner>) in
				create_onion_message(entropySourcePointer, nodeSignerPointer, path.dynamicallyDangledClone().cType!, message.danglingClone().cType!, replyPath.dynamicallyDangledClone().cType!)
					}
					...
					// return value (do some wrapping)
					let returnValue = Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func payInvoice(invoice: Bolt11Invoice, retryStrategy: Retry, channelmanager: ChannelManager) -> Result_ThirtyTwoBytesPaymentErrorZ {
					// native call variable prep
				...
				pay_invoice(invoicePointer, retryStrategy.danglingClone().cType!, channelmanagerPointer)
					...
					// return value (do some wrapping)
					let returnValue = Result_ThirtyTwoBytesPaymentErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func payInvoiceWithId(invoice: Bolt11Invoice, paymentId: [UInt8], retryStrategy: Retry, channelmanager: ChannelManager) -> Result_NonePaymentErrorZ {
					// native call variable prep
				...
				pay_invoice_with_id(invoicePointer, paymentIdPrimitiveWrapper.cType!, retryStrategy.danglingClone().cType!, channelmanagerPointer)
					...
					// return value (do some wrapping)
					let returnValue = Result_NonePaymentErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				public class func payZeroValueInvoice(invoice: Bolt11Invoice, amountMsats: UInt64, retryStrategy: Retry, channelmanager: ChannelManager) -> Result_ThirtyTwoBytesPaymentErrorZ {
					// native call variable prep
...
return returnValue
				...
				/// idempotency token.
				public class func payZeroValueInvoiceWithId(invoice: Bolt11Invoice, amountMsats: UInt64, paymentId: [UInt8], retryStrategy: Retry, channelmanager: ChannelManager) -> Result_NonePaymentErrorZ {
					// native call variable prep
...
return returnValue
				...
				public class func preflightProbeInvoice(invoice: Bolt11Invoice, channelmanager: ChannelManager, liquidityLimitMultiplier: UInt64?) -> Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbingErrorZ {
					// native call variable prep
					
					let liquidityLimitMultiplierOption = Option_u64Z(some: liquidityLimitMultiplier, instantiationContext: "Bindings.swift::\(#function):\(#line)").danglingClone()
					...
					withUnsafePointer(to: channelmanager.cType!) { (channelmanagerPointer: UnsafePointer<LDKChannelManager>) in
				preflight_probe_invoice(invoicePointer, channelmanagerPointer, liquidityLimitMultiplierOption.cType!)
					}
					...
					// return value (do some wrapping)
					let returnValue = Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbingErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
...
return returnValue
				...
				/// 
				/// See [`ChannelManager::send_preflight_probes`] for more information.
				public class func preflightProbeZeroValueInvoice(invoice: Bolt11Invoice, amountMsat: UInt64, channelmanager: ChannelManager, liquidityLimitMultiplier: UInt64?) -> Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbingErrorZ {
					// native call variable prep
					...
					withUnsafePointer(to: channelmanager.cType!) { (channelmanagerPointer: UnsafePointer<LDKChannelManager>) in
				preflight_probe_zero_value_invoice(invoicePointer, amountMsat, channelmanagerPointer, liquidityLimitMultiplierOption.cType!)
					}
...
return returnValue
				...
				public class func createPhantomInvoice(amtMsat: UInt64?, paymentHash: [UInt8]?, description: String, invoiceExpiryDeltaSecs: UInt32, phantomRouteHints: [PhantomRouteHints], entropySource: EntropySource, nodeSigner: NodeSigner, logger: Logger, network: Currency, minFinalCltvExpiryDelta: UInt16?, durationSinceEpoch: UInt64) -> Result_Bolt11InvoiceSignOrCreationErrorZ {
					...
					// return value (do some wrapping)
					let returnValue = Result_Bolt11InvoiceSignOrCreationErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				/// 
				/// [`MIN_FINAL_CLTV_EXPIRY_DETLA`]: lightning::ln::channelmanager::MIN_FINAL_CLTV_EXPIRY_DELTA
				public class func createInvoiceFromChannelmanager(channelmanager: ChannelManager, nodeSigner: NodeSigner, logger: Logger, network: Currency, amtMsat: UInt64?, description: String, invoiceExpiryDeltaSecs: UInt32, minFinalCltvExpiryDelta: UInt16?) -> Result_Bolt11InvoiceSignOrCreationErrorZ {
					// native call variable prep
...
return returnValue
				...
				/// 
				/// [`MIN_FINAL_CLTV_EXPIRY_DETLA`]: lightning::ln::channelmanager::MIN_FINAL_CLTV_EXPIRY_DELTA
				public class func createInvoiceFromChannelmanagerWithDescriptionHash(channelmanager: ChannelManager, nodeSigner: NodeSigner, logger: Logger, network: Currency, amtMsat: UInt64?, descriptionHash: Sha256, invoiceExpiryDeltaSecs: UInt32, minFinalCltvExpiryDelta: UInt16?) -> Result_Bolt11InvoiceSignOrCreationErrorZ {
					// native call variable prep
...
return returnValue
				...
				public class func readThirtyTwoBytesChannelManager(ser: [UInt8], arg: ChannelManagerReadArgs) -> Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ {
					// native call variable prep
					...
					// native method call
					let nativeCallResult = C2Tuple_ThirtyTwoBytesChannelManagerZ_read(serPrimitiveWrapper.cType!, arg.dangle().cType!)
					...
					// return value (do some wrapping)
					let returnValue = Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				public class func readThirtyTwoBytesChannelMonitor(ser: [UInt8], argA: EntropySource, argB: SignerProvider) -> Result_C2Tuple_ThirtyTwoBytesChannelMonitorZDecodeErrorZ {
					// native call variable prep
				...
				C2Tuple_ThirtyTwoBytesChannelMonitorZ_read(serPrimitiveWrapper.cType!, argAPointer, argBPointer)
					...
					// return value (do some wrapping)
					let returnValue = Result_C2Tuple_ThirtyTwoBytesChannelMonitorZDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Bindings.swift::\(#function):\(#line)")
				...
				internal typealias UInt16Tuple32 = (UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16, UInt16)
