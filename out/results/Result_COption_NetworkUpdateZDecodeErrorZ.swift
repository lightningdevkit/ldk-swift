...
extension Bindings {
	...
	public class Result_COption_NetworkUpdateZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_NetworkUpdateZDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: NetworkUpdate?) -> Result_COption_NetworkUpdateZDecodeErrorZ {
			...
			let oOption = Option_NetworkUpdateZ(
				some: o, instantiationContext: "Result_COption_NetworkUpdateZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
			...
			let returnValue = Result_COption_NetworkUpdateZDecodeErrorZ(
				...
				instantiationContext: "Result_COption_NetworkUpdateZDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_COption_NetworkUpdateZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_NetworkUpdateZDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_COption_NetworkUpdateZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_NetworkUpdateZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_NetworkUpdateZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
