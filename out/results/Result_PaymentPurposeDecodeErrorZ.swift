			...
			extension Bindings {
				...
				public class Result_PaymentPurposeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PaymentPurposeDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_PaymentPurposeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_PaymentPurposeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: PaymentPurpose) -> Result_PaymentPurposeDecodeErrorZ {
						...
						let returnValue = Result_PaymentPurposeDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_PaymentPurposeDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_PaymentPurposeDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_PaymentPurposeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> PaymentPurpose? {
						if self.cType?.result_ok == true {
							return PaymentPurpose(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PaymentPurposeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PaymentPurposeDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PaymentPurposeDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
