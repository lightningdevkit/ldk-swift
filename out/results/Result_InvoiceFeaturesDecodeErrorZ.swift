			...
			extension Bindings {
				...
				public class Result_InvoiceFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal func clone() -> Result_InvoiceFeaturesDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_InvoiceFeaturesDecodeErrorZ>) in
				CResult_InvoiceFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> InvoiceFeatures? {
						if self.cType?.result_ok == true {
							return InvoiceFeatures(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
