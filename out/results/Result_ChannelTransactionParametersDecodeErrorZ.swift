			...
			extension Bindings {
				...
				public class Result_ChannelTransactionParametersDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelTransactionParametersDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ChannelTransactionParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelTransactionParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelTransactionParameters) -> Result_ChannelTransactionParametersDecodeErrorZ {
						...
						let returnValue = Result_ChannelTransactionParametersDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelTransactionParametersDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelTransactionParameters? {
						if self.cType?.result_ok == true {
							return ChannelTransactionParameters(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelTransactionParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelTransactionParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
