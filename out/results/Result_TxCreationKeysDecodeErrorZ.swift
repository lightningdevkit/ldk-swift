			...
			extension Bindings {
				...
				public class Result_TxCreationKeysDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_TxCreationKeysDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_TxCreationKeysDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_TxCreationKeysDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: TxCreationKeys) -> Result_TxCreationKeysDecodeErrorZ {
						...
						let returnValue = Result_TxCreationKeysDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_TxCreationKeysDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_TxCreationKeysDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_TxCreationKeysDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> TxCreationKeys? {
						if self.cType?.result_ok == true {
							return TxCreationKeys(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_TxCreationKeysDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_TxCreationKeysDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_TxCreationKeysDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
