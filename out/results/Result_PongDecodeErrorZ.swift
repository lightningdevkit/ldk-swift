			...
			extension Bindings {
				...
				public class Result_PongDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PongDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_PongDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_PongDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Pong) -> Result_PongDecodeErrorZ {
						...
						let returnValue = Result_PongDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_PongDecodeErrorZ.swift::\(#function):\(#line)")
					...
					public class func initWithErr(e: DecodeError) -> Result_PongDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_PongDecodeErrorZ_err(e.danglingClone().cType!)
				...
				CResult_PongDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_PongDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Pong? {
						if self.cType?.result_ok == true {
							return Pong(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PongDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_PongDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PongDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PongDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
