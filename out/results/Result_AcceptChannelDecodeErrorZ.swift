			...
			extension Bindings {
				...
				public class Result_AcceptChannelDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_AcceptChannelDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_AcceptChannelDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_AcceptChannelDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: AcceptChannel) -> Result_AcceptChannelDecodeErrorZ {
						...
						let returnValue = Result_AcceptChannelDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_AcceptChannelDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_AcceptChannelDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_AcceptChannelDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> AcceptChannel? {
						if self.cType?.result_ok == true {
							return AcceptChannel(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_AcceptChannelDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_AcceptChannelDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_AcceptChannelDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
