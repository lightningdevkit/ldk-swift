...
public typealias Result_COption_CustomOnionMessageContentsZDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_COption_CustomOnionMessageContentsZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_CustomOnionMessageContentsZDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: CustomOnionMessageContents?)
			-> Result_COption_CustomOnionMessageContentsZDecodeErrorZ
		{
			// native call variable prep

			let oOption = Option_CustomOnionMessageContentsZ(
				some: o,
				instantiationContext:
					"Result_COption_CustomOnionMessageContentsZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		internal func clone() -> Result_COption_CustomOnionMessageContentsZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_CustomOnionMessageContentsZDecodeErrorZ>) in
		...
		public func getValue() -> CustomOnionMessageContents? {
			if self.cType?.result_ok == true {
				return Option_CustomOnionMessageContentsZ(
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_CustomOnionMessageContentsZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_CustomOnionMessageContentsZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
