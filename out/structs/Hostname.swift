...
extension Bindings {
	...
	public class Hostname: NativeTypeWrapper {
		...
		public func hash() -> UInt64 {
			...
			// native method call
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (oPointer: UnsafePointer<LDKHostname>) in
					Hostname_hash(oPointer)
				}
		...
		public func write() -> [UInt8] {
			...
			let returnValue = Vec_u8Z(
				cType: nativeCallResult, instantiationContext: "Hostname.swift::\(#function):\(#line)", anchor: self
			)
