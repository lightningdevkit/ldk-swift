			...
			extension Bindings {
				...
				public class Result_COption_PathFailureZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_PathFailureZDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_COption_PathFailureZDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_COption_PathFailureZDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> PathFailure? {
						if self.cType?.result_ok == true {
							return Option_PathFailureZ(cType: self.cType!.contents.result.pointee, anchor: self).getValue()
						}
						return nil
					}
