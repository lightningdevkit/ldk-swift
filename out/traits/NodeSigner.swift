			...
			extension Bindings {
				...
				open class NodeSigner: NativeTraitWrapper {
					...
					public init() {
						...
						func signGossipMessageLambda(this_arg: UnsafeRawPointer?, msg: LDKUnsignedGossipMessage) -> LDKCResult_SignatureNoneZ {
				...
				return; // the semicolon is necessary because Swift is whitespace-agnostic
					...
					internal func dangle(_ shouldDangle: Bool = true) -> NodeSigner {
