			...
			extension Bindings {
				...
				public class Result_BuiltCommitmentTransactionDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: BuiltCommitmentTransaction) -> Result_BuiltCommitmentTransactionDecodeErrorZ {
						...
						let returnValue = Result_BuiltCommitmentTransactionDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_BuiltCommitmentTransactionDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> BuiltCommitmentTransaction? {
						if self.cType?.result_ok == true {
							return BuiltCommitmentTransaction(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
