			...
			extension Bindings {
				...
				public class UnsignedInvoiceRequest: NativeTypeWrapper {
					...
					internal init(cType: LDKUnsignedInvoiceRequest, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				UnsignedInvoiceRequest_tagged_hash(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = TaggedHash(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_chains(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedInvoiceRequest_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKAmount
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Amount(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_description(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PrintableString(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_offer_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = OfferFeatures(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				UnsignedInvoiceRequest_paths(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_BlindedPathZ(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedInvoiceRequest_supported_quantity(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Quantity(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_signing_pubkey(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedInvoiceRequest_payer_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = u8slice(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle().getValue()
				...
				UnsignedInvoiceRequest_chain(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				UnsignedInvoiceRequest_invoice_request_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = InvoiceRequestFeatures(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				UnsignedInvoiceRequest_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "UnsignedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing UnsignedInvoiceRequest \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing UnsignedInvoiceRequest \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
