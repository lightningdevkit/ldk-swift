...
TxCreationKeys_get_per_commitment_point(this_ptrPointer)
    ...
    public func set_per_commitment_point(val: [UInt8]) -> Void {
    	/* NATIVE_CALL_PREP */
        return withUnsafeMutablePointer(to: &self.cOpaqueStruct!) { (this_ptrPointer: UnsafeMutablePointer<LDKTxCreationKeys>) in
TxCreationKeys_set_per_commitment_point(this_ptrPointer, Bindings.new_LDKPublicKey(array: val))
};
    }
...
TxCreationKeys_get_revocation_key(this_ptrPointer)
    ...
    public func set_revocation_key(val: [UInt8]) -> Void {
    	/* NATIVE_CALL_PREP */
        return withUnsafeMutablePointer(to: &self.cOpaqueStruct!) { (this_ptrPointer: UnsafeMutablePointer<LDKTxCreationKeys>) in
TxCreationKeys_set_revocation_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val))
};
    }
...
TxCreationKeys_get_broadcaster_htlc_key(this_ptrPointer)
    ...
    public func set_broadcaster_htlc_key(val: [UInt8]) -> Void {
    	/* NATIVE_CALL_PREP */
        return withUnsafeMutablePointer(to: &self.cOpaqueStruct!) { (this_ptrPointer: UnsafeMutablePointer<LDKTxCreationKeys>) in
TxCreationKeys_set_broadcaster_htlc_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val))
};
    }
...
TxCreationKeys_get_countersignatory_htlc_key(this_ptrPointer)
    ...
    public func set_countersignatory_htlc_key(val: [UInt8]) -> Void {
    	/* NATIVE_CALL_PREP */
        return withUnsafeMutablePointer(to: &self.cOpaqueStruct!) { (this_ptrPointer: UnsafeMutablePointer<LDKTxCreationKeys>) in
TxCreationKeys_set_countersignatory_htlc_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val))
};
    }
...
TxCreationKeys_get_broadcaster_delayed_payment_key(this_ptrPointer)
    ...
    public func set_broadcaster_delayed_payment_key(val: [UInt8]) -> Void {
    	/* NATIVE_CALL_PREP */
        return withUnsafeMutablePointer(to: &self.cOpaqueStruct!) { (this_ptrPointer: UnsafeMutablePointer<LDKTxCreationKeys>) in
TxCreationKeys_set_broadcaster_delayed_payment_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val))
};
    }
