			...
			extension Bindings {
				...
				NodeAnnouncementInfo_addresses(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_SocketAddressZ(cType: nativeCallResult, instantiationContext: "NodeAnnouncementInfo.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
