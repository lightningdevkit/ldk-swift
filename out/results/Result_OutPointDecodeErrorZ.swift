			...
			extension Bindings {
				...
				public class Result_OutPointDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_OutPointDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_OutPointDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_OutPointDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: OutPoint) -> Result_OutPointDecodeErrorZ {
						...
						let returnValue = Result_OutPointDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_OutPointDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_OutPointDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_OutPointDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> OutPoint? {
						if self.cType?.result_ok == true {
							return OutPoint(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_OutPointDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_OutPointDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_OutPointDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
