public class C2Tuple_BlockHashChannelManagerZ {
    ...
    public class func new(a: [UInt8], b: ChannelManager) -> C2Tuple_BlockHashChannelManagerZ {
        ...
        return C2Tuple_BlockHashChannelManagerZ(pointer: C2Tuple_BlockHashChannelManagerZ_new(Bindings.new_LDKThirtyTwoBytes(array: a).cOpaqueStruct!, b.cOpaqueStruct!));
    }
    ...
    internal func free() -> Void {
        ...
        return C2Tuple_BlockHashChannelManagerZ_free(self.cOpaqueStruct!);
					...
					deinit {
						if !self.dangling {
							print("Freeing C2Tuple_BlockHashChannelManagerZ \(self.instanceNumber).")
							self.free()
						} else {
							print("Not freeing C2Tuple_BlockHashChannelManagerZ \(self.instanceNumber) due to dangle.")
						}
					}
