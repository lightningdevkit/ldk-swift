...
extension Bindings {
	...
	public class Result_GossipTimestampFilterDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_GossipTimestampFilterDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		internal init(
			cType: LDKCResult_GossipTimestampFilterDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: GossipTimestampFilter) -> Result_GossipTimestampFilterDecodeErrorZ {
			...
			let returnValue = Result_GossipTimestampFilterDecodeErrorZ(
				...
				instantiationContext: "Result_GossipTimestampFilterDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_GossipTimestampFilterDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_GossipTimestampFilterDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_GossipTimestampFilterDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_GossipTimestampFilterDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_GossipTimestampFilterDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
