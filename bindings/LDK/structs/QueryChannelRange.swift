public class QueryChannelRange {
    ...
    public init(chain_hash_arg: [UInt8], first_blocknum_arg: UInt32, number_of_blocks_arg: UInt32) {
        ...
        self.cOpaqueStruct = QueryChannelRange_new(Bindings.new_LDKThirtyTwoBytes(array: chain_hash_arg).cOpaqueStruct!, first_blocknum_arg, number_of_blocks_arg)
    }
...
QueryChannelRange_get_chain_hash(this_ptrPointer)
    ...
    public func set_chain_hash(val: [UInt8]) -> Void {
        ...
        return QueryChannelRange_set_chain_hash(this_ptrPointer, Bindings.new_LDKThirtyTwoBytes(array: val).cOpaqueStruct!);
    }
...
QueryChannelRange_end_blocknum(this_argPointer)
    ...
    public class func read(ser: [UInt8]) -> Result_QueryChannelRangeDecodeErrorZ {
        ...
        return Result_QueryChannelRangeDecodeErrorZ(pointer: QueryChannelRange_read(Bindings.new_LDKu8slice(array: ser).cOpaqueStruct!));
    }
