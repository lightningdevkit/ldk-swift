			...
			extension Bindings {
				...
				HolderCommitmentTransaction_get_counterparty_sig(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setCounterpartySig(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ECDSASignature(value: val, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)")
				...
				HolderCommitmentTransaction_get_counterparty_htlc_sigs(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ECDSASignatureZ(cType: nativeCallResult, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setCounterpartyHtlcSigs(val: [[UInt8]]) {
						...
						let valVector = Vec_ECDSASignatureZ(array: val, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)").dangle()
				...
				HolderCommitmentTransaction_write(objPointer)
					...
					public init(commitmentTx: CommitmentTransaction, counterpartySig: [UInt8], counterpartyHtlcSigs: [[UInt8]], holderFundingKey: [UInt8], counterpartyFundingKey: [UInt8]) {
						...
						let counterpartySigPrimitiveWrapper = ECDSASignature(value: counterpartySig, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)")
				
						let counterpartyHtlcSigsVector = Vec_ECDSASignatureZ(array: counterpartyHtlcSigs, instantiationContext: "HolderCommitmentTransaction.swift::\(#function):\(#line)").dangle()
