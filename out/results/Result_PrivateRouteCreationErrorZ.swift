			...
			extension Bindings {
				...
				public class Result_PrivateRouteCreationErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PrivateRouteCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_PrivateRouteCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: PrivateRoute) -> Result_PrivateRouteCreationErrorZ {
						...
						let returnValue = Result_PrivateRouteCreationErrorZ(cType: nativeCallResult, instantiationContext: "Result_PrivateRouteCreationErrorZ.swift::\(#function):\(#line)")
				...
				CResult_PrivateRouteCreationErrorZ_clone(origPointer)
					...
					public func getValue() -> PrivateRoute? {
						if self.cType?.result_ok == true {
							return PrivateRoute(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PrivateRouteCreationErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PrivateRouteCreationErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PrivateRouteCreationErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
