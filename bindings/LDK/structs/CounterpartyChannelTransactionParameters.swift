...
CounterpartyChannelTransactionParameters_write(objPointer)
    ...
    public class func read(ser: [UInt8]) -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
        ...
        return Result_CounterpartyChannelTransactionParametersDecodeErrorZ(pointer: CounterpartyChannelTransactionParameters_read(Bindings.new_LDKu8sliceWrapper(array: ser).cOpaqueStruct!));
    }
