...
extension Bindings {
	...
	public class Result_ClosingSignedFeeRangeDecodeErrorZ: NativeTypeWrapper {
		...
		internal var cOpaqueStruct: LDKCResult_ClosingSignedFeeRangeDecodeErrorZ?
		...
		/* RESULT_METHODS_START */
			...
			public func getValue() -> ClosingSignedFeeRange? {
				if self.cOpaqueStruct?.result_ok == true {
					return ClosingSignedFeeRange(pointer: self.cOpaqueStruct!.contents.result.pointee, anchor: self).dangle()
				}
				return nil
			}
