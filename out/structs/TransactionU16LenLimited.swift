			...
			extension Bindings {
				...
				public class TransactionU16LenLimited: NativeTypeWrapper {
					...
					internal init(cType: LDKTransactionU16LenLimited, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				TransactionU16LenLimited_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = TransactionU16LenLimited(cType: nativeCallResult, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)")
				...
				TransactionU16LenLimited_eq(aPointer, bPointer)
					...
					public class func new(transaction: [UInt8]) -> Result_TransactionU16LenLimitedNoneZ {
						...
						let transactionPrimitiveWrapper = Transaction(value: transaction, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)").dangle()
						...
						// return value (do some wrapping)
						let returnValue = Result_TransactionU16LenLimitedNoneZ(cType: nativeCallResult, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)")
					...
					public func intoTransaction() -> [UInt8] {
						...
						// return value (do some wrapping)
						let returnValue = Transaction(cType: nativeCallResult, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)").getValue()
				...
				TransactionU16LenLimited_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_TransactionU16LenLimitedDecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_TransactionU16LenLimitedDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TransactionU16LenLimited.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing TransactionU16LenLimited \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing TransactionU16LenLimited \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
