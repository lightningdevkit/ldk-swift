			...
			extension Bindings {
				...
				public class Result_CVec_CVec_u8ZZNoneZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: [[UInt8]]) -> Result_CVec_CVec_u8ZZNoneZ {
						...
						let returnValue = Result_CVec_CVec_u8ZZNoneZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
					...
					*/
					...
					public func getValue() -> [[UInt8]]? {
						if self.cType?.result_ok == true {
							return Vec_CVec_u8ZZ(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
