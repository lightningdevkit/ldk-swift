			...
			extension Bindings {
				...
				public class Result_UpdateFulfillHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UpdateFulfillHTLC) -> Result_UpdateFulfillHTLCDecodeErrorZ {
						...
						let returnValue = Result_UpdateFulfillHTLCDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UpdateFulfillHTLCDecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_UpdateFulfillHTLCDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_UpdateFulfillHTLCDecodeErrorZ>) in
				CResult_UpdateFulfillHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UpdateFulfillHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UpdateFulfillHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFulfillHTLC(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UpdateFulfillHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UpdateFulfillHTLCDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UpdateFulfillHTLCDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
