			...
			extension Bindings {
				...
				public class Result_FixedPenaltyScorerDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_FixedPenaltyScorerDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_FixedPenaltyScorerDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_FixedPenaltyScorerDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> FixedPenaltyScorer? {
						if self.cType?.result_ok == true {
							return FixedPenaltyScorer(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
