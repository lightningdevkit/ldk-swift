			...
			extension Bindings {
				...
				public class Result_COption_HTLCDestinationZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_HTLCDestinationZDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_COption_HTLCDestinationZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_COption_HTLCDestinationZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: HTLCDestination?) -> Result_COption_HTLCDestinationZDecodeErrorZ {
						...
						let returnValue = Result_COption_HTLCDestinationZDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_COption_HTLCDestinationZDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_COption_HTLCDestinationZDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_COption_HTLCDestinationZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> HTLCDestination? {
						if self.cType?.result_ok == true {
							return Option_HTLCDestinationZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_COption_HTLCDestinationZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_COption_HTLCDestinationZDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_COption_HTLCDestinationZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_COption_HTLCDestinationZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
