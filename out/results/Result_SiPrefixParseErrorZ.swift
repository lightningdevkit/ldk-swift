			...
			extension Bindings {
				...
				public class Result_SiPrefixParseErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_SiPrefixParseErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_SiPrefixParseErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_SiPrefixParseErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: SiPrefix) -> Result_SiPrefixParseErrorZ {
						...
						let returnValue = Result_SiPrefixParseErrorZ(cType: nativeCallResult, instantiationContext: "Result_SiPrefixParseErrorZ.swift::\(#function):\(#line)")
				...
				CResult_SiPrefixParseErrorZ_clone(origPointer)
					...
					public func getError() -> ParseError? {
						if self.cType?.result_ok == false {
							return ParseError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_SiPrefixParseErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_SiPrefixParseErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_SiPrefixParseErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
