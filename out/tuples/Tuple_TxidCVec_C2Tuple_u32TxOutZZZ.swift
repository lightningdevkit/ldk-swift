			...
			extension Bindings {
				...
				C2Tuple_TxidCVec_C2Tuple_u32TxOutZZZ_clone(origPointer)
						...
						let returnValue = Tuple_TxidCVec_C2Tuple_u32TxOutZZZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
					...
					public func getB() -> [(UInt32, TxOut)] {
						// return value (do some wrapping)
						let returnValue = Vec_C2Tuple_u32TxOutZZ(cType: self.cType!.b, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self).dangle().getValue()
