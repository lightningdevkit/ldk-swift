			...
			extension Bindings {
				...
				public class Result_COption_APIErrorZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_APIErrorZDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_COption_APIErrorZDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_COption_APIErrorZDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> APIError? {
						if self.cType?.result_ok == true {
							return Option_APIErrorZ(cType: self.cType!.contents.result.pointee, anchor: self).getValue()
						}
						return nil
					}
