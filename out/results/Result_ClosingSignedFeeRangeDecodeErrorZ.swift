			...
			extension Bindings {
				...
				public class Result_ClosingSignedFeeRangeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ClosingSignedFeeRangeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ClosingSignedFeeRange) -> Result_ClosingSignedFeeRangeDecodeErrorZ {
						...
						let returnValue = Result_ClosingSignedFeeRangeDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ClosingSignedFeeRangeDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ClosingSignedFeeRangeDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ClosingSignedFeeRangeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ClosingSignedFeeRange? {
						if self.cType?.result_ok == true {
							return ClosingSignedFeeRange(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ClosingSignedFeeRangeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ClosingSignedFeeRangeDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ClosingSignedFeeRangeDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
