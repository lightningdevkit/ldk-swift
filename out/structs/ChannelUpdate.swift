			...
			extension Bindings {
				...
				ChannelUpdate_get_signature(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Signature(cType: nativeCallResult, instantiationContext: "ChannelUpdate.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setSignature(val: [UInt8]) {
						...
						let valPrimitiveWrapper = Signature(value: val, instantiationContext: "ChannelUpdate.swift::\(#function):\(#line)")
				...
				ChannelUpdate_set_contents(thisPtrPointer, val.dynamicallyDangledClone().cType!)
					...
					public init(signatureArg: [UInt8], contentsArg: UnsignedChannelUpdate) {
						...
						let signatureArgPrimitiveWrapper = Signature(value: signatureArg, instantiationContext: "ChannelUpdate.swift::\(#function):\(#line)")
