			...
			extension Bindings {
				...
				public class Result_ChannelInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelInfoDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ChannelInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelInfo) -> Result_ChannelInfoDecodeErrorZ {
						...
						let returnValue = Result_ChannelInfoDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelInfoDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelInfoDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelInfo? {
						if self.cType?.result_ok == true {
							return ChannelInfo(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
