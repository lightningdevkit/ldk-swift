			...
			extension Bindings {
				...
				public class Result_HTLCDescriptorDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_HTLCDescriptorDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_HTLCDescriptorDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: HTLCDescriptor) -> Result_HTLCDescriptorDecodeErrorZ {
						...
						let returnValue = Result_HTLCDescriptorDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_HTLCDescriptorDecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_HTLCDescriptorDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_HTLCDescriptorDecodeErrorZ>) in
				CResult_HTLCDescriptorDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_HTLCDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> HTLCDescriptor? {
						if self.cType?.result_ok == true {
							return HTLCDescriptor(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_HTLCDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_HTLCDescriptorDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_HTLCDescriptorDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
