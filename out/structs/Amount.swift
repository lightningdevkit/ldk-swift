			...
			extension Bindings {
				...
				Amount_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = Amount(cType: nativeCallResult, instantiationContext: "Amount.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Amount \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
