			...
			extension Bindings {
				...
				public class Bolt11Invoice: NativeTypeWrapper {
					...
					internal init(cType: LDKBolt11Invoice, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				Bolt11Invoice_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = Bolt11Invoice(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)")
				...
				Bolt11Invoice_signable_hash(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func intoSignedRaw() -> SignedRawBolt11Invoice {
						...
						// return value (do some wrapping)
						let returnValue = SignedRawBolt11Invoice(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)")
				...
				Bolt11Invoice_check_signature(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Result_NoneBolt11SemanticErrorZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public class func fromSigned(signedInvoice: SignedRawBolt11Invoice) -> Result_Bolt11InvoiceBolt11SemanticErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_Bolt11InvoiceBolt11SemanticErrorZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)")
				...
				// Type: LDKPublicKey
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Bolt11Invoice_payment_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKBolt11InvoiceFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Bolt11InvoiceFeatures(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Bolt11Invoice_expires_at(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				Bolt11Invoice_fallback_addresses(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_StrZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Bolt11Invoice_private_routes(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_PrivateRouteZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Bolt11Invoice_route_hints(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_RouteHintZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Bolt11Invoice_amount_milli_satoshis(thisArgPointer)
					...
					public class func fromStr(s: String) -> Result_Bolt11InvoiceParseOrSemanticErrorZ {
						...
						let sPrimitiveWrapper = Str(value: s, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)").dangle()
						...
						// return value (do some wrapping)
						let returnValue = Result_Bolt11InvoiceParseOrSemanticErrorZ(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)")
				...
				Bolt11Invoice_to_str(oPointer)
						...
						// return value (do some wrapping)
						let returnValue = Str(cType: nativeCallResult, instantiationContext: "Bolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Bolt11Invoice \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Bolt11Invoice \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
