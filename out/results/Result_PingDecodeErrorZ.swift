			...
			extension Bindings {
				...
				public class Result_PingDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PingDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Ping) -> Result_PingDecodeErrorZ {
						...
						let returnValue = Result_PingDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_PingDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_PingDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_PingDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Ping? {
						if self.cType?.result_ok == true {
							return Ping(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PingDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PingDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PingDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
