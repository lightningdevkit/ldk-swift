			...
			extension Bindings {
				...
				public class Result_NodeAnnouncementInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: NodeAnnouncementInfo) -> Result_NodeAnnouncementInfoDecodeErrorZ {
						...
						let returnValue = Result_NodeAnnouncementInfoDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_NodeAnnouncementInfoDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_NodeAnnouncementInfoDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NodeAnnouncementInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> NodeAnnouncementInfo? {
						if self.cType?.result_ok == true {
							return NodeAnnouncementInfo(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_NodeAnnouncementInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_NodeAnnouncementInfoDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NodeAnnouncementInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NodeAnnouncementInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
