...
extension Bindings {
	...
	public class Result_ChannelAnnouncementDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ChannelAnnouncementDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: ChannelAnnouncement) -> Result_ChannelAnnouncementDecodeErrorZ {
			...
			let returnValue = Result_ChannelAnnouncementDecodeErrorZ(
				...
				instantiationContext: "Result_ChannelAnnouncementDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ChannelAnnouncementDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ChannelAnnouncementDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_ChannelAnnouncementDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ChannelAnnouncementDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ChannelAnnouncementDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
