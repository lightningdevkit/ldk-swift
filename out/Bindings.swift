...
public class Bindings {
	...
	public class func buildHtlcInputWitness(
		...
		let localSigPrimitiveWrapper = Signature(
	...
	public class func buildAnchorInputWitness(fundingKey: [UInt8], fundingSig: [UInt8]) -> [UInt8] {
		...
		let fundingSigPrimitiveWrapper = Signature(
	...
	public class func readBlockHashChannelMonitor(ser: [UInt8], argA: EntropySource, argB: SignerProvider)
