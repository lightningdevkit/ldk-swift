			...
			extension Bindings {
				...
				public class Result_C2Tuple_CVec_u8ZusizeZNoneZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_CVec_u8ZusizeZNoneZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_C2Tuple_CVec_u8ZusizeZNoneZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ([UInt8], UInt)) -> Result_C2Tuple_CVec_u8ZusizeZNoneZ {
						...
						let oTuple = Tuple_CVec_u8ZusizeZ(tuple: o, instantiationContext: "Result_C2Tuple_CVec_u8ZusizeZNoneZ.swift::\(#function):\(#line)").danglingClone()
						...
						let returnValue = Result_C2Tuple_CVec_u8ZusizeZNoneZ(cType: nativeCallResult, instantiationContext: "Result_C2Tuple_CVec_u8ZusizeZNoneZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_C2Tuple_CVec_u8ZusizeZNoneZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_C2Tuple_CVec_u8ZusizeZNoneZ>) in
					...
					*/
					...
					public func getValue() -> ([UInt8], UInt)? {
						if self.cType?.result_ok == true {
							return Tuple_CVec_u8ZusizeZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_C2Tuple_CVec_u8ZusizeZNoneZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_C2Tuple_CVec_u8ZusizeZNoneZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_C2Tuple_CVec_u8ZusizeZNoneZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
