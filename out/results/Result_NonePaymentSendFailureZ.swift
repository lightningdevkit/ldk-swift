			...
			extension Bindings {
				...
				public class Result_NonePaymentSendFailureZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NonePaymentSendFailureZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_NonePaymentSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_NonePaymentSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk() -> Result_NonePaymentSendFailureZ {
						...
						let returnValue = Result_NonePaymentSendFailureZ(cType: nativeCallResult, instantiationContext: "Result_NonePaymentSendFailureZ.swift::\(#function):\(#line)")
					...
					public class func initWithErr(e: PaymentSendFailure) -> Result_NonePaymentSendFailureZ {
						...
						// native method call
						let nativeCallResult = CResult_NonePaymentSendFailureZ_err(e.danglingClone().cType!)
				...
				CResult_NonePaymentSendFailureZ_clone(origPointer)
					...
					public func getError() -> PaymentSendFailure? {
						if self.cType?.result_ok == false {
							return PaymentSendFailure(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NonePaymentSendFailureZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					*/
					...
					internal func dangle(_ shouldDangle: Bool = true) -> Result_NonePaymentSendFailureZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NonePaymentSendFailureZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NonePaymentSendFailureZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
