			...
			extension Bindings {
				...
				public class Result_WriteableEcdsaChannelSignerDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_WriteableEcdsaChannelSignerDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_WriteableEcdsaChannelSignerDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_WriteableEcdsaChannelSignerDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> WriteableEcdsaChannelSigner? {
						if self.cType?.result_ok == true {
							return NativelyImplementedWriteableEcdsaChannelSigner(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
