...
extension Bindings {
	...
	public class Result_DelayedPaymentOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_DelayedPaymentOutputDescriptorDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: DelayedPaymentOutputDescriptor)
			-> Result_DelayedPaymentOutputDescriptorDecodeErrorZ
		{
			...
			// native method call
			let nativeCallResult = CResult_DelayedPaymentOutputDescriptorDecodeErrorZ_ok(
			...
			let returnValue = Result_DelayedPaymentOutputDescriptorDecodeErrorZ(
				cType: nativeCallResult,
				instantiationContext: "Result_DelayedPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_DelayedPaymentOutputDescriptorDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_DelayedPaymentOutputDescriptorDecodeErrorZ>) in
			...
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext:
						"Result_DelayedPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
			}
			return nil
		}
		...
		internal func dangleRecursively() -> Result_DelayedPaymentOutputDescriptorDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_DelayedPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_DelayedPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
