public class Result_FundingLockedDecodeErrorZ: NativeTypeWrapper {
    ...
    internal func free() -> Void {
        ...
        return CResult_FundingLockedDecodeErrorZ_free(self.cOpaqueStruct!);
					...
					deinit {
						if !self.dangling {
							print("Freeing Result_FundingLockedDecodeErrorZ \(self.instanceNumber).")
							self.free()
						} else {
							print("Not freeing Result_FundingLockedDecodeErrorZ \(self.instanceNumber) due to dangle.")
						}
					}
