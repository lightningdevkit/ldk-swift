			...
			extension Bindings {
				...
				public class Result_ChannelPublicKeysDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: ChannelPublicKeys) -> Result_ChannelPublicKeysDecodeErrorZ {
						...
						let returnValue = Result_ChannelPublicKeysDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_ChannelPublicKeysDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelPublicKeys? {
						if self.cType?.result_ok == true {
							return ChannelPublicKeys(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
