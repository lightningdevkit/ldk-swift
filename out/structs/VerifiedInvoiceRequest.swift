			...
			extension Bindings {
				...
				public class VerifiedInvoiceRequest: NativeTypeWrapper {
					...
					internal init(cType: LDKVerifiedInvoiceRequest, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				VerifiedInvoiceRequest_get_keys(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_SecretKeyZ(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setKeys(val: [UInt8]?) {
						...
						let valOption = Option_SecretKeyZ(some: val, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKVerifiedInvoiceRequest>) in
				...
				VerifiedInvoiceRequest_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = VerifiedInvoiceRequest(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)")
				...
				VerifiedInvoiceRequest_chains(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				VerifiedInvoiceRequest_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKAmount
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Amount(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				VerifiedInvoiceRequest_description(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PrintableString(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				VerifiedInvoiceRequest_offer_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = OfferFeatures(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				VerifiedInvoiceRequest_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				VerifiedInvoiceRequest_paths(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_BlindedPathZ(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				VerifiedInvoiceRequest_supported_quantity(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Quantity(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				VerifiedInvoiceRequest_signing_pubkey(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				VerifiedInvoiceRequest_payer_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = u8slice(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle().getValue()
				...
				VerifiedInvoiceRequest_chain(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = ThirtyTwoBytes(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				VerifiedInvoiceRequest_invoice_request_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = InvoiceRequestFeatures(cType: nativeCallResult, instantiationContext: "VerifiedInvoiceRequest.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing VerifiedInvoiceRequest \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing VerifiedInvoiceRequest \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
