...
internal typealias Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ = Bindings
...
extension Bindings {
	...
	internal class Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKC3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ, instantiationContext: String,
		...
		internal convenience init(
			tuple: (ChannelAnnouncement, ChannelUpdate, ChannelUpdate), instantiationContext: String
		) {
		...
		internal func clone() -> Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKC3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ>) in
			...
			let returnValue = Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ(
				cType: nativeCallResult,
				instantiationContext:
					"Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ.swift::\(#function):\(#line)")
		...
		public init(a: ChannelAnnouncement, b: ChannelUpdate, c: ChannelUpdate, instantiationContext: String) {
			...
			// native method call
			let nativeCallResult = C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ_new(
				a.dynamicallyDangledClone().cType!, b.dynamicallyDangledClone().cType!,
				c.dynamicallyDangledClone().cType!)
		...
		public func getA() -> ChannelAnnouncement {
			...
			let returnValue = ChannelAnnouncement(
				cType: self.cType!.a,
				instantiationContext:
					"Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ.swift::\(#function):\(#line)", anchor: self
			)
			.dangle()
		...
		internal func dangleRecursively() -> Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
