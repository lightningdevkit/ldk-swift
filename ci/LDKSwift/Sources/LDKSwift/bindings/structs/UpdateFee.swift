...
UpdateFee_clone(origPointer)
		...
		public class func eq(a: UpdateFee, b: UpdateFee) -> Bool {
			...
			return withUnsafePointer(to: a.cOpaqueStruct!) { (aPointer: UnsafePointer<LDKUpdateFee>) in
withUnsafePointer(to: b.cOpaqueStruct!) { (bPointer: UnsafePointer<LDKUpdateFee>) in
