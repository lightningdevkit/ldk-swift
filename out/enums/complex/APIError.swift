...
extension Bindings {
	...
	public class APIError: NativeTypeWrapper {
		...
		internal func clone() -> APIError {
			...
			// return value (do some wrapping)
			let returnValue = APIError(
				cType: nativeCallResult, instantiationContext: "APIError.swift::\(#function):\(#line)")
		...
		public class func initWithApimisuseError(err: String) -> APIError {
			...
			let errPrimitiveWrapper = Str(value: err, instantiationContext: "APIError.swift::\(#function):\(#line)")
				.dangle()
		...
		public func write() -> [UInt8] {
			...
			let returnValue = Vec_u8Z(
				cType: nativeCallResult, instantiationContext: "APIError.swift::\(#function):\(#line)", anchor: self
			)
		...
		public class func read(ser: [UInt8]) -> Result_COption_APIErrorZDecodeErrorZ {
			...
			// return value (do some wrapping)
			let returnValue = Result_COption_APIErrorZDecodeErrorZ(
				cType: nativeCallResult, instantiationContext: "APIError.swift::\(#function):\(#line)")
		...
		public func getValueAsApiMisuseError() -> APIMisuseError? {
			...
			return APIError_LDKAPIMisuseError_Body(
				cType: self.cType!.api_misuse_error, instantiationContext: "APIError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsFeeRateTooHigh() -> FeeRateTooHigh? {
			...
			return APIError_LDKFeeRateTooHigh_Body(
				cType: self.cType!.fee_rate_too_high, instantiationContext: "APIError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsInvalidRoute() -> InvalidRoute? {
			...
			return APIError_LDKInvalidRoute_Body(
				cType: self.cType!.invalid_route, instantiationContext: "APIError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsChannelUnavailable() -> ChannelUnavailable? {
			...
			return APIError_LDKChannelUnavailable_Body(
				cType: self.cType!.channel_unavailable, instantiationContext: "APIError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsIncompatibleShutdownScript() -> IncompatibleShutdownScript? {
			...
			return APIError_LDKIncompatibleShutdownScript_Body(
				cType: self.cType!.incompatible_shutdown_script,
				instantiationContext: "APIError.swift::\(#function):\(#line)", anchor: self)
		}
		...
		deinit {
			...
			if !self.dangling {
				...
				Bindings.print(
					"Not freeing APIError \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
			}
		}
		...
		public class APIMisuseError: NativeTypeWrapper {
			...
			internal init(
				cType: LDKAPIError_LDKAPIMisuseError_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
			...
			public func getErr() -> String {
				// return value (do some wrapping)
				let returnValue = Str(
					cType: self.cType!.err, instantiationContext: "APIError.swift::\(#function):\(#line)", anchor: self
				)
				.getValue()
		...
		public class FeeRateTooHigh: NativeTypeWrapper {
			...
			internal init(
				cType: LDKAPIError_LDKFeeRateTooHigh_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
		...
		public class InvalidRoute: NativeTypeWrapper {
			...
			internal init(
				cType: LDKAPIError_LDKInvalidRoute_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
		...
		public class ChannelUnavailable: NativeTypeWrapper {
			...
			internal init(
				cType: LDKAPIError_LDKChannelUnavailable_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
		...
		public class IncompatibleShutdownScript: NativeTypeWrapper {
			...
			internal init(
				cType: LDKAPIError_LDKIncompatibleShutdownScript_Body, instantiationContext: String,
			...
			public func getScript() -> Bindings.ShutdownScript {
				// return value (do some wrapping)
				let returnValue = Bindings.ShutdownScript(
					cType: self.cType!.script, instantiationContext: "APIError.swift::\(#function):\(#line)",
					anchor: self)
