			...
			extension Bindings {
				...
				public class Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: [([UInt8], ChannelMonitor)]) -> Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ {
						...
						let oVector = Vec_C2Tuple_BlockHashChannelMonitorZZ(array: o, instantiationContext: "Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ.swift::\(#function):\(#line)").dangle()
						...
						let returnValue = Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ(cType: nativeCallResult, instantiationContext: "Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ.swift::\(#function):\(#line)")
				...
				CResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ_clone(origPointer)
					...
					public func getValue() -> [([UInt8], ChannelMonitor)]? {
						if self.cType?.result_ok == true {
							return Vec_C2Tuple_BlockHashChannelMonitorZZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
