...
public class Result_CResult_NetAddressu8ZDecodeErrorZ: NativeTypeWrapper {
    ...
    internal func free() -> Void {
        ...
        return CResult_CResult_NetAddressu8ZDecodeErrorZ_free(self.cOpaqueStruct!);
					...
					deinit {
						if !self.dangling {
							print("Freeing Result_CResult_NetAddressu8ZDecodeErrorZ \(self.instanceNumber).")
							self.free()
						} else {
							print("Not freeing Result_CResult_NetAddressu8ZDecodeErrorZ \(self.instanceNumber) due to dangle.")
						}
					}
