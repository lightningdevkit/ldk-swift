			...
			extension Bindings {
				...
				public class Result_CounterpartyCommitmentSecretsDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CounterpartyCommitmentSecretsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_CounterpartyCommitmentSecretsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: CounterpartyCommitmentSecrets) -> Result_CounterpartyCommitmentSecretsDecodeErrorZ {
						...
						let returnValue = Result_CounterpartyCommitmentSecretsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_CounterpartyCommitmentSecretsDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_CounterpartyCommitmentSecretsDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_CounterpartyCommitmentSecretsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> CounterpartyCommitmentSecrets? {
						if self.cType?.result_ok == true {
							return CounterpartyCommitmentSecrets(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_CounterpartyCommitmentSecretsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_CounterpartyCommitmentSecretsDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_CounterpartyCommitmentSecretsDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
