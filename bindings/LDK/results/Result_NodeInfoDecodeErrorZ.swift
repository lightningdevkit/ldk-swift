public class Result_NodeInfoDecodeErrorZ: NativeTypeWrapper {
    ...
    internal var cOpaqueStruct: LDKCResult_NodeInfoDecodeErrorZ?
    ...
    /* RESULT_METHODS_START */
		...
		public func getValue() throws -> NodeInfo {
			if self.cOpaqueStruct?.result_ok == true {
				return NodeInfo(pointer: self.cOpaqueStruct!.contents.result.pointee, anchor: self)
			}
