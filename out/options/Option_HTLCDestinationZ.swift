			...
			extension Bindings {
				...
				internal class Option_HTLCDestinationZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCOption_HTLCDestinationZ) {
					...
					internal init(cType: LDKCOption_HTLCDestinationZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public init(some: HTLCDestination?) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
