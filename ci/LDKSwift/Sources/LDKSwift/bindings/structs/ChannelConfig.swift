...
extension Bindings {
	...
	public class ChannelConfig: NativeTypeWrapper {
		...
		internal var cOpaqueStruct: LDKChannelConfig?
...
ChannelConfig_clone(origPointer)
		...
		public class func eq(a: ChannelConfig, b: ChannelConfig) -> Bool {
			...
			return withUnsafePointer(to: a.cOpaqueStruct!) { (aPointer: UnsafePointer<LDKChannelConfig>) in
withUnsafePointer(to: b.cOpaqueStruct!) { (bPointer: UnsafePointer<LDKChannelConfig>) in
...
}, callerContext: "ChannelConfig::write");
		}
