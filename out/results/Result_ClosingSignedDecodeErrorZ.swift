			...
			extension Bindings {
				...
				public class Result_ClosingSignedDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ClosingSignedDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ClosingSignedDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ClosingSignedDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ClosingSigned? {
						if self.cType?.result_ok == true {
							return ClosingSigned(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
