			...
			extension Bindings {
				...
				public class Result_COption_MonitorEventZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_MonitorEventZDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_COption_MonitorEventZDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_COption_MonitorEventZDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> MonitorEvent? {
						if self.cType?.result_ok == true {
							return Option_MonitorEventZ(cType: self.cType!.contents.result.pointee, anchor: self).getValue()
						}
						return nil
					}
