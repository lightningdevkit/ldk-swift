			...
			extension Bindings {
				...
				internal class Tuple__u168_u168Z: NativeTypeWrapper {
					...
					internal init(cType: LDKC2Tuple__u168_u168Z, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Tuple__u168_u168Z \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Tuple__u168_u168Z \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
