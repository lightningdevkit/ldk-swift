			...
			extension Bindings {
				...
				public class Result_NodeInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NodeInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: NodeInfo) -> Result_NodeInfoDecodeErrorZ {
						...
						let returnValue = Result_NodeInfoDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_NodeInfoDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_NodeInfoDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NodeInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> NodeInfo? {
						if self.cType?.result_ok == true {
							return NodeInfo(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_NodeInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NodeInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NodeInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
