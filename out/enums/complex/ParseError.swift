...
extension Bindings {
	...
	public class ParseError: NativeTypeWrapper {
		...
		internal init(
			cType: LDKParseError, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		internal func clone() -> ParseError {
			...
			// return value (do some wrapping)
			let returnValue = ParseError(
				cType: nativeCallResult, instantiationContext: "ParseError.swift::\(#function):\(#line)")
		...
		public class func initWithInvalidSliceLength(a: String) -> ParseError {
			...
			let aPrimitiveWrapper = Str(value: a, instantiationContext: "ParseError.swift::\(#function):\(#line)")
				.dangle()
		...
		public func toStr() -> String {
			...
			// return value (do some wrapping)
			let returnValue = Str(
				cType: nativeCallResult, instantiationContext: "ParseError.swift::\(#function):\(#line)", anchor: self
			)
		...
		public func getValueAsBech32Error() -> Bech32Error? {
			...
			return Bech32Error(
				cType: self.cType!.bech32_error, instantiationContext: "ParseError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsParseAmountError() -> Bindings.BindingsError? {
			...
			return BindingsError(
				cType: self.cType!.parse_amount_error, instantiationContext: "ParseError.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsDescriptionDecodeError() -> Bindings.BindingsError? {
			...
			return BindingsError(
				...
				instantiationContext: "ParseError.swift::\(#function):\(#line)", anchor: self)
		}
		...
		internal func dangleRecursively() -> ParseError {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				...
				Bindings.print(
					"Not freeing ParseError \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
