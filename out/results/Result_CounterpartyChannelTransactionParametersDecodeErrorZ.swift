			...
			extension Bindings {
				...
				public class Result_CounterpartyChannelTransactionParametersDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CounterpartyChannelTransactionParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: CounterpartyChannelTransactionParameters) -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
						...
						let returnValue = Result_CounterpartyChannelTransactionParametersDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_CounterpartyChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_CounterpartyChannelTransactionParametersDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_CounterpartyChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> CounterpartyChannelTransactionParameters? {
						if self.cType?.result_ok == true {
							return CounterpartyChannelTransactionParameters(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_CounterpartyChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_CounterpartyChannelTransactionParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_CounterpartyChannelTransactionParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
