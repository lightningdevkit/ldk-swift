			...
			extension Bindings {
				...
				public class Result_ClosingSignedDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ClosingSignedDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ClosingSigned) -> Result_ClosingSignedDecodeErrorZ {
						...
						let returnValue = Result_ClosingSignedDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ClosingSignedDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ClosingSignedDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ClosingSignedDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ClosingSigned? {
						if self.cType?.result_ok == true {
							return ClosingSigned(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ClosingSignedDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ClosingSignedDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ClosingSignedDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
