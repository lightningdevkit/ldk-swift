			...
			extension Bindings {
				...
				public class Result_NodeAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NodeAnnouncementDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: NodeAnnouncement) -> Result_NodeAnnouncementDecodeErrorZ {
						...
						let returnValue = Result_NodeAnnouncementDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_NodeAnnouncementDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_NodeAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NodeAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> NodeAnnouncement? {
						if self.cType?.result_ok == true {
							return NodeAnnouncement(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_NodeAnnouncementDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NodeAnnouncementDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NodeAnnouncementDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
