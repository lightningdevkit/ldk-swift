...
public typealias Option_NetAddressZ = Bindings.Option_NetAddressZ
	...
	public class Option_NetAddressZ: NativeTypeWrapper {
		...
		public func getValue() -> NetAddress? {
				...
				if self.cOpaqueStruct!.tag == LDKCOption_NetAddressZ_Some {
					return NetAddress(pointer: self.cOpaqueStruct!.some, anchor: self).dangle()
				}
		...
		public class func some(o: Bindings.NetAddress) -> Option_NetAddressZ {
