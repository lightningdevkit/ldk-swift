...
HTLCOutputInCommitment_write(objPointer)
    ...
    public class func read(ser: [UInt8]) throws -> HTLCOutputInCommitment {
        ...
        return try Result_HTLCOutputInCommitmentDecodeErrorZ(pointer: HTLCOutputInCommitment_read(serWrapper.cOpaqueStruct!)).getValue();
    }
