...
extension Bindings {
	...
	public class Result_RouteParametersDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_RouteParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: RouteParameters) -> Result_RouteParametersDecodeErrorZ {
			...
			let returnValue = Result_RouteParametersDecodeErrorZ(
				...
				instantiationContext: "Result_RouteParametersDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_RouteParametersDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_RouteParametersDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_RouteParametersDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_RouteParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_RouteParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
