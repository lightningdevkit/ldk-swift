			...
			extension Bindings {
				...
				public class Result_ReplyShortChannelIdsEndDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: ReplyShortChannelIdsEnd) -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
						...
						let returnValue = Result_ReplyShortChannelIdsEndDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_ReplyShortChannelIdsEndDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ReplyShortChannelIdsEnd? {
						if self.cType?.result_ok == true {
							return ReplyShortChannelIdsEnd(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
