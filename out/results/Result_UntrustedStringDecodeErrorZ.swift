			...
			extension Bindings {
				...
				public class Result_UntrustedStringDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UntrustedStringDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_UntrustedStringDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UntrustedStringDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UntrustedString) -> Result_UntrustedStringDecodeErrorZ {
						...
						let returnValue = Result_UntrustedStringDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UntrustedStringDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UntrustedStringDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UntrustedStringDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UntrustedString? {
						if self.cType?.result_ok == true {
							return UntrustedString(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UntrustedStringDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UntrustedStringDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UntrustedStringDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
