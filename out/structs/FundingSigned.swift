			...
			extension Bindings {
				...
				public class FundingSigned: NativeTypeWrapper {
					...
					internal init(cType: LDKFundingSigned, instantiationContext: String) {
					...
					internal init(cType: LDKFundingSigned, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
					...
					internal init(cType: LDKFundingSigned, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				FundingSigned_get_signature(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "FundingSigned.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setSignature(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ECDSASignature(value: val, instantiationContext: "FundingSigned.swift::\(#function):\(#line)")
				...
				FundingSigned_set_signature(thisPtrPointer, valPrimitiveWrapper.cType!)
					...
					public init(channelIdArg: [UInt8], signatureArg: [UInt8]) {
						...
						let signatureArgPrimitiveWrapper = ECDSASignature(value: signatureArg, instantiationContext: "FundingSigned.swift::\(#function):\(#line)")
				...
				self.initialCFreeability = nativeCallResult.is_owned
						...
						/*
						// return value (do some wrapping)
						let returnValue = FundingSigned(cType: nativeCallResult, instantiationContext: "FundingSigned.swift::\(#function):\(#line)")
						*/
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "FundingSigned.swift::\(#function):\(#line)")
				...
				FundingSigned_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "FundingSigned.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_FundingSignedDecodeErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_FundingSignedDecodeErrorZ(cType: nativeCallResult, instantiationContext: "FundingSigned.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing FundingSigned \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing FundingSigned \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
