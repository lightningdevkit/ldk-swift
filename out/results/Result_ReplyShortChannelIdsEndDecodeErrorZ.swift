			...
			extension Bindings {
				...
				public class Result_ReplyShortChannelIdsEndDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
