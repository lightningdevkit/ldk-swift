			...
			extension Bindings {
				...
				public class Result_QueryShortChannelIdsDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_QueryShortChannelIdsDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_QueryShortChannelIdsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_QueryShortChannelIdsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: QueryShortChannelIds) -> Result_QueryShortChannelIdsDecodeErrorZ {
						...
						let returnValue = Result_QueryShortChannelIdsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_QueryShortChannelIdsDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_QueryShortChannelIdsDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_QueryShortChannelIdsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> QueryShortChannelIds? {
						if self.cType?.result_ok == true {
							return QueryShortChannelIds(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_QueryShortChannelIdsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_QueryShortChannelIdsDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_QueryShortChannelIdsDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
