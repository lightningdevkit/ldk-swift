			...
			extension Bindings {
				...
				public class Result_NonePaymentSendFailureZ: NativeTypeWrapper {
					...
					public class func initWithOk() -> Result_NonePaymentSendFailureZ {
						...
						let returnValue = Result_NonePaymentSendFailureZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_NonePaymentSendFailureZ_clone(origPointer)
					...
					public func getError() -> PaymentSendFailure? {
						if self.cType?.result_ok == false {
							return PaymentSendFailure(cType: self.cType!.contents.err.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
