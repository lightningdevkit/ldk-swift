			...
			extension Bindings {
				...
				public class TxInitRbf: NativeTypeWrapper {
					...
					internal init(cType: LDKTxInitRbf, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				TxInitRbf_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)")
				...
				TxInitRbf_get_funding_output_contribution(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_i64Z(cType: nativeCallResult, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setFundingOutputContribution(val: Int64?) {
						...
						let valOption = Option_i64Z(some: val, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)").danglingClone()
				...
				TxInitRbf_set_funding_output_contribution(thisPtrPointer, valOption.cType!)
					...
					public init(channelIdArg: [UInt8], locktimeArg: UInt32, feerateSatPer1000WeightArg: UInt32, fundingOutputContributionArg: Int64?) {
						// native call variable prep
						
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)")
				
						let fundingOutputContributionArgOption = Option_i64Z(some: fundingOutputContributionArg, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = TxInitRbf_new(channelIdArgPrimitiveWrapper.cType!, locktimeArg, feerateSatPer1000WeightArg, fundingOutputContributionArgOption.cType!)
				...
				TxInitRbf_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_TxInitRbfDecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_TxInitRbfDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TxInitRbf.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing TxInitRbf \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
