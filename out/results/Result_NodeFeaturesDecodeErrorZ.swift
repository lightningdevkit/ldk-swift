			...
			extension Bindings {
				...
				public class Result_NodeFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NodeFeaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_NodeFeaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: NodeFeatures) -> Result_NodeFeaturesDecodeErrorZ {
						...
						let returnValue = Result_NodeFeaturesDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_NodeFeaturesDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_NodeFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NodeFeaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> NodeFeatures? {
						if self.cType?.result_ok == true {
							return NodeFeatures(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_NodeFeaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NodeFeaturesDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NodeFeaturesDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
