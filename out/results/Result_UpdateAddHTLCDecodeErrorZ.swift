			...
			extension Bindings {
				...
				public class Result_UpdateAddHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateAddHTLCDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_UpdateAddHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UpdateAddHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UpdateAddHTLC) -> Result_UpdateAddHTLCDecodeErrorZ {
						...
						let returnValue = Result_UpdateAddHTLCDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UpdateAddHTLCDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UpdateAddHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UpdateAddHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UpdateAddHTLC? {
						if self.cType?.result_ok == true {
							return UpdateAddHTLC(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UpdateAddHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UpdateAddHTLCDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UpdateAddHTLCDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
