...
extension Bindings {
	...
	public class Result_CounterpartyForwardingInfoDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: CounterpartyForwardingInfo) -> Result_CounterpartyForwardingInfoDecodeErrorZ {
			...
			let returnValue = Result_CounterpartyForwardingInfoDecodeErrorZ(
				...
				instantiationContext: "Result_CounterpartyForwardingInfoDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_CounterpartyForwardingInfoDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_CounterpartyForwardingInfoDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_CounterpartyForwardingInfoDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_CounterpartyForwardingInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_CounterpartyForwardingInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
