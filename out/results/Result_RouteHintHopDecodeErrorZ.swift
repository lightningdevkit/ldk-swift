			...
			extension Bindings {
				...
				public class Result_RouteHintHopDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RouteHintHopDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_RouteHintHopDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_RouteHintHopDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RouteHintHop? {
						if self.cType?.result_ok == true {
							return RouteHintHop(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
