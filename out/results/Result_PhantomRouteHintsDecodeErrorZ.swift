			...
			extension Bindings {
				...
				public class Result_PhantomRouteHintsDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: PhantomRouteHints) -> Result_PhantomRouteHintsDecodeErrorZ {
						...
						let returnValue = Result_PhantomRouteHintsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_PhantomRouteHintsDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> PhantomRouteHints? {
						if self.cType?.result_ok == true {
							return PhantomRouteHints(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
