			...
			extension Bindings {
				...
				public class ProbabilisticScoringFeeParameters: NativeTypeWrapper {
					...
					internal init(cType: LDKProbabilisticScoringFeeParameters, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
					...
					internal init(cType: LDKProbabilisticScoringFeeParameters, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
					...
					public func getBasePenaltyMsat() -> UInt64 {
						...
						withUnsafePointer(to: self.cType!) { (thisPtrPointer: UnsafePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_get_base_penalty_msat(thisPtrPointer)
					...
					public func setBasePenaltyMsat(val: UInt64) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKProbabilisticScoringFeeParameters>) in
				...
				ProbabilisticScoringFeeParameters_get_historical_liquidity_penalty_multiplier_msat(thisPtrPointer)
					...
					public func setHistoricalLiquidityPenaltyMultiplierMsat(val: UInt64) {
						...
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_set_historical_liquidity_penalty_multiplier_msat(thisPtrPointer, val)
						}
					...
					public func getHistoricalLiquidityPenaltyAmountMultiplierMsat() -> UInt64 {
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisPtrPointer: UnsafePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_get_historical_liquidity_penalty_amount_multiplier_msat(thisPtrPointer)
						}
					...
					public func setHistoricalLiquidityPenaltyAmountMultiplierMsat(val: UInt64) {
						...
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_set_historical_liquidity_penalty_amount_multiplier_msat(thisPtrPointer, val)
						}
				...
				ProbabilisticScoringFeeParameters_set_considered_impossible_penalty_msat(thisPtrPointer, val)
					...
					/// 
					/// Default value: false
					public func getLinearSuccessProbability() -> Bool {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisPtrPointer: UnsafePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_get_linear_success_probability(thisPtrPointer)
						}
					...
					/// 
					/// Default value: false
					public func setLinearSuccessProbability(val: Bool) {
						// native call variable prep
						...
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_set_linear_success_probability(thisPtrPointer, val)
						}
					...
					internal func clone() -> ProbabilisticScoringFeeParameters {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKProbabilisticScoringFeeParameters>) in
				ProbabilisticScoringFeeParameters_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = ProbabilisticScoringFeeParameters(cType: nativeCallResult, instantiationContext: "ProbabilisticScoringFeeParameters.swift::\(#function):\(#line)")
					...
					public func addBanned(nodeId: NodeId) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisArgPointer: UnsafeMutablePointer<LDKProbabilisticScoringFeeParameters>) in
				...
				ProbabilisticScoringFeeParameters_add_banned(thisArgPointer, nodeIdPointer)
					...
					public func addBannedFromList(nodeIds: [NodeId]) {
						...
						let nodeIdsVector = Vec_NodeIdZ(array: nodeIds, instantiationContext: "ProbabilisticScoringFeeParameters.swift::\(#function):\(#line)").dangle()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing ProbabilisticScoringFeeParameters \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing ProbabilisticScoringFeeParameters \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
