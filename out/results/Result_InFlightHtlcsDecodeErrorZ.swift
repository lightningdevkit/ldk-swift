			...
			extension Bindings {
				...
				public class Result_InFlightHtlcsDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_InFlightHtlcsDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_InFlightHtlcsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_InFlightHtlcsDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: InFlightHtlcs) -> Result_InFlightHtlcsDecodeErrorZ {
						...
						let returnValue = Result_InFlightHtlcsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_InFlightHtlcsDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_InFlightHtlcsDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_InFlightHtlcsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> InFlightHtlcs? {
						if self.cType?.result_ok == true {
							return InFlightHtlcs(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_InFlightHtlcsDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_InFlightHtlcsDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_InFlightHtlcsDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
