			...
			extension Bindings {
				...
				public class Result_TxCreationKeysDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: TxCreationKeys) -> Result_TxCreationKeysDecodeErrorZ {
						...
						let returnValue = Result_TxCreationKeysDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_TxCreationKeysDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> TxCreationKeys? {
						if self.cType?.result_ok == true {
							return TxCreationKeys(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
