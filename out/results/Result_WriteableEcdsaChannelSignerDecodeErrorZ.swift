			...
			public typealias Result_WriteableEcdsaChannelSignerDecodeErrorZ = Bindings.Result_WriteableEcdsaChannelSignerDecodeErrorZ
			...
			extension Bindings {
				...
				public class Result_WriteableEcdsaChannelSignerDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_WriteableEcdsaChannelSignerDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_WriteableEcdsaChannelSignerDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: WriteableEcdsaChannelSigner) -> Result_WriteableEcdsaChannelSignerDecodeErrorZ {
						...
						let returnValue = Result_WriteableEcdsaChannelSignerDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_WriteableEcdsaChannelSignerDecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_WriteableEcdsaChannelSignerDecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_WriteableEcdsaChannelSignerDecodeErrorZ>) in
				CResult_WriteableEcdsaChannelSignerDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_WriteableEcdsaChannelSignerDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> WriteableEcdsaChannelSigner? {
						if self.cType?.result_ok == true {
							return NativelyImplementedWriteableEcdsaChannelSigner(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_WriteableEcdsaChannelSignerDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_WriteableEcdsaChannelSignerDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_WriteableEcdsaChannelSignerDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_WriteableEcdsaChannelSignerDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
