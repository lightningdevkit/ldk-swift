			...
			extension Bindings {
				...
				public class Result_ReplyChannelRangeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ReplyChannelRangeDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ReplyChannelRangeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ReplyChannelRangeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ReplyChannelRange) -> Result_ReplyChannelRangeDecodeErrorZ {
						...
						let returnValue = Result_ReplyChannelRangeDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ReplyChannelRangeDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ReplyChannelRangeDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ReplyChannelRangeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ReplyChannelRange? {
						if self.cType?.result_ok == true {
							return ReplyChannelRange(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ReplyChannelRangeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_ReplyChannelRangeDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ReplyChannelRangeDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ReplyChannelRangeDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
