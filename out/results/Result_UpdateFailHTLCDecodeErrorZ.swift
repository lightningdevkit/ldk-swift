			...
			extension Bindings {
				...
				public class Result_UpdateFailHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateFailHTLCDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_UpdateFailHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UpdateFailHTLCDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UpdateFailHTLC) -> Result_UpdateFailHTLCDecodeErrorZ {
						...
						let returnValue = Result_UpdateFailHTLCDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UpdateFailHTLCDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UpdateFailHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UpdateFailHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UpdateFailHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFailHTLC(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UpdateFailHTLCDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UpdateFailHTLCDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UpdateFailHTLCDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
