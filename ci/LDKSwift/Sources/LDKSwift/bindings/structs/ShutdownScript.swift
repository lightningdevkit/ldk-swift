...
ShutdownScript_write(objPointer)
    ...
    public class func new_witness_program(version: UInt8, program: [UInt8]) -> Result_ShutdownScriptInvalidShutdownScriptZ {
        ...
        return Result_ShutdownScriptInvalidShutdownScriptZ(pointer: ShutdownScript_new_witness_program(Bindings.new_LDKWitnessVersion(array: version), programWrapper.cOpaqueStruct!));
    }
