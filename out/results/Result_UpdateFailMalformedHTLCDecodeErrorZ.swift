			...
			extension Bindings {
				...
				public class Result_UpdateFailMalformedHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateFailMalformedHTLCDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_UpdateFailMalformedHTLCDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_UpdateFailMalformedHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UpdateFailMalformedHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFailMalformedHTLC(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
