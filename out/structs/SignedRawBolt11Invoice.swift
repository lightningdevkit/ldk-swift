			...
			extension Bindings {
				...
				public class SignedRawBolt11Invoice: NativeTypeWrapper {
					...
					internal init(cType: LDKSignedRawBolt11Invoice, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				SignedRawBolt11Invoice_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = SignedRawBolt11Invoice(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)")
				...
				SignedRawBolt11Invoice_hash(oPointer)
					...
					public func intoParts() -> (RawBolt11Invoice, [UInt8], Bolt11InvoiceSignature) {
						...
						// return value (do some wrapping)
						let returnValue = Tuple_RawBolt11Invoice_u832Bolt11InvoiceSignatureZ(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)").getValue()
				...
				SignedRawBolt11Invoice_raw_invoice(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = RawBolt11Invoice(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				SignedRawBolt11Invoice_signature(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Bolt11InvoiceSignature(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				SignedRawBolt11Invoice_recover_payee_pub_key(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Result_PayeePubKeySecp256k1ErrorZ(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				SignedRawBolt11Invoice_check_signature(thisArgPointer)
					...
					public class func fromStr(s: String) -> Result_SignedRawBolt11InvoiceBolt11ParseErrorZ {
						...
						let sPrimitiveWrapper = Str(value: s, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)").dangle()
						...
						// return value (do some wrapping)
						let returnValue = Result_SignedRawBolt11InvoiceBolt11ParseErrorZ(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)")
				...
				SignedRawBolt11Invoice_to_str(oPointer)
						...
						// return value (do some wrapping)
						let returnValue = Str(cType: nativeCallResult, instantiationContext: "SignedRawBolt11Invoice.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing SignedRawBolt11Invoice \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing SignedRawBolt11Invoice \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
