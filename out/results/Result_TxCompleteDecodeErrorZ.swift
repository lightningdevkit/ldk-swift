			...
			extension Bindings {
				...
				public class Result_TxCompleteDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_TxCompleteDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: TxComplete) -> Result_TxCompleteDecodeErrorZ {
						...
						let returnValue = Result_TxCompleteDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_TxCompleteDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_TxCompleteDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_TxCompleteDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> TxComplete? {
						if self.cType?.result_ok == true {
							return TxComplete(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_TxCompleteDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_TxCompleteDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_TxCompleteDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
