			...
			extension Bindings {
				...
				public class Result_PaymentPreimageAPIErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PaymentPreimageAPIErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_PaymentPreimageAPIErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: [UInt8]) -> Result_PaymentPreimageAPIErrorZ {
						...
						let oPrimitiveWrapper = ThirtyTwoBytes(value: o, instantiationContext: "Result_PaymentPreimageAPIErrorZ.swift::\(#function):\(#line)")
						...
						let returnValue = Result_PaymentPreimageAPIErrorZ(cType: nativeCallResult, instantiationContext: "Result_PaymentPreimageAPIErrorZ.swift::\(#function):\(#line)")
				...
				CResult_PaymentPreimageAPIErrorZ_clone(origPointer)
					...
					public func getError() -> APIError? {
						if self.cType?.result_ok == false {
							return APIError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_PaymentPreimageAPIErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> [UInt8]? {
						if self.cType?.result_ok == true {
							return ThirtyTwoBytes(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PaymentPreimageAPIErrorZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_PaymentPreimageAPIErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PaymentPreimageAPIErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PaymentPreimageAPIErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
