			...
			extension Bindings {
				...
				public class Result_QueryChannelRangeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_QueryChannelRangeDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_QueryChannelRangeDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_QueryChannelRangeDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> QueryChannelRange? {
						if self.cType?.result_ok == true {
							return QueryChannelRange(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
