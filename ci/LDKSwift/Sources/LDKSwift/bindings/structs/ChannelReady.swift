...
ChannelReady_clone(origPointer)
		...
		public class func eq(a: ChannelReady, b: ChannelReady) -> Bool {
			...
			return withUnsafePointer(to: a.cOpaqueStruct!) { (aPointer: UnsafePointer<LDKChannelReady>) in
withUnsafePointer(to: b.cOpaqueStruct!) { (bPointer: UnsafePointer<LDKChannelReady>) in
