...
DelayedPaymentOutputDescriptor_write(objPointer)
    ...
    public class func read(ser: [UInt8]) -> Result_DelayedPaymentOutputDescriptorDecodeErrorZ {
        ...
        return Result_DelayedPaymentOutputDescriptorDecodeErrorZ(pointer: DelayedPaymentOutputDescriptor_read(Bindings.new_LDKu8sliceWrapper(array: ser).cOpaqueStruct!));
    }
