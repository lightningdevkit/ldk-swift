			...
			extension Bindings {
				...
				public class Bolt11ParseError: NativeTypeWrapper {
					...
					internal init(cType: LDKBolt11ParseError, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				Bolt11ParseError_clone(origPointer)
						...
						// return value (do some wrapping)
						let returnValue = Bolt11ParseError(cType: nativeCallResult, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)")
					...
					public class func initWithInvalidSliceLength(a: String) -> Bolt11ParseError {
						...
						let aPrimitiveWrapper = Str(value: a, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)").dangle()
				...
				Bolt11ParseError_to_str(oPointer)
						...
						// return value (do some wrapping)
						let returnValue = Str(cType: nativeCallResult, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func getValueAsBech32Error() -> Bech32Error? {
						...
						return Bech32Error(cType: self.cType!.bech32_error, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public func getValueAsParseAmountError() -> Bindings.BindingsError? {
						...
						return BindingsError(cType: self.cType!.parse_amount_error, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public func getValueAsDescriptionDecodeError() -> Bindings.BindingsError? {
						...
						return BindingsError(cType: self.cType!.description_decode_error, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public func getValueAsInvalidSliceLength() -> String? {
						...
						return Str(cType: self.cType!.invalid_slice_length, instantiationContext: "Bolt11ParseError.swift::\(#function):\(#line)", anchor: self).getValue()
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Bolt11ParseError \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Bolt11ParseError \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
