...
extension Bindings {
	...
	public class Result_COption_HTLCDestinationZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_HTLCDestinationZDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: HTLCDestination?) -> Result_COption_HTLCDestinationZDecodeErrorZ {
			...
			let oOption = Option_HTLCDestinationZ(
				some: o,
				instantiationContext: "Result_COption_HTLCDestinationZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		internal func clone() -> Result_COption_HTLCDestinationZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_HTLCDestinationZDecodeErrorZ>) in
		...
		public func getValue() -> HTLCDestination? {
			if self.cType?.result_ok == true {
				return Option_HTLCDestinationZ(
		...
		internal func dangleRecursively() -> Result_COption_HTLCDestinationZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_HTLCDestinationZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_HTLCDestinationZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
