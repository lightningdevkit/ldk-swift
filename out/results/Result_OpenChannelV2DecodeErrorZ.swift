			...
			extension Bindings {
				...
				public class Result_OpenChannelV2DecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_OpenChannelV2DecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_OpenChannelV2DecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: OpenChannelV2) -> Result_OpenChannelV2DecodeErrorZ {
						...
						let returnValue = Result_OpenChannelV2DecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_OpenChannelV2DecodeErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_OpenChannelV2DecodeErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_OpenChannelV2DecodeErrorZ>) in
				CResult_OpenChannelV2DecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_OpenChannelV2DecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> OpenChannelV2? {
						if self.cType?.result_ok == true {
							return OpenChannelV2(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_OpenChannelV2DecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_OpenChannelV2DecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_OpenChannelV2DecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
