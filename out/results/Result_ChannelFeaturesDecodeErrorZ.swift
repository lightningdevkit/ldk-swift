			...
			extension Bindings {
				...
				public class Result_ChannelFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: ChannelFeatures) -> Result_ChannelFeaturesDecodeErrorZ {
						...
						let returnValue = Result_ChannelFeaturesDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_ChannelFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelFeatures? {
						if self.cType?.result_ok == true {
							return ChannelFeatures(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
