			...
			extension Bindings {
				...
				public class Result_InvoiceSignOrCreationErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_InvoiceSignOrCreationErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_InvoiceSignOrCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_InvoiceSignOrCreationErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Invoice) -> Result_InvoiceSignOrCreationErrorZ {
						...
						let returnValue = Result_InvoiceSignOrCreationErrorZ(cType: nativeCallResult, instantiationContext: "Result_InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)")
				...
				CResult_InvoiceSignOrCreationErrorZ_clone(origPointer)
					...
					public func getError() -> SignOrCreationError? {
						if self.cType?.result_ok == false {
							return SignOrCreationError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Invoice? {
						if self.cType?.result_ok == true {
							return Invoice(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_InvoiceSignOrCreationErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_InvoiceSignOrCreationErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_InvoiceSignOrCreationErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
