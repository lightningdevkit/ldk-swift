...
public typealias Result_ChannelTransactionParametersDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_ChannelTransactionParametersDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ChannelTransactionParametersDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: ChannelTransactionParameters) -> Result_ChannelTransactionParametersDecodeErrorZ
		{
			...
			// native method call
			let nativeCallResult = CResult_ChannelTransactionParametersDecodeErrorZ_ok(
			...
			let returnValue = Result_ChannelTransactionParametersDecodeErrorZ(
				cType: nativeCallResult,
				instantiationContext: "Result_ChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ChannelTransactionParametersDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ChannelTransactionParametersDecodeErrorZ>) in
			...
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext:
						"Result_ChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
			}
			return nil
		}
		...
		internal func dangleRecursively() -> Result_ChannelTransactionParametersDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ChannelTransactionParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ChannelTransactionParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
