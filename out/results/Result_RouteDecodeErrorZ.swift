			...
			extension Bindings {
				...
				public class Result_RouteDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RouteDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_RouteDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_RouteDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: Route) -> Result_RouteDecodeErrorZ {
						...
						let returnValue = Result_RouteDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_RouteDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_RouteDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_RouteDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> Route? {
						if self.cType?.result_ok == true {
							return Route(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_RouteDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_RouteDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_RouteDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
