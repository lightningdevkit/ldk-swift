			...
			extension Bindings {
				...
				public class OpenChannel: NativeTypeWrapper {
					...
					internal init(cType: LDKOpenChannel, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				OpenChannel_get_funding_pubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "OpenChannel.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				OpenChannel_get_shutdown_scriptpubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "OpenChannel.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setShutdownScriptpubkey(val: [UInt8]?) {
						...
						let valOption = Option_CVec_u8ZZ(some: val, instantiationContext: "OpenChannel.swift::\(#function):\(#line)").danglingClone()
				...
				// Type: LDKChannelTypeFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = ChannelTypeFeatures(cType: nativeCallResult, instantiationContext: "OpenChannel.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				OpenChannel_set_channel_type(thisPtrPointer, val.dynamicallyDangledClone().cType!)
					...
					public init(chainHashArg: [UInt8], temporaryChannelIdArg: [UInt8], fundingSatoshisArg: UInt64, pushMsatArg: UInt64, dustLimitSatoshisArg: UInt64, maxHtlcValueInFlightMsatArg: UInt64, channelReserveSatoshisArg: UInt64, htlcMinimumMsatArg: UInt64, feeratePerKwArg: UInt32, toSelfDelayArg: UInt16, maxAcceptedHtlcsArg: UInt16, fundingPubkeyArg: [UInt8], revocationBasepointArg: [UInt8], paymentPointArg: [UInt8], delayedPaymentBasepointArg: [UInt8], htlcBasepointArg: [UInt8], firstPerCommitmentPointArg: [UInt8], channelFlagsArg: UInt8, shutdownScriptpubkeyArg: [UInt8]?, channelTypeArg: ChannelTypeFeatures) {
						...
						let chainHashArgPrimitiveWrapper = ThirtyTwoBytes(value: chainHashArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let temporaryChannelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: temporaryChannelIdArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let fundingPubkeyArgPrimitiveWrapper = PublicKey(value: fundingPubkeyArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let revocationBasepointArgPrimitiveWrapper = PublicKey(value: revocationBasepointArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let paymentPointArgPrimitiveWrapper = PublicKey(value: paymentPointArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let delayedPaymentBasepointArgPrimitiveWrapper = PublicKey(value: delayedPaymentBasepointArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let htlcBasepointArgPrimitiveWrapper = PublicKey(value: htlcBasepointArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let firstPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: firstPerCommitmentPointArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				
						let shutdownScriptpubkeyArgOption = Option_CVec_u8ZZ(some: shutdownScriptpubkeyArg, instantiationContext: "OpenChannel.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = OpenChannel_new(chainHashArgPrimitiveWrapper.cType!, temporaryChannelIdArgPrimitiveWrapper.cType!, fundingSatoshisArg, pushMsatArg, dustLimitSatoshisArg, maxHtlcValueInFlightMsatArg, channelReserveSatoshisArg, htlcMinimumMsatArg, feeratePerKwArg, toSelfDelayArg, maxAcceptedHtlcsArg, fundingPubkeyArgPrimitiveWrapper.cType!, revocationBasepointArgPrimitiveWrapper.cType!, paymentPointArgPrimitiveWrapper.cType!, delayedPaymentBasepointArgPrimitiveWrapper.cType!, htlcBasepointArgPrimitiveWrapper.cType!, firstPerCommitmentPointArgPrimitiveWrapper.cType!, channelFlagsArg, shutdownScriptpubkeyArgOption.cType!, channelTypeArg.dynamicallyDangledClone().cType!)
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
				...
				OpenChannel_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "OpenChannel.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_OpenChannelDecodeErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_OpenChannelDecodeErrorZ(cType: nativeCallResult, instantiationContext: "OpenChannel.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing OpenChannel \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
