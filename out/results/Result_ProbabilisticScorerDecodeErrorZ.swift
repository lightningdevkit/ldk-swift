...
extension Bindings {
	...
	public class Result_ProbabilisticScorerDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ProbabilisticScorerDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: ProbabilisticScorer) -> Result_ProbabilisticScorerDecodeErrorZ {
			...
			let returnValue = Result_ProbabilisticScorerDecodeErrorZ(
				...
				instantiationContext: "Result_ProbabilisticScorerDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func dangleRecursively() -> Result_ProbabilisticScorerDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ProbabilisticScorerDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ProbabilisticScorerDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
