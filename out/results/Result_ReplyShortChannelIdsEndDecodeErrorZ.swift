			...
			extension Bindings {
				...
				public class Result_ReplyShortChannelIdsEndDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ReplyShortChannelIdsEnd) -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
						...
						let returnValue = Result_ReplyShortChannelIdsEndDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ReplyShortChannelIdsEndDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ReplyShortChannelIdsEndDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ReplyShortChannelIdsEndDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ReplyShortChannelIdsEnd? {
						if self.cType?.result_ok == true {
							return ReplyShortChannelIdsEnd(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ReplyShortChannelIdsEndDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ReplyShortChannelIdsEndDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ReplyShortChannelIdsEndDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
