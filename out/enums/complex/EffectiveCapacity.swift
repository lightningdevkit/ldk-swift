			...
			extension Bindings {
				...
				EffectiveCapacity_as_msat(thisArgPointer)
					...
					public func getValueAsAdvertisedMaxHtlc() -> AdvertisedMaxHTLC? {
						...
						return EffectiveCapacity_LDKAdvertisedMaxHTLC_Body(cType: self.cType!.advertised_max_htlc, instantiationContext: "EffectiveCapacity.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public func getValueAsHintMaxHtlc() -> HintMaxHTLC? {
						...
						return EffectiveCapacity_LDKHintMaxHTLC_Body(cType: self.cType!.hint_max_htlc, instantiationContext: "EffectiveCapacity.swift::\(#function):\(#line)", anchor: self)
					}
					...
					public class AdvertisedMaxHTLC: NativeTypeWrapper {
						...
						internal init(cType: LDKEffectiveCapacity_LDKAdvertisedMaxHTLC_Body, instantiationContext: String, anchor: NativeTypeWrapper) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
						...
						internal init(cType: LDKEffectiveCapacity_LDKAdvertisedMaxHTLC_Body, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
					...
					public class HintMaxHTLC: NativeTypeWrapper {
						...
						internal init(cType: LDKEffectiveCapacity_LDKHintMaxHTLC_Body, instantiationContext: String, anchor: NativeTypeWrapper) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
						...
						internal init(cType: LDKEffectiveCapacity_LDKHintMaxHTLC_Body, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
							Self.instanceCounter += 1
							self.instanceNumber = Self.instanceCounter
							self.cType = cType
