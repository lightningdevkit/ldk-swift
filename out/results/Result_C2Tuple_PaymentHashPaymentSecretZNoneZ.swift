...
extension Bindings {
	...
	public class Result_C2Tuple_PaymentHashPaymentSecretZNoneZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_C2Tuple_PaymentHashPaymentSecretZNoneZ, instantiationContext: String,
		...
		public class func initWithOk(o: ([UInt8], [UInt8])) -> Result_C2Tuple_PaymentHashPaymentSecretZNoneZ {
			...
			let oTuple = Tuple_PaymentHashPaymentSecretZ(
				tuple: o,
				instantiationContext: "Result_C2Tuple_PaymentHashPaymentSecretZNoneZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		internal func clone() -> Result_C2Tuple_PaymentHashPaymentSecretZNoneZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_C2Tuple_PaymentHashPaymentSecretZNoneZ>) in
		...
		internal func dangleRecursively() -> Result_C2Tuple_PaymentHashPaymentSecretZNoneZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_C2Tuple_PaymentHashPaymentSecretZNoneZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_C2Tuple_PaymentHashPaymentSecretZNoneZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
