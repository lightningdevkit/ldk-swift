			...
			extension Bindings {
				...
				ChannelMonitor_update_monitor(thisArgPointer, updatesPointer, broadcasterPointer, feeEstimatorPointer, loggerPointer)
						}
				...
				ChannelMonitor_get_funding_txo(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Tuple_OutPointCVec_u8ZZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				ChannelMonitor_get_outputs_to_watch(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_C2Tuple_ThirtyTwoBytesCVec_C2Tuple_u32CVec_u8ZZZZZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				ChannelMonitor_get_and_clear_pending_monitor_events(thisArgPointer)
					...
					public func processPendingEvents(handler: EventHandler) {
						...
						withUnsafePointer(to: handler.activate().cType!) { (handlerPointer: UnsafePointer<LDKEventHandler>) in
				...
				// Type: LDKCommitmentTransaction
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = CommitmentTransaction(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				ChannelMonitor_counterparty_commitment_txs_from_update(thisArgPointer, updatePointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_CommitmentTransactionZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func signToLocalJusticeTx(justiceTx: [UInt8], inputIdx: UInt, value: UInt64, commitmentNumber: UInt64) -> Result_TransactionNoneZ {
						// native call variable prep
						
						let justiceTxPrimitiveWrapper = Transaction(value: justiceTx, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)").dangle()
				...
				ChannelMonitor_sign_to_local_justice_tx(thisArgPointer, justiceTxPrimitiveWrapper.cType!, inputIdx, value, commitmentNumber)
						...
						// return value (do some wrapping)
						let returnValue = Result_TransactionNoneZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				ChannelMonitor_get_relevant_txids(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_C2Tuple_ThirtyTwoBytesCOption_ThirtyTwoBytesZZZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				ChannelMonitor_rebroadcast_pending_claims(thisArgPointer, broadcaster.activate().cType!, feeEstimator.activate().cType!, logger.activate().cType!)
					...
					public func getSpendableOutputs(tx: [UInt8], confirmationHeight: UInt32) -> [SpendableOutputDescriptor] {
						...
						let txPrimitiveWrapper = Transaction(value: tx, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)").dangle()
				...
				ChannelMonitor_get_spendable_outputs(thisArgPointer, txPrimitiveWrapper.cType!, confirmationHeight)
						...
						// return value (do some wrapping)
						let returnValue = Vec_SpendableOutputDescriptorZ(cType: nativeCallResult, instantiationContext: "ChannelMonitor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
