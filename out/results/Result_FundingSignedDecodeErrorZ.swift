			...
			extension Bindings {
				...
				public class Result_FundingSignedDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_FundingSignedDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_FundingSignedDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_FundingSignedDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> FundingSigned? {
						if self.cType?.result_ok == true {
							return FundingSigned(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
