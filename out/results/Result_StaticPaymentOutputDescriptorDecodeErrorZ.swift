...
extension Bindings {
	...
	public class Result_StaticPaymentOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_StaticPaymentOutputDescriptorDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: StaticPaymentOutputDescriptor)
			-> Result_StaticPaymentOutputDescriptorDecodeErrorZ
		{
			...
			// native method call
			let nativeCallResult = CResult_StaticPaymentOutputDescriptorDecodeErrorZ_ok(
			...
			let returnValue = Result_StaticPaymentOutputDescriptorDecodeErrorZ(
				...
				instantiationContext: "Result_StaticPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_StaticPaymentOutputDescriptorDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_StaticPaymentOutputDescriptorDecodeErrorZ>) in
			...
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext:
						"Result_StaticPaymentOutputDescriptorDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
			}
			return nil
		}
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_StaticPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_StaticPaymentOutputDescriptorDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
