			...
			extension Bindings {
				...
				Wallet_as_CoinSelectionSource(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = NativelyImplementedCoinSelectionSource(cType: nativeCallResult, instantiationContext: "Wallet.swift::\(#function):\(#line)", anchor: self)
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Wallet \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
