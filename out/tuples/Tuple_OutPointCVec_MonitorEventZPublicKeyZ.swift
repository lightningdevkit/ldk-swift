...
extension Bindings {
	...
	internal class Tuple_OutPointCVec_MonitorEventZPublicKeyZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKC3Tuple_OutPointCVec_MonitorEventZPublicKeyZ, instantiationContext: String,
		...
		internal func clone() -> Tuple_OutPointCVec_MonitorEventZPublicKeyZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKC3Tuple_OutPointCVec_MonitorEventZPublicKeyZ>) in
			...
			let returnValue = Tuple_OutPointCVec_MonitorEventZPublicKeyZ(
				cType: nativeCallResult,
				instantiationContext: "Tuple_OutPointCVec_MonitorEventZPublicKeyZ.swift::\(#function):\(#line)")
		...
		public init(a: OutPoint, b: [MonitorEvent], c: [UInt8], instantiationContext: String) {
			...
			let bVector = Vec_MonitorEventZ(
				array: b,
				instantiationContext: "Tuple_OutPointCVec_MonitorEventZPublicKeyZ.swift::\(#function):\(#line)"
			)
			.dangle()

			let cPrimitiveWrapper = PublicKey(
				value: c,
				instantiationContext: "Tuple_OutPointCVec_MonitorEventZPublicKeyZ.swift::\(#function):\(#line)")


			// native method call
			let nativeCallResult = C3Tuple_OutPointCVec_MonitorEventZPublicKeyZ_new(
				a.dynamicallyDangledClone().cType!, bVector.cType!, cPrimitiveWrapper.cType!)
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Tuple_OutPointCVec_MonitorEventZPublicKeyZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Tuple_OutPointCVec_MonitorEventZPublicKeyZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
