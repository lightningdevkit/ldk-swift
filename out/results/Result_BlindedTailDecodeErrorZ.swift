			...
			extension Bindings {
				...
				public class Result_BlindedTailDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_BlindedTailDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_BlindedTailDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: BlindedTail) -> Result_BlindedTailDecodeErrorZ {
						...
						let returnValue = Result_BlindedTailDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_BlindedTailDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_BlindedTailDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_BlindedTailDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> BlindedTail? {
						if self.cType?.result_ok == true {
							return BlindedTail(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_BlindedTailDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_BlindedTailDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_BlindedTailDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
