			...
			extension Bindings {
				...
				public class Result_InMemorySignerDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_InMemorySignerDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_InMemorySignerDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_InMemorySignerDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: InMemorySigner) -> Result_InMemorySignerDecodeErrorZ {
						...
						let returnValue = Result_InMemorySignerDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_InMemorySignerDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_InMemorySignerDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_InMemorySignerDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> InMemorySigner? {
						if self.cType?.result_ok == true {
							return InMemorySigner(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_InMemorySignerDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_InMemorySignerDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_InMemorySignerDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
