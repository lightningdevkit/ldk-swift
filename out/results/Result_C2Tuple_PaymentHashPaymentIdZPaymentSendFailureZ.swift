			...
			extension Bindings {
				...
				public class Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ([UInt8], [UInt8])) -> Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ {
						...
						let returnValue = Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ(cType: nativeCallResult, instantiationContext: "Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ.swift::\(#function):\(#line)")
				...
				CResult_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ_clone(origPointer)
					...
					public func getError() -> PaymentSendFailure? {
						if self.cType?.result_ok == false {
							return PaymentSendFailure(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ([UInt8], [UInt8])? {
						if self.cType?.result_ok == true {
							return Tuple_PaymentHashPaymentIdZ(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ.swift::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
