...
extension Bindings {
	...
	public class Result_NodeAnnouncementInfoDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_NodeAnnouncementInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: NodeAnnouncementInfo) -> Result_NodeAnnouncementInfoDecodeErrorZ {
			...
			let returnValue = Result_NodeAnnouncementInfoDecodeErrorZ(
				...
				instantiationContext: "Result_NodeAnnouncementInfoDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_NodeAnnouncementInfoDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_NodeAnnouncementInfoDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_NodeAnnouncementInfoDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_NodeAnnouncementInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_NodeAnnouncementInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
