			...
			extension Bindings {
				...
				internal class Option_C2Tuple_u64u64ZZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCOption_C2Tuple_u64u64ZZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Option_C2Tuple_u64u64ZZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Option_C2Tuple_u64u64ZZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
