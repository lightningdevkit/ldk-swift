			...
			extension Bindings {
				...
				ChannelReestablish_get_my_current_per_commitment_point(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setMyCurrentPerCommitmentPoint(val: [UInt8]) {
						...
						let valPrimitiveWrapper = PublicKey(value: val, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)")
				...
				ChannelReestablish_get_next_funding_txid(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setNextFundingTxid(val: [UInt8]?) {
						...
						let valOption = Option_ThirtyTwoBytesZ(some: val, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)").danglingClone()
				...
				ChannelReestablish_set_next_funding_txid(thisPtrPointer, valOption.cType!)
					...
					public init(channelIdArg: [UInt8], nextLocalCommitmentNumberArg: UInt64, nextRemoteCommitmentNumberArg: UInt64, yourLastPerCommitmentSecretArg: [UInt8], myCurrentPerCommitmentPointArg: [UInt8], nextFundingTxidArg: [UInt8]?) {
						// native call variable prep
						
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)")
				
						let yourLastPerCommitmentSecretArgPrimitiveWrapper = ThirtyTwoBytes(value: yourLastPerCommitmentSecretArg, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)")
				
						let myCurrentPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: myCurrentPerCommitmentPointArg, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)")
				
						let nextFundingTxidArgOption = Option_ThirtyTwoBytesZ(some: nextFundingTxidArg, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = ChannelReestablish_new(channelIdArgPrimitiveWrapper.cType!, nextLocalCommitmentNumberArg, nextRemoteCommitmentNumberArg, yourLastPerCommitmentSecretArgPrimitiveWrapper.cType!, myCurrentPerCommitmentPointArgPrimitiveWrapper.cType!, nextFundingTxidArgOption.cType!)
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "ChannelReestablish.swift::\(#function):\(#line)")
