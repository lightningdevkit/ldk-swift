...
StaticPaymentOutputDescriptor_write(objPointer)
    ...
    public class func read(ser: [UInt8]) -> Result_StaticPaymentOutputDescriptorDecodeErrorZ {
        ...
        return Result_StaticPaymentOutputDescriptorDecodeErrorZ(pointer: StaticPaymentOutputDescriptor_read(Bindings.new_LDKu8sliceWrapper(array: ser).cOpaqueStruct!));
    }
