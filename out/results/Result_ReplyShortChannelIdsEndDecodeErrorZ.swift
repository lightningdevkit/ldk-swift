...
extension Bindings {
	...
	public class Result_ReplyShortChannelIdsEndDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: ReplyShortChannelIdsEnd) -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
			...
			let returnValue = Result_ReplyShortChannelIdsEndDecodeErrorZ(
				...
				instantiationContext: "Result_ReplyShortChannelIdsEndDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ReplyShortChannelIdsEndDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_ReplyShortChannelIdsEndDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ReplyShortChannelIdsEndDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ReplyShortChannelIdsEndDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
