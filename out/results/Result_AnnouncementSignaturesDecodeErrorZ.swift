			...
			extension Bindings {
				...
				public class Result_AnnouncementSignaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_AnnouncementSignaturesDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_AnnouncementSignaturesDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_AnnouncementSignaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> AnnouncementSignatures? {
						if self.cType?.result_ok == true {
							return AnnouncementSignatures(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
