			...
			extension Bindings {
				...
				public class TxSignatures: NativeTypeWrapper {
					...
					internal init(cType: LDKTxSignatures, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				TxSignatures_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
				...
				TxSignatures_get_witnesses(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_WitnessZ(cType: nativeCallResult, instantiationContext: "TxSignatures.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setWitnesses(val: [[UInt8]]) {
						...
						let valVector = Vec_WitnessZ(array: val, instantiationContext: "TxSignatures.swift::\(#function):\(#line)").dangle()
				...
				TxSignatures_set_witnesses(thisPtrPointer, valVector.cType!)
					...
					public init(channelIdArg: [UInt8], txHashArg: [UInt8], witnessesArg: [[UInt8]]) {
						...
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
				
						let txHashArgPrimitiveWrapper = ThirtyTwoBytes(value: txHashArg, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
				
						let witnessesArgVector = Vec_WitnessZ(array: witnessesArg, instantiationContext: "TxSignatures.swift::\(#function):\(#line)").dangle()
				

						// native method call
						let nativeCallResult = TxSignatures_new(channelIdArgPrimitiveWrapper.cType!, txHashArgPrimitiveWrapper.cType!, witnessesArgVector.cType!)
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
				...
				TxSignatures_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TxSignatures.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_TxSignaturesDecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_TxSignaturesDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TxSignatures.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing TxSignatures \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing TxSignatures \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
