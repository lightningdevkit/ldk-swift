			...
			extension Bindings {
				...
				public class Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: [([UInt8], ChannelMonitor)]) -> Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ {
						...
						let returnValue = Result_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_CVec_C2Tuple_BlockHashChannelMonitorZZErrorZ_clone(origPointer)
					...
					public func getValue() -> [([UInt8], ChannelMonitor)]? {
						if self.cType?.result_ok == true {
							return Vec_C2Tuple_BlockHashChannelMonitorZZ(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
