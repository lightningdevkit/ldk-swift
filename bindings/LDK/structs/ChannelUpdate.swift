...
ChannelUpdate_write(objPointer)
    ...
    public class func read(ser: [UInt8]) throws -> ChannelUpdate {
        ...
        return try Result_ChannelUpdateDecodeErrorZ(pointer: ChannelUpdate_read(serWrapper.cOpaqueStruct!)).getValue();
    }
