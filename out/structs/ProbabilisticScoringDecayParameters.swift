			...
			extension Bindings {
				...
				public class ProbabilisticScoringDecayParameters: NativeTypeWrapper {
					...
					internal init(cType: LDKProbabilisticScoringDecayParameters, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
					...
					internal init(cType: LDKProbabilisticScoringDecayParameters, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
					...
					public func getHistoricalNoUpdatesHalfLife() -> UInt64 {
						...
						withUnsafePointer(to: self.cType!) { (thisPtrPointer: UnsafePointer<LDKProbabilisticScoringDecayParameters>) in
				ProbabilisticScoringDecayParameters_get_historical_no_updates_half_life(thisPtrPointer)
					...
					public func setHistoricalNoUpdatesHalfLife(val: UInt64) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKProbabilisticScoringDecayParameters>) in
				...
				ProbabilisticScoringDecayParameters_set_liquidity_offset_half_life(thisPtrPointer, val)
					...
					public init(historicalNoUpdatesHalfLifeArg: UInt64, liquidityOffsetHalfLifeArg: UInt64) {
						...
						// native method call
						let nativeCallResult = ProbabilisticScoringDecayParameters_new(historicalNoUpdatesHalfLifeArg, liquidityOffsetHalfLifeArg)
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "ProbabilisticScoringDecayParameters.swift::\(#function):\(#line)")
					...
					internal func clone() -> ProbabilisticScoringDecayParameters {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKProbabilisticScoringDecayParameters>) in
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing ProbabilisticScoringDecayParameters \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing ProbabilisticScoringDecayParameters \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
