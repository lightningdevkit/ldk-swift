...
public typealias Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ, instantiationContext: String,
			...
			-> Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ
		{
			...
			let oTuple = Tuple_BlockHashChannelMonitorZ(
				tuple: o,
				instantiationContext: "Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
		...
		internal func clone() -> Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ>) in
			...
			if self.cType?.result_ok == false {
				return DecodeError(
					...
					instantiationContext:
						"Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ.swift::\(#function):\(#line)", anchor: self
				)
			}
			return nil
		}
		...
		public func getValue() -> ([UInt8], ChannelMonitor)? {
			if self.cType?.result_ok == true {
				return Tuple_BlockHashChannelMonitorZ(
		...
		internal func dangleRecursively() -> Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_C2Tuple_BlockHashChannelMonitorZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
