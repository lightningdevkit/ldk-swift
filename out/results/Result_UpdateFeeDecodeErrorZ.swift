			...
			extension Bindings {
				...
				public class Result_UpdateFeeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateFeeDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_UpdateFeeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UpdateFeeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UpdateFee) -> Result_UpdateFeeDecodeErrorZ {
						...
						let returnValue = Result_UpdateFeeDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UpdateFeeDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UpdateFeeDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UpdateFeeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UpdateFee? {
						if self.cType?.result_ok == true {
							return UpdateFee(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UpdateFeeDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UpdateFeeDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UpdateFeeDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
