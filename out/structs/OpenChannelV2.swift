			...
			extension Bindings {
				...
				public class OpenChannelV2: NativeTypeWrapper {
					...
					internal init(cType: LDKOpenChannelV2, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				OpenChannelV2_get_chain_hash(thisPtrPointer)
					...
					public func setChainHash(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				...
				OpenChannelV2_get_funding_pubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setFundingPubkey(val: [UInt8]) {
						...
						let valPrimitiveWrapper = PublicKey(value: val, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				...
				OpenChannelV2_get_shutdown_scriptpubkey(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setShutdownScriptpubkey(val: [UInt8]?) {
						...
						let valOption = Option_CVec_u8ZZ(some: val, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)").danglingClone()
				...
				// Type: LDKChannelTypeFeatures
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = ChannelTypeFeatures(cType: nativeCallResult, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				OpenChannelV2_set_require_confirmed_inputs(thisPtrPointer, val.getCValue())
					...
					public init(chainHashArg: [UInt8], temporaryChannelIdArg: [UInt8], fundingFeerateSatPer1000WeightArg: UInt32, commitmentFeerateSatPer1000WeightArg: UInt32, fundingSatoshisArg: UInt64, dustLimitSatoshisArg: UInt64, maxHtlcValueInFlightMsatArg: UInt64, htlcMinimumMsatArg: UInt64, toSelfDelayArg: UInt16, maxAcceptedHtlcsArg: UInt16, locktimeArg: UInt32, fundingPubkeyArg: [UInt8], revocationBasepointArg: [UInt8], paymentBasepointArg: [UInt8], delayedPaymentBasepointArg: [UInt8], htlcBasepointArg: [UInt8], firstPerCommitmentPointArg: [UInt8], secondPerCommitmentPointArg: [UInt8], channelFlagsArg: UInt8, shutdownScriptpubkeyArg: [UInt8]?, channelTypeArg: ChannelTypeFeatures, requireConfirmedInputsArg: Option_NoneZ) {
						...
						let chainHashArgPrimitiveWrapper = ThirtyTwoBytes(value: chainHashArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let temporaryChannelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: temporaryChannelIdArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let fundingPubkeyArgPrimitiveWrapper = PublicKey(value: fundingPubkeyArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let revocationBasepointArgPrimitiveWrapper = PublicKey(value: revocationBasepointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let paymentBasepointArgPrimitiveWrapper = PublicKey(value: paymentBasepointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let delayedPaymentBasepointArgPrimitiveWrapper = PublicKey(value: delayedPaymentBasepointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let htlcBasepointArgPrimitiveWrapper = PublicKey(value: htlcBasepointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let firstPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: firstPerCommitmentPointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let secondPerCommitmentPointArgPrimitiveWrapper = PublicKey(value: secondPerCommitmentPointArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				
						let shutdownScriptpubkeyArgOption = Option_CVec_u8ZZ(some: shutdownScriptpubkeyArg, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)").danglingClone()
				

						// native method call
						let nativeCallResult = OpenChannelV2_new(chainHashArgPrimitiveWrapper.cType!, temporaryChannelIdArgPrimitiveWrapper.cType!, fundingFeerateSatPer1000WeightArg, commitmentFeerateSatPer1000WeightArg, fundingSatoshisArg, dustLimitSatoshisArg, maxHtlcValueInFlightMsatArg, htlcMinimumMsatArg, toSelfDelayArg, maxAcceptedHtlcsArg, locktimeArg, fundingPubkeyArgPrimitiveWrapper.cType!, revocationBasepointArgPrimitiveWrapper.cType!, paymentBasepointArgPrimitiveWrapper.cType!, delayedPaymentBasepointArgPrimitiveWrapper.cType!, htlcBasepointArgPrimitiveWrapper.cType!, firstPerCommitmentPointArgPrimitiveWrapper.cType!, secondPerCommitmentPointArgPrimitiveWrapper.cType!, channelFlagsArg, shutdownScriptpubkeyArgOption.cType!, channelTypeArg.dynamicallyDangledClone().cType!, requireConfirmedInputsArg.getCValue())
				...
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				super.init(conflictAvoidingVariableName: 0, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
				...
				OpenChannelV2_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_OpenChannelV2DecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_OpenChannelV2DecodeErrorZ(cType: nativeCallResult, instantiationContext: "OpenChannelV2.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing OpenChannelV2 \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing OpenChannelV2 \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
