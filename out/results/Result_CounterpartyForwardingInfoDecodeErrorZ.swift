			...
			extension Bindings {
				...
				public class Result_CounterpartyForwardingInfoDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_CounterpartyForwardingInfoDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: CounterpartyForwardingInfo) -> Result_CounterpartyForwardingInfoDecodeErrorZ {
						...
						let returnValue = Result_CounterpartyForwardingInfoDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_CounterpartyForwardingInfoDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_CounterpartyForwardingInfoDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_CounterpartyForwardingInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> CounterpartyForwardingInfo? {
						if self.cType?.result_ok == true {
							return CounterpartyForwardingInfo(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_CounterpartyForwardingInfoDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_CounterpartyForwardingInfoDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_CounterpartyForwardingInfoDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
