			...
			extension Bindings {
				...
				Offer_chains(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ChainHashZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Offer_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_DurationZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				Offer_write(objPointer)
					...
					internal func dangle(_ shouldDangle: Bool = true) -> Offer {
