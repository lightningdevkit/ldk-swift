...
extension Bindings {
	...
	public class Result_COption_ClosureReasonZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_ClosureReasonZDecodeErrorZ, instantiationContext: String,
		...
		public class func initWithOk(o: ClosureReason?) -> Result_COption_ClosureReasonZDecodeErrorZ {
			...
			let oOption = Option_ClosureReasonZ(
				some: o, instantiationContext: "Result_COption_ClosureReasonZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
			...
			let returnValue = Result_COption_ClosureReasonZDecodeErrorZ(
				...
				instantiationContext: "Result_COption_ClosureReasonZDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_COption_ClosureReasonZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_ClosureReasonZDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_COption_ClosureReasonZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_ClosureReasonZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_ClosureReasonZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
