			...
			extension Bindings {
				...
				public class TxAddInput: NativeTypeWrapper {
					...
					internal init(cType: LDKTxAddInput, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				TxAddInput_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ThirtyTwoBytes(value: val, instantiationContext: "TxAddInput.swift::\(#function):\(#line)")
				...
				TxAddInput_get_prevtx(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = TransactionU16LenLimited(cType: nativeCallResult, instantiationContext: "TxAddInput.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				TxAddInput_set_sequence(thisPtrPointer, val)
					...
					public init(channelIdArg: [UInt8], serialIdArg: UInt64, prevtxArg: TransactionU16LenLimited, prevtxOutArg: UInt32, sequenceArg: UInt32) {
						// native call variable prep
						
						let channelIdArgPrimitiveWrapper = ThirtyTwoBytes(value: channelIdArg, instantiationContext: "TxAddInput.swift::\(#function):\(#line)")
				

						// native method call
						let nativeCallResult = TxAddInput_new(channelIdArgPrimitiveWrapper.cType!, serialIdArg, prevtxArg.dynamicallyDangledClone().cType!, prevtxOutArg, sequenceArg)
				...
				TxAddInput_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "TxAddInput.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_TxAddInputDecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "TxAddInput.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_TxAddInputDecodeErrorZ(cType: nativeCallResult, instantiationContext: "TxAddInput.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing TxAddInput \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
