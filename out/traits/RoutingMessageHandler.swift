...
extension Bindings {
	...
	open class RoutingMessageHandler: NativeTraitWrapper {
		...
		internal init(
			cType: LDKRoutingMessageHandler, instantiationContext: String, anchor: NativeTypeWrapper,
			dangle: Bool = false
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
		...
		public init(messageSendEventsProvider: MessageSendEventsProvider) {
			...
			super
				.init(
					...
					instantiationContext: "RoutingMessageHandler.swift::\(#function):\(#line)")

			let thisArg = Bindings.instanceToPointer(instance: self)


			func handleNodeAnnouncementLambda(this_arg: UnsafeRawPointer?, msg: UnsafePointer<LDKNodeAnnouncement>)
				-> LDKCResult_boolLightningErrorZ
			{
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleNodeAnnouncementLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleNodeAnnouncement(
					msg: NodeAnnouncement(
						cType: msg.pointee,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"
					)
					.dangle().clone())
			...
			func handleChannelAnnouncementLambda(
				this_arg: UnsafeRawPointer?, msg: UnsafePointer<LDKChannelAnnouncement>
			) -> LDKCResult_boolLightningErrorZ {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleChannelAnnouncementLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleChannelAnnouncement(
			...
			func handleChannelUpdateLambda(this_arg: UnsafeRawPointer?, msg: UnsafePointer<LDKChannelUpdate>)
				-> LDKCResult_boolLightningErrorZ
			{
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleChannelUpdateLambda")
			...
			func getNextChannelAnnouncementLambda(this_arg: UnsafeRawPointer?, starting_point: UInt64)
				-> LDKCOption_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ
			{
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::getNextChannelAnnouncementLambda")
				...
				// return value (do some wrapping)
				let returnValue = Option_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ(
			...
			func getNextNodeAnnouncementLambda(this_arg: UnsafeRawPointer?, starting_point: LDKNodeId)
				-> LDKNodeAnnouncement
			{
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::getNextNodeAnnouncementLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.getNextNodeAnnouncement(
					startingPoint: NodeId(
						cType: starting_point,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"))
			...
			func peerConnectedLambda(
				...
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::peerConnectedLambda")
			...
			func handleReplyChannelRangeLambda(
				this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: LDKReplyChannelRange
			) -> LDKCResult_NoneLightningErrorZ {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleReplyChannelRangeLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleReplyChannelRange(
					theirNodeId: PublicKey(
						cType: their_node_id,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"
					)
					...
					msg: ReplyChannelRange(
						cType: msg, instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"))
			...
			func handleReplyShortChannelIdsEndLambda(
				this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: LDKReplyShortChannelIdsEnd
			) -> LDKCResult_NoneLightningErrorZ {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleReplyShortChannelIdsEndLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleReplyShortChannelIdsEnd(
					theirNodeId: PublicKey(
						cType: their_node_id,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"
					)
			...
			func handleQueryChannelRangeLambda(
				this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: LDKQueryChannelRange
			) -> LDKCResult_NoneLightningErrorZ {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleQueryChannelRangeLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleQueryChannelRange(
					theirNodeId: PublicKey(
						cType: their_node_id,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"
					)
			...
			func handleQueryShortChannelIdsLambda(
				this_arg: UnsafeRawPointer?, their_node_id: LDKPublicKey, msg: LDKQueryShortChannelIds
			) -> LDKCResult_NoneLightningErrorZ {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::handleQueryShortChannelIdsLambda")

				// Swift callback variable prep


				// Swift callback call
				let swiftCallbackResult = instance.handleQueryShortChannelIds(
					theirNodeId: PublicKey(
						cType: their_node_id,
						instantiationContext: "RoutingMessageHandler.swift::init()::\(#function):\(#line)"
					)
			...
			func processingQueueHighLambda(this_arg: UnsafeRawPointer?) -> Bool {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::processingQueueHighLambda")
			...
			func providedNodeFeaturesLambda(this_arg: UnsafeRawPointer?) -> LDKNodeFeatures {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::providedNodeFeaturesLambda")
			...
			{
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::providedInitFeaturesLambda")
			...
			func freeLambda(this_arg: UnsafeMutableRawPointer?) {
				let instance: RoutingMessageHandler = Bindings.pointerToInstance(
					pointer: this_arg!, sourceMarker: "RoutingMessageHandler::freeLambda")
		...
		open func handleNodeAnnouncement(msg: NodeAnnouncement) -> Result_boolLightningErrorZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::handleNodeAnnouncement MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func handleChannelAnnouncement(msg: ChannelAnnouncement) -> Result_boolLightningErrorZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::handleChannelAnnouncement MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func handleChannelUpdate(msg: ChannelUpdate) -> Result_boolLightningErrorZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::handleChannelUpdate MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func getNextChannelAnnouncement(startingPoint: UInt64) -> (
			ChannelAnnouncement, ChannelUpdate, ChannelUpdate
		)? {

			Bindings.print(
				"Error: RoutingMessageHandler::getNextChannelAnnouncement MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func getNextNodeAnnouncement(startingPoint: NodeId) -> NodeAnnouncement {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::getNextNodeAnnouncement MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func peerConnected(theirNodeId: [UInt8], initArgument: BindingsInit, inbound: Bool) -> Result_NoneNoneZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::peerConnected MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func handleReplyChannelRange(theirNodeId: [UInt8], msg: ReplyChannelRange) -> Result_NoneLightningErrorZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::handleReplyChannelRange MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		/// gossip messages.
		open func handleReplyShortChannelIdsEnd(theirNodeId: [UInt8], msg: ReplyShortChannelIdsEnd)
			-> Result_NoneLightningErrorZ
		{

			Bindings.print(
				"Error: RoutingMessageHandler::handleReplyShortChannelIdsEnd MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func handleQueryChannelRange(theirNodeId: [UInt8], msg: QueryChannelRange) -> Result_NoneLightningErrorZ {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::handleQueryChannelRange MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func handleQueryShortChannelIds(theirNodeId: [UInt8], msg: QueryShortChannelIds)
			-> Result_NoneLightningErrorZ
		{

			Bindings.print(
				"Error: RoutingMessageHandler::handleQueryShortChannelIds MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func processingQueueHigh() -> Bool {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::processingQueueHigh MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func providedNodeFeatures() -> NodeFeatures {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::providedNodeFeatures MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		open func providedInitFeatures(theirNodeId: [UInt8]) -> InitFeatures {
			...
			Bindings.print(
				"Error: RoutingMessageHandler::providedInitFeatures MUST be overridden! Offending class: \(String(describing: self)). Aborting.",
				severity: .ERROR)
			abort()
		}
		...
		public func getMessageSendEventsProvider() -> MessageSendEventsProvider {
			...
			let returnValue = NativelyImplementedMessageSendEventsProvider(
				...
				instantiationContext: "RoutingMessageHandler.swift::\(#function):\(#line)", anchor: self)
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing RoutingMessageHandler \(self.instanceNumber). (Origin: \(self.instantiationContext))")
				}
				self.free()
			} else if Self.enableDeinitLogging {
				Bindings.print(
					"Not freeing RoutingMessageHandler \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
	}
	...
	internal class NativelyImplementedRoutingMessageHandler: RoutingMessageHandler {
		...
		public override func handleNodeAnnouncement(msg: NodeAnnouncement) -> Result_boolLightningErrorZ {
			...
			// return value (do some wrapping)
			let returnValue = Result_boolLightningErrorZ(
				cType: nativeCallResult, instantiationContext: "RoutingMessageHandler.swift::\(#function):\(#line)")
		...
		/// starting at the `short_channel_id` indicated by `starting_point` and including announcements
		/// for a single channel.
		public override func getNextChannelAnnouncement(startingPoint: UInt64) -> (
			ChannelAnnouncement, ChannelUpdate, ChannelUpdate
		)? {
			// native call variable prep
		...
		public override func getNextNodeAnnouncement(startingPoint: NodeId) -> NodeAnnouncement {
			...
			let nativeCallResult = self.cType!
				.get_next_node_announcement(self.cType!.this_arg, startingPoint.dynamicallyDangledClone().cType!)
			...
			-> Result_NoneNoneZ
		{
			...
			let theirNodeIdPrimitiveWrapper = PublicKey(
				value: theirNodeId, instantiationContext: "RoutingMessageHandler.swift::\(#function):\(#line)")
		...
		/// for a given range of blocks. We can expect to receive one or more
		/// replies to a single query.
		public override func handleReplyChannelRange(theirNodeId: [UInt8], msg: ReplyChannelRange)
			-> Result_NoneLightningErrorZ
		{
			// native call variable prep
			...
			let nativeCallResult = self.cType!
				.handle_reply_channel_range(
					self.cType!.this_arg, theirNodeIdPrimitiveWrapper.cType!, msg.dynamicallyDangledClone().cType!)
		...
		/// a node has completed its best effort to send us the pertaining routing
		/// gossip messages.
		public override func handleReplyShortChannelIdsEnd(theirNodeId: [UInt8], msg: ReplyShortChannelIdsEnd)
			-> Result_NoneLightningErrorZ
		{
			// native call variable prep
		...
		/// Handles when a peer asks us to send a list of `short_channel_id`s
		/// for the requested range of blocks.
		public override func handleQueryChannelRange(theirNodeId: [UInt8], msg: QueryChannelRange)
			-> Result_NoneLightningErrorZ
		{
			// native call variable prep
		...
		/// Handles when a peer asks us to send routing gossip messages for a
		/// list of `short_channel_id`s.
		public override func handleQueryShortChannelIds(theirNodeId: [UInt8], msg: QueryShortChannelIds)
			-> Result_NoneLightningErrorZ
		{
			// native call variable prep
