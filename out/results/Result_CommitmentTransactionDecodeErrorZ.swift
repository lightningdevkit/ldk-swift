			...
			extension Bindings {
				...
				public class Result_CommitmentTransactionDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_CommitmentTransactionDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_CommitmentTransactionDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: CommitmentTransaction) -> Result_CommitmentTransactionDecodeErrorZ {
						...
						let returnValue = Result_CommitmentTransactionDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_CommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_CommitmentTransactionDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_CommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> CommitmentTransaction? {
						if self.cType?.result_ok == true {
							return CommitmentTransaction(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_CommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_CommitmentTransactionDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_CommitmentTransactionDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
