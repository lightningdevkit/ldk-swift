...
KeysManager_spend_spendable_outputs(this_argPointer, Bindings.new_LDKCVec_SpendableOutputDescriptorZ(array: descriptors).cOpaqueStruct!, Bindings.new_LDKCVec_TxOutZ(array: outputs).cOpaqueStruct!, Bindings.new_LDKCVec_u8Z(array: change_destination_script), feerate_sat_per_1000_weight)
});
    }
