			...
			extension Bindings {
				...
				public class Result_RouteParametersDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_RouteParametersDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_RouteParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_RouteParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: RouteParameters) -> Result_RouteParametersDecodeErrorZ {
						...
						let returnValue = Result_RouteParametersDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_RouteParametersDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_RouteParametersDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_RouteParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> RouteParameters? {
						if self.cType?.result_ok == true {
							return RouteParameters(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_RouteParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_RouteParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_RouteParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
