			...
			extension Bindings {
				...
				public class Result_BuiltCommitmentTransactionDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_BuiltCommitmentTransactionDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_BuiltCommitmentTransactionDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_BuiltCommitmentTransactionDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: BuiltCommitmentTransaction) -> Result_BuiltCommitmentTransactionDecodeErrorZ {
						...
						let returnValue = Result_BuiltCommitmentTransactionDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_BuiltCommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_BuiltCommitmentTransactionDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_BuiltCommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> BuiltCommitmentTransaction? {
						if self.cType?.result_ok == true {
							return BuiltCommitmentTransaction(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_BuiltCommitmentTransactionDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_BuiltCommitmentTransactionDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_BuiltCommitmentTransactionDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
