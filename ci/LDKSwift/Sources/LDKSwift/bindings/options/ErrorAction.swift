...
ErrorAction_clone(origPointer)
		...
		public class func disconnect_peer(msg: Bindings.ErrorMessage) -> ErrorAction {
		...
		public class func send_error_message(msg: Bindings.ErrorMessage) -> ErrorAction {
			
			return ErrorAction(pointer: ErrorAction_send_error_message(msg.danglingClone().cOpaqueStruct!));
		}

		public class func send_warning_message(msg: Bindings.WarningMessage, log_level: LDKLevel) -> ErrorAction {
