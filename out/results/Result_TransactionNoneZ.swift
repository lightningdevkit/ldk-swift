			...
			extension Bindings {
				...
				public class Result_TransactionNoneZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: [UInt8]) -> Result_TransactionNoneZ {
						...
						let returnValue = Result_TransactionNoneZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
					...
					*/
					...
					public func getValue() -> [UInt8]? {
						if self.cType?.result_ok == true {
							return Transaction(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self).getValue()
						}
						return nil
					}
