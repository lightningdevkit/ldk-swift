...
extension Bindings {
	...
	public class CounterpartyChannelTransactionParameters: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCounterpartyChannelTransactionParameters, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public func getPubkeys() -> ChannelPublicKeys {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(thisPtrPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in
			...
			let returnValue = ChannelPublicKeys(
				...
				instantiationContext: "CounterpartyChannelTransactionParameters.swift::\(#function):\(#line)",
				anchor: self
			)
			.dangle(false)
		...
		public func setPubkeys(val: ChannelPublicKeys) {
			...
			let nativeCallResult =
				withUnsafeMutablePointer(to: &self.cType!) {
					(thisPtrPointer: UnsafeMutablePointer<LDKCounterpartyChannelTransactionParameters>) in
		...
		public init(pubkeysArg: ChannelPublicKeys, selectedContestDelayArg: UInt16) {
			...
			// native method call
			let nativeCallResult = CounterpartyChannelTransactionParameters_new(
				pubkeysArg.dynamicallyDangledClone().cType!, selectedContestDelayArg)
		...
		internal func clone() -> CounterpartyChannelTransactionParameters {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in
			...
			// return value (do some wrapping)
			let returnValue = CounterpartyChannelTransactionParameters(
				cType: nativeCallResult,
				instantiationContext: "CounterpartyChannelTransactionParameters.swift::\(#function):\(#line)")
		...
		public func hash() -> UInt64 {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(oPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in
		...
		public class func eq(a: CounterpartyChannelTransactionParameters, b: CounterpartyChannelTransactionParameters)
			-> Bool
		{
			// native call variable prep
			...
			// native method call
			let nativeCallResult =
				withUnsafePointer(to: a.cType!) {
					(aPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in

					withUnsafePointer(to: b.cType!) {
						(bPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in
		...
		public func write() -> [UInt8] {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(objPointer: UnsafePointer<LDKCounterpartyChannelTransactionParameters>) in
		...
		public class func read(ser: [UInt8]) -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
			...
			// return value (do some wrapping)
			let returnValue = Result_CounterpartyChannelTransactionParametersDecodeErrorZ(
				cType: nativeCallResult,
				instantiationContext: "CounterpartyChannelTransactionParameters.swift::\(#function):\(#line)")
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing CounterpartyChannelTransactionParameters \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing CounterpartyChannelTransactionParameters \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
