...
extension Bindings {
	...
	public class Result_ReplyChannelRangeDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ReplyChannelRangeDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: ReplyChannelRange) -> Result_ReplyChannelRangeDecodeErrorZ {
			...
			let returnValue = Result_ReplyChannelRangeDecodeErrorZ(
				...
				instantiationContext: "Result_ReplyChannelRangeDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ReplyChannelRangeDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ReplyChannelRangeDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_ReplyChannelRangeDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ReplyChannelRangeDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ReplyChannelRangeDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
