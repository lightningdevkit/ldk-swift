			...
			extension Bindings {
				...
				public class HTLCDescriptor: NativeTypeWrapper {
					...
					internal init(cType: LDKHTLCDescriptor, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						self.initialCFreeability = self.cType!.is_owned
				...
				HTLCDescriptor_get_channel_derivation_parameters(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ChannelDerivationParameters(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false)
					...
					public func setChannelDerivationParameters(val: ChannelDerivationParameters) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKHTLCDescriptor>) in
				HTLCDescriptor_set_channel_derivation_parameters(thisPtrPointer, val.dynamicallyDangledClone().cType!)
						}
				...
				HTLCDescriptor_get_per_commitment_point(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setPerCommitmentPoint(val: [UInt8]) {
						...
						let valPrimitiveWrapper = PublicKey(value: val, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
				...
				HTLCDescriptor_get_htlc(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = HTLCOutputInCommitment(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				HTLCDescriptor_get_preimage(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).getValue()
					...
					public func setPreimage(val: [UInt8]?) {
						...
						let valOption = Option_ThirtyTwoBytesZ(some: val, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)").danglingClone()
				...
				HTLCDescriptor_get_counterparty_sig(thisPtrPointer)
						...
						// return value (do some wrapping)
						let returnValue = ECDSASignature(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func setCounterpartySig(val: [UInt8]) {
						...
						let valPrimitiveWrapper = ECDSASignature(value: val, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
				...
				HTLCDescriptor_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func read(ser: [UInt8]) -> Result_HTLCDescriptorDecodeErrorZ {
						...
						let serPrimitiveWrapper = u8slice(value: ser, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
						...
						// return value (do some wrapping)
						let returnValue = Result_HTLCDescriptorDecodeErrorZ(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
				...
				HTLCDescriptor_outpoint(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = OutPoint(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				HTLCDescriptor_previous_utxo(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = TxOut(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self)
				...
				HTLCDescriptor_unsigned_tx_input(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = TxIn(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self)
				...
				HTLCDescriptor_witness_script(thisArgPointer)
					...
					public func txInputWitness(signature: [UInt8], witnessScript: [UInt8]) -> [UInt8] {
						...
						let signaturePrimitiveWrapper = ECDSASignature(value: signature, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
				
						let witnessScriptPrimitiveWrapper = u8slice(value: witnessScript, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)")
				

						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.cType!) { (thisArgPointer: UnsafePointer<LDKHTLCDescriptor>) in
				HTLCDescriptor_tx_input_witness(thisArgPointer, signaturePrimitiveWrapper.cType!, witnessScriptPrimitiveWrapper.cType!)
						}
						...
						// return value (do some wrapping)
						let returnValue = Witness(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				HTLCDescriptor_derive_channel_signer(thisArgPointer, signerProviderPointer)
						...
						// return value (do some wrapping)
						let returnValue = NativelyImplementedWriteableEcdsaChannelSigner(cType: nativeCallResult, instantiationContext: "HTLCDescriptor.swift::\(#function):\(#line)", anchor: self)
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing HTLCDescriptor \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing HTLCDescriptor \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
