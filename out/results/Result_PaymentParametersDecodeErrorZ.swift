			...
			extension Bindings {
				...
				public class Result_PaymentParametersDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_PaymentParametersDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: PaymentParameters) -> Result_PaymentParametersDecodeErrorZ {
						...
						let returnValue = Result_PaymentParametersDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_PaymentParametersDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_PaymentParametersDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_PaymentParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> PaymentParameters? {
						if self.cType?.result_ok == true {
							return PaymentParameters(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_PaymentParametersDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_PaymentParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_PaymentParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
