...
extension Bindings {
	...
	public class Result_ShutdownScriptInvalidShutdownScriptZ: NativeTypeWrapper {
		...
		internal var cOpaqueStruct: LDKCResult_ShutdownScriptInvalidShutdownScriptZ?
		...
		/* RESULT_METHODS_START */
			...
			public func getError() -> InvalidShutdownScript? {
				if self.cOpaqueStruct?.result_ok == false {
					return InvalidShutdownScript(pointer: self.cOpaqueStruct!.contents.err.pointee, anchor: self).dangle()
				}
				return nil
			}
			...
			public func getValue() -> ShutdownScript? {
				if self.cOpaqueStruct?.result_ok == true {
					return ShutdownScript(pointer: self.cOpaqueStruct!.contents.result.pointee, anchor: self).dangle()
				}
				return nil
			}
