			...
			extension Bindings {
				...
				public class Result_COption_ClosureReasonZDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_COption_ClosureReasonZDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_COption_ClosureReasonZDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_COption_ClosureReasonZDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ClosureReason? {
						if self.cType?.result_ok == true {
							return Option_ClosureReasonZ(cType: self.cType!.contents.result.pointee, anchor: self).getValue()
						}
						return nil
					}
