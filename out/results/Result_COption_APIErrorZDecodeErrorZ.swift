...
extension Bindings {
	...
	public class Result_COption_APIErrorZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_COption_APIErrorZDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		public class func initWithOk(o: APIError?) -> Result_COption_APIErrorZDecodeErrorZ {
			...
			let oOption = Option_APIErrorZ(
				some: o, instantiationContext: "Result_COption_APIErrorZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.danglingClone()
			...
			let returnValue = Result_COption_APIErrorZDecodeErrorZ(
				...
				instantiationContext: "Result_COption_APIErrorZDecodeErrorZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_COption_APIErrorZDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_COption_APIErrorZDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_COption_APIErrorZDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_COption_APIErrorZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_COption_APIErrorZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
