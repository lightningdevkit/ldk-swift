			...
			extension Bindings {
				...
				Offer_chains(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_ThirtyTwoBytesZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Offer_metadata(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_CVec_u8ZZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				// Type: LDKAmount
					...
					if pointerValue == 0 {
						...
						// return value (do some wrapping)
						let returnValue = Amount(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Offer_description(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PrintableString(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Offer_offer_features(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = OfferFeatures(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Offer_absolute_expiry(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Option_u64Z(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).getValue()
				...
				Offer_paths(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_BlindedPathZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
				...
				Offer_supported_quantity(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = Quantity(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false)
				...
				Offer_signing_pubkey(thisArgPointer)
						...
						// return value (do some wrapping)
						let returnValue = PublicKey(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public func supportsChain(chain: [UInt8]) -> Bool {
						...
						let chainPrimitiveWrapper = ThirtyTwoBytes(value: chain, instantiationContext: "Offer.swift::\(#function):\(#line)")
				...
				Offer_write(objPointer)
						...
						// return value (do some wrapping)
						let returnValue = Vec_u8Z(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)", anchor: self).dangle(false).getValue()
					...
					public class func fromStr(s: String) -> Result_OfferBolt12ParseErrorZ {
						...
						// return value (do some wrapping)
						let returnValue = Result_OfferBolt12ParseErrorZ(cType: nativeCallResult, instantiationContext: "Offer.swift::\(#function):\(#line)")
					...
					deinit {
						...
						if !self.dangling {
							...
							Bindings.print("Not freeing Offer \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
