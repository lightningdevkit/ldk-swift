			...
			extension Bindings {
				...
				public class Result_ClosingSignedFeeRangeDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ClosingSignedFeeRangeDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ClosingSignedFeeRangeDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ClosingSignedFeeRangeDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ClosingSignedFeeRange? {
						if self.cType?.result_ok == true {
							return ClosingSignedFeeRange(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
