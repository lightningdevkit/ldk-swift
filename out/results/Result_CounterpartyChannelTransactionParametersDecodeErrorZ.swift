...
public typealias Result_CounterpartyChannelTransactionParametersDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_CounterpartyChannelTransactionParametersDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_CounterpartyChannelTransactionParametersDecodeErrorZ, instantiationContext: String
		) {
		...
		public class func initWithOk(o: CounterpartyChannelTransactionParameters)
			-> Result_CounterpartyChannelTransactionParametersDecodeErrorZ
		{
			...
			// native method call
			let nativeCallResult = CResult_CounterpartyChannelTransactionParametersDecodeErrorZ_ok(
			...
			let returnValue = Result_CounterpartyChannelTransactionParametersDecodeErrorZ(
				...
				instantiationContext:
					"Result_CounterpartyChannelTransactionParametersDecodeErrorZ.swift::\(#function):\(#line)")
		...
		public class func initWithErr(e: DecodeError) -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
			...
			// native method call
			let nativeCallResult = CResult_CounterpartyChannelTransactionParametersDecodeErrorZ_err(
		...
		internal func clone() -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_CounterpartyChannelTransactionParametersDecodeErrorZ>) in
		...
		internal func dangleRecursively() -> Result_CounterpartyChannelTransactionParametersDecodeErrorZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_CounterpartyChannelTransactionParametersDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_CounterpartyChannelTransactionParametersDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
