			...
			extension Bindings {
				...
				public class Result_ChannelConfigDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelConfigDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_ChannelConfigDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_ChannelConfigDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelConfig? {
						if self.cType?.result_ok == true {
							return ChannelConfig(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
