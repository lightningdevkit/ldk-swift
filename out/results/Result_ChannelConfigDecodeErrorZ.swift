			...
			extension Bindings {
				...
				public class Result_ChannelConfigDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_ChannelConfigDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_ChannelConfigDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_ChannelConfigDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: ChannelConfig) -> Result_ChannelConfigDecodeErrorZ {
						...
						let returnValue = Result_ChannelConfigDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_ChannelConfigDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_ChannelConfigDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_ChannelConfigDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> ChannelConfig? {
						if self.cType?.result_ok == true {
							return ChannelConfig(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_ChannelConfigDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_ChannelConfigDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_ChannelConfigDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_ChannelConfigDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
