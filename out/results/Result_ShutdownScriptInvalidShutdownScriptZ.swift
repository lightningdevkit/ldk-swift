...
extension Bindings {
	...
	public class Result_ShutdownScriptInvalidShutdownScriptZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_ShutdownScriptInvalidShutdownScriptZ, instantiationContext: String,
		...
		public class func initWithOk(o: ShutdownScript) -> Result_ShutdownScriptInvalidShutdownScriptZ {
			...
			let returnValue = Result_ShutdownScriptInvalidShutdownScriptZ(
				cType: nativeCallResult,
				instantiationContext: "Result_ShutdownScriptInvalidShutdownScriptZ.swift::\(#function):\(#line)")
		...
		internal func clone() -> Result_ShutdownScriptInvalidShutdownScriptZ {
			...
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) {
					(origPointer: UnsafePointer<LDKCResult_ShutdownScriptInvalidShutdownScriptZ>) in
		...
		internal func dangleRecursively() -> Result_ShutdownScriptInvalidShutdownScriptZ {
			self.dangling = true
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_ShutdownScriptInvalidShutdownScriptZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_ShutdownScriptInvalidShutdownScriptZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
