			...
			extension Bindings {
				...
				public class Result_UnsignedChannelUpdateDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UnsignedChannelUpdateDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_UnsignedChannelUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_UnsignedChannelUpdateDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: UnsignedChannelUpdate) -> Result_UnsignedChannelUpdateDecodeErrorZ {
						...
						let returnValue = Result_UnsignedChannelUpdateDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_UnsignedChannelUpdateDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_UnsignedChannelUpdateDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_UnsignedChannelUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> UnsignedChannelUpdate? {
						if self.cType?.result_ok == true {
							return UnsignedChannelUpdate(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_UnsignedChannelUpdateDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_UnsignedChannelUpdateDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_UnsignedChannelUpdateDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
