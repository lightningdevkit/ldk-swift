			...
			extension Bindings {
				...
				public class Result_AnnouncementSignaturesDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_AnnouncementSignaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_AnnouncementSignaturesDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: AnnouncementSignatures) -> Result_AnnouncementSignaturesDecodeErrorZ {
						...
						let returnValue = Result_AnnouncementSignaturesDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_AnnouncementSignaturesDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_AnnouncementSignaturesDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_AnnouncementSignaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> AnnouncementSignatures? {
						if self.cType?.result_ok == true {
							return AnnouncementSignatures(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_AnnouncementSignaturesDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_AnnouncementSignaturesDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_AnnouncementSignaturesDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_AnnouncementSignaturesDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
