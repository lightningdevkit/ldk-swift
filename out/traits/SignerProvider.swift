				...
				open class SignerProvider: NativeTraitWrapper {
					...
					public init() {
						...
						func generateChannelKeysIdLambda(this_arg: UnsafeRawPointer?, inbound: Bool, channel_value_satoshis: UInt64, user_channel_id: LDKU128) -> LDKThirtyTwoBytes {
							...
							let returnValue = ThirtyTwoBytes(value: swiftCallbackResult, instantiationContext: "SignerProvider.swift::init()::\(#function):\(#line)").dangleRecursively().cType!
			...
			public override func getDestinationScript() -> Result_CVec_u8ZNoneZ {
				...
				// return value (do some wrapping)
				let returnValue = Result_CVec_u8ZNoneZ(cType: nativeCallResult, instantiationContext: "SignerProvider.swift::\(#function):\(#line)")
			...
			public override func getShutdownScriptpubkey() -> Result_ShutdownScriptNoneZ {
				...
				// return value (do some wrapping)
				let returnValue = Result_ShutdownScriptNoneZ(cType: nativeCallResult, instantiationContext: "SignerProvider.swift::\(#function):\(#line)")
