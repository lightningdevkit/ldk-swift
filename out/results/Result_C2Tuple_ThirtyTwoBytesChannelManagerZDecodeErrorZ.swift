...
public typealias Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ = Bindings
...
extension Bindings {
	...
	public class Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ: NativeTypeWrapper {
		...
		internal init(
			cType: LDKCResult_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ, instantiationContext: String,
			...
			-> Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ
		{
			...
			let oTuple = Tuple_ThirtyTwoBytesChannelManagerZ(
				tuple: o,
				instantiationContext:
					"Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ.swift::\(#function):\(#line)"
			)
			.dangle()
		...
		public class func initWithErr(e: DecodeError) -> Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ {
			...
			// native method call
			let nativeCallResult = CResult_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ_err(
		...
		public func getValue() -> ([UInt8], ChannelManager)? {
			if self.cType?.result_ok == true {
				return Tuple_ThirtyTwoBytesChannelManagerZ(
		...
		deinit {
			...
			if !self.dangling {
				if Self.enableDeinitLogging {
					Bindings.print(
						"Freeing Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))"
					)
				}
				...
				Bindings.print(
					"Not freeing Result_C2Tuple_ThirtyTwoBytesChannelManagerZDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
