			...
			extension Bindings {
				...
				public class Result_UpdateFulfillHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ) {
					...
					internal init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
				...
				CResult_UpdateFulfillHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UpdateFulfillHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFulfillHTLC(cType: self.cType!.contents.result.pointee, anchor: self)
						}
						return nil
					}
