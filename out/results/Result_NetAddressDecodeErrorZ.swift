			...
			extension Bindings {
				...
				public class Result_NetAddressDecodeErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_NetAddressDecodeErrorZ, instantiationContext: String) {
					...
					internal init(cType: LDKCResult_NetAddressDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_NetAddressDecodeErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: NetAddress) -> Result_NetAddressDecodeErrorZ {
						...
						let returnValue = Result_NetAddressDecodeErrorZ(cType: nativeCallResult, instantiationContext: "Result_NetAddressDecodeErrorZ.swift::\(#function):\(#line)")
				...
				CResult_NetAddressDecodeErrorZ_clone(origPointer)
					...
					public func getError() -> DecodeError? {
						if self.cType?.result_ok == false {
							return DecodeError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_NetAddressDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					public func getValue() -> NetAddress? {
						if self.cType?.result_ok == true {
							return NetAddress(cType: self.cType!.contents.result.pointee, instantiationContext: "Result_NetAddressDecodeErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					

					internal func dangle(_ shouldDangle: Bool = true) -> Result_NetAddressDecodeErrorZ {
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_NetAddressDecodeErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_NetAddressDecodeErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
