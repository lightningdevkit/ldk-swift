			...
			extension Bindings {
				...
				public class Result_QueryShortChannelIdsDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: QueryShortChannelIds) -> Result_QueryShortChannelIdsDecodeErrorZ {
						...
						let returnValue = Result_QueryShortChannelIdsDecodeErrorZ(cType: nativeCallResult, instantiationContext: "#{swift_class_name}::\(#function):\(#line)")
				...
				CResult_QueryShortChannelIdsDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> QueryShortChannelIds? {
						if self.cType?.result_ok == true {
							return QueryShortChannelIds(cType: self.cType!.contents.result.pointee, instantiationContext: "#{swift_class_name}::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
