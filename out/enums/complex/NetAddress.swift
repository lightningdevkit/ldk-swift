...
extension Bindings {
	...
	public class NetAddress: NativeTypeWrapper {
		...
		internal init(
			cType: LDKNetAddress, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false
		) {
			Self.instanceCounter += 1
			self.instanceNumber = Self.instanceCounter
			self.cType = cType
		...
		internal func clone() -> NetAddress {
			...
			// return value (do some wrapping)
			let returnValue = NetAddress(
				cType: nativeCallResult, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
		...
		public class func initWithIpv4(addr: [UInt8], port: UInt16) -> NetAddress {
			...
			let addrPrimitiveWrapper = FourBytes(
				value: addr, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
		...
		public class func initWithOnionV2(a: [UInt8]) -> NetAddress {
			...
			let aPrimitiveWrapper = TwelveBytes(
				value: a, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
			...
			-> NetAddress
		{
			...
			let ed25519PubkeyPrimitiveWrapper = ThirtyTwoBytes(
				value: ed25519Pubkey, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
		...
		public func write() -> [UInt8] {
			...
			let returnValue = Vec_u8Z(
				cType: nativeCallResult, instantiationContext: "NetAddress.swift::\(#function):\(#line)", anchor: self
			)
		...
		public class func read(ser: [UInt8]) -> Result_NetAddressDecodeErrorZ {
			...
			let serPrimitiveWrapper = u8slice(
				value: ser, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
			...
			// return value (do some wrapping)
			let returnValue = Result_NetAddressDecodeErrorZ(
				cType: nativeCallResult, instantiationContext: "NetAddress.swift::\(#function):\(#line)")
		...
		public func getValueAsIPv4() -> IPv4? {
			...
			return NetAddress_LDKIPv4_Body(
				cType: self.cType!.i_pv4, instantiationContext: "NetAddress.swift::\(#function):\(#line)", anchor: self)
		}
		...
		public func getValueAsIPv6() -> IPv6? {
			...
			return NetAddress_LDKIPv6_Body(
				cType: self.cType!.i_pv6, instantiationContext: "NetAddress.swift::\(#function):\(#line)", anchor: self)
		}
		...
		public func getValueAsOnionV2() -> [UInt8]? {
			...
			return TwelveBytes(
				cType: self.cType!.onion_v2, instantiationContext: "NetAddress.swift::\(#function):\(#line)",
				anchor: self
			)
			.getValue()
		}
		...
		public func getValueAsOnionV3() -> OnionV3? {
			...
			return NetAddress_LDKOnionV3_Body(
				cType: self.cType!.onion_v3, instantiationContext: "NetAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		public func getValueAsHostname() -> Hostname? {
			...
			return NetAddress_LDKHostname_Body(
				cType: self.cType!.hostname, instantiationContext: "NetAddress.swift::\(#function):\(#line)",
				anchor: self)
		}
		...
		deinit {
			...
			if !self.dangling {
				...
				Bindings.print(
					"Not freeing NetAddress \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))"
				)
			}
		}
		...
		public class IPv4: NativeTypeWrapper {
			...
			internal init(
				cType: LDKNetAddress_LDKIPv4_Body, instantiationContext: String, anchor: NativeTypeWrapper,
				dangle: Bool = false
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
			...
			public func getAddr() -> [UInt8] {
				...
				let returnValue = FourBytes(
					cType: self.cType!.addr, instantiationContext: "NetAddress.swift::\(#function):\(#line)",
					anchor: self
				)
				.getValue()
		...
		public class IPv6: NativeTypeWrapper {
			...
			internal init(
				cType: LDKNetAddress_LDKIPv6_Body, instantiationContext: String, anchor: NativeTypeWrapper,
				dangle: Bool = false
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
		...
		public class OnionV3: NativeTypeWrapper {
			...
			internal init(
				cType: LDKNetAddress_LDKOnionV3_Body, instantiationContext: String, anchor: NativeTypeWrapper,
				dangle: Bool = false
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
			...
			public func getEd25519Pubkey() -> [UInt8] {
				...
				let returnValue = ThirtyTwoBytes(
					cType: self.cType!.ed25519_pubkey, instantiationContext: "NetAddress.swift::\(#function):\(#line)",
					anchor: self
				)
				.getValue()
		...
		public class Hostname: NativeTypeWrapper {
			...
			internal init(
				cType: LDKNetAddress_LDKHostname_Body, instantiationContext: String, anchor: NativeTypeWrapper
			) {
				Self.instanceCounter += 1
				self.instanceNumber = Self.instanceCounter
				self.cType = cType
