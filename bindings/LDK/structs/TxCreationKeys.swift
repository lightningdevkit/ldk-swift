public class TxCreationKeys {
    ...
    public init(per_commitment_point_arg: [UInt8], revocation_key_arg: [UInt8], broadcaster_htlc_key_arg: [UInt8], countersignatory_htlc_key_arg: [UInt8], broadcaster_delayed_payment_key_arg: [UInt8]) {
        ...
        self.cOpaqueStruct = TxCreationKeys_new(Bindings.new_LDKPublicKey(array: per_commitment_point_arg).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: revocation_key_arg).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: broadcaster_htlc_key_arg).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: countersignatory_htlc_key_arg).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: broadcaster_delayed_payment_key_arg).cOpaqueStruct!)
    }
...
TxCreationKeys_get_per_commitment_point(this_ptrPointer)
    ...
    public func set_per_commitment_point(val: [UInt8]) -> Void {
        ...
        return TxCreationKeys_set_per_commitment_point(this_ptrPointer, Bindings.new_LDKPublicKey(array: val).cOpaqueStruct!);
    }
...
TxCreationKeys_get_revocation_key(this_ptrPointer)
    ...
    public func set_revocation_key(val: [UInt8]) -> Void {
        ...
        return TxCreationKeys_set_revocation_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val).cOpaqueStruct!);
    }
...
TxCreationKeys_get_broadcaster_htlc_key(this_ptrPointer)
    ...
    public func set_broadcaster_htlc_key(val: [UInt8]) -> Void {
        ...
        return TxCreationKeys_set_broadcaster_htlc_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val).cOpaqueStruct!);
    }
...
TxCreationKeys_get_countersignatory_htlc_key(this_ptrPointer)
    ...
    public func set_countersignatory_htlc_key(val: [UInt8]) -> Void {
        ...
        return TxCreationKeys_set_countersignatory_htlc_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val).cOpaqueStruct!);
    }
...
TxCreationKeys_get_broadcaster_delayed_payment_key(this_ptrPointer)
    ...
    public func set_broadcaster_delayed_payment_key(val: [UInt8]) -> Void {
        ...
        return TxCreationKeys_set_broadcaster_delayed_payment_key(this_ptrPointer, Bindings.new_LDKPublicKey(array: val).cOpaqueStruct!);
    }
...
TxCreationKeys_write(objPointer)
    ...
    public class func read(ser: [UInt8]) -> Result_TxCreationKeysDecodeErrorZ {
        ...
        return Result_TxCreationKeysDecodeErrorZ(pointer: TxCreationKeys_read(Bindings.new_LDKu8slice(array: ser).cOpaqueStruct!));
    }
    ...
    public class func derive_new(per_commitment_point: [UInt8], broadcaster_delayed_payment_base: [UInt8], broadcaster_htlc_base: [UInt8], countersignatory_revocation_base: [UInt8], countersignatory_htlc_base: [UInt8]) -> Result_TxCreationKeysErrorZ {
        ...
        return Result_TxCreationKeysErrorZ(pointer: TxCreationKeys_derive_new(Bindings.new_LDKPublicKey(array: per_commitment_point).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: broadcaster_delayed_payment_base).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: broadcaster_htlc_base).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: countersignatory_revocation_base).cOpaqueStruct!, Bindings.new_LDKPublicKey(array: countersignatory_htlc_base).cOpaqueStruct!));
    }
...
TxCreationKeys_from_channel_static_keys(Bindings.new_LDKPublicKey(array: per_commitment_point).cOpaqueStruct!, broadcaster_keysPointer, countersignatory_keysPointer)
}
});
    }
