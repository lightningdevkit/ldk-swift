			...
			extension Bindings {
				...
				public class Result_SiPrefixBolt11ParseErrorZ: NativeTypeWrapper {
					...
					internal init(cType: LDKCResult_SiPrefixBolt11ParseErrorZ, instantiationContext: String, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					internal init(cType: LDKCResult_SiPrefixBolt11ParseErrorZ, instantiationContext: String, anchor: NativeTypeWrapper, dangle: Bool = false) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public class func initWithOk(o: SiPrefix) -> Result_SiPrefixBolt11ParseErrorZ {
						...
						let returnValue = Result_SiPrefixBolt11ParseErrorZ(cType: nativeCallResult, instantiationContext: "Result_SiPrefixBolt11ParseErrorZ.swift::\(#function):\(#line)")
					...
					internal func clone() -> Result_SiPrefixBolt11ParseErrorZ {
						...
						withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_SiPrefixBolt11ParseErrorZ>) in
				CResult_SiPrefixBolt11ParseErrorZ_clone(origPointer)
					...
					public func getError() -> Bolt11ParseError? {
						if self.cType?.result_ok == false {
							return Bolt11ParseError(cType: self.cType!.contents.err.pointee, instantiationContext: "Result_SiPrefixBolt11ParseErrorZ.swift::\(#function):\(#line)", anchor: self)
						}
						return nil
					}
					...
					deinit {
						...
						if !self.dangling {
							if Self.enableDeinitLogging {
								Bindings.print("Freeing Result_SiPrefixBolt11ParseErrorZ \(self.instanceNumber). (Origin: \(self.instantiationContext))")
							}
							
							self.free()
						} else if Self.enableDeinitLogging {
							Bindings.print("Not freeing Result_SiPrefixBolt11ParseErrorZ \(self.instanceNumber) due to dangle. (Origin: \(self.instantiationContext))")
						}
					}
